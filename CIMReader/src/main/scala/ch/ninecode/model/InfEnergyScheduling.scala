        ...
        Element
{
    ...
    {
        "\t<cim:AreaReserveSpec rdf:%s=\"%s\">\n%s\t</cim:AreaReserveSpec>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:CurrentEmergencyScheduledInterchange rdf:%s=\"%s\">\n%s\t</cim:CurrentEmergencyScheduledInterchange>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:CurrentScheduledInterchange rdf:%s=\"%s\">\n%s\t</cim:CurrentScheduledInterchange>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:CurtailmentProfile rdf:%s=\"%s\">\n%s\t</cim:CurtailmentProfile>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:DynamicSchedule rdf:%s=\"%s\">\n%s\t</cim:DynamicSchedule>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:EnergyProduct rdf:%s=\"%s\">\n%s\t</cim:EnergyProduct>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:InadvertentAccount rdf:%s=\"%s\">\n%s\t</cim:InadvertentAccount>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:InternalControlArea rdf:%s=\"%s\">\n%s\t</cim:InternalControlArea>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:LossProfile rdf:%s=\"%s\">\n%s\t</cim:LossProfile>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:TieLine rdf:%s=\"%s\">\n%s\t</cim:TieLine>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:TransmissionCorridor rdf:%s=\"%s\">\n%s\t</cim:TransmissionCorridor>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:TransmissionRightOfWay rdf:%s=\"%s\">\n%s\t</cim:TransmissionRightOfWay>".format(if (about) "about" else "ID", id, export_fields)
    }
}
