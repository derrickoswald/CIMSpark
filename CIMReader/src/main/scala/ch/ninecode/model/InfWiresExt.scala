        ...
        Element
{
    ...
    def this () =
    {
        this (null, 0, 0.0, null, 0.0, null, null, null, false, 0.0, 0, false, null, 0, null, null, 0.0, false, null)
    }
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [ShuntCompensatorControl]
    }
