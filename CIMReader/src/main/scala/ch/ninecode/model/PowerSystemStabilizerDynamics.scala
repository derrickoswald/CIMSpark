        ...
        Element
{
    ...
    {
        "\t<cim:PowerSystemStabilizerDynamics rdf:%s=\"%s\">\n%s\t</cim:PowerSystemStabilizerDynamics>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:Pss1 rdf:%s=\"%s\">\n%s\t</cim:Pss1>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:Pss1A rdf:%s=\"%s\">\n%s\t</cim:Pss1A>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:Pss2B rdf:%s=\"%s\">\n%s\t</cim:Pss2B>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:Pss2ST rdf:%s=\"%s\">\n%s\t</cim:Pss2ST>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:Pss5 rdf:%s=\"%s\">\n%s\t</cim:Pss5>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PssELIN2 rdf:%s=\"%s\">\n%s\t</cim:PssELIN2>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PssIEEE1A rdf:%s=\"%s\">\n%s\t</cim:PssIEEE1A>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PssIEEE2B rdf:%s=\"%s\">\n%s\t</cim:PssIEEE2B>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PssIEEE3B rdf:%s=\"%s\">\n%s\t</cim:PssIEEE3B>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PssIEEE4B rdf:%s=\"%s\">\n%s\t</cim:PssIEEE4B>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PssPTIST1 rdf:%s=\"%s\">\n%s\t</cim:PssPTIST1>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PssPTIST3 rdf:%s=\"%s\">\n%s\t</cim:PssPTIST3>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PssRQB rdf:%s=\"%s\">\n%s\t</cim:PssRQB>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PssSB4 rdf:%s=\"%s\">\n%s\t</cim:PssSB4>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PssSH rdf:%s=\"%s\">\n%s\t</cim:PssSH>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PssSK rdf:%s=\"%s\">\n%s\t</cim:PssSK>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PssSTAB2A rdf:%s=\"%s\">\n%s\t</cim:PssSTAB2A>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PssWECC rdf:%s=\"%s\">\n%s\t</cim:PssWECC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
