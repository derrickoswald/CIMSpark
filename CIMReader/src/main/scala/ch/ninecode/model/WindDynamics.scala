        ...
        Element
{
    ...
    {
        "\t<cim:WindAeroConstIEC rdf:%s=\"%s\">\n%s\t</cim:WindAeroConstIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindAeroOneDimIEC rdf:%s=\"%s\">\n%s\t</cim:WindAeroOneDimIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindAeroTwoDimIEC rdf:%s=\"%s\">\n%s\t</cim:WindAeroTwoDimIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindContCurrLimIEC rdf:%s=\"%s\">\n%s\t</cim:WindContCurrLimIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindContPType3IEC rdf:%s=\"%s\">\n%s\t</cim:WindContPType3IEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindContPType4aIEC rdf:%s=\"%s\">\n%s\t</cim:WindContPType4aIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindContPType4bIEC rdf:%s=\"%s\">\n%s\t</cim:WindContPType4bIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindContPitchAngleIEC rdf:%s=\"%s\">\n%s\t</cim:WindContPitchAngleIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindContQIEC rdf:%s=\"%s\">\n%s\t</cim:WindContQIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindContQLimIEC rdf:%s=\"%s\">\n%s\t</cim:WindContQLimIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindContQPQULimIEC rdf:%s=\"%s\">\n%s\t</cim:WindContQPQULimIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindContRotorRIEC rdf:%s=\"%s\">\n%s\t</cim:WindContRotorRIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindDynamicsLookupTable rdf:%s=\"%s\">\n%s\t</cim:WindDynamicsLookupTable>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindGenTurbineType1aIEC rdf:%s=\"%s\">\n%s\t</cim:WindGenTurbineType1aIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindGenTurbineType1bIEC rdf:%s=\"%s\">\n%s\t</cim:WindGenTurbineType1bIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindGenTurbineType2IEC rdf:%s=\"%s\">\n%s\t</cim:WindGenTurbineType2IEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindGenType3IEC rdf:%s=\"%s\">\n%s\t</cim:WindGenType3IEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindGenType3aIEC rdf:%s=\"%s\">\n%s\t</cim:WindGenType3aIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindGenType3bIEC rdf:%s=\"%s\">\n%s\t</cim:WindGenType3bIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindGenType4IEC rdf:%s=\"%s\">\n%s\t</cim:WindGenType4IEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindMechIEC rdf:%s=\"%s\">\n%s\t</cim:WindMechIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindPitchContPowerIEC rdf:%s=\"%s\">\n%s\t</cim:WindPitchContPowerIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindPlantDynamics rdf:%s=\"%s\">\n%s\t</cim:WindPlantDynamics>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindPlantFreqPcontrolIEC rdf:%s=\"%s\">\n%s\t</cim:WindPlantFreqPcontrolIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindPlantIEC rdf:%s=\"%s\">\n%s\t</cim:WindPlantIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindPlantReactiveControlIEC rdf:%s=\"%s\">\n%s\t</cim:WindPlantReactiveControlIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindProtectionIEC rdf:%s=\"%s\">\n%s\t</cim:WindProtectionIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindRefFrameRotIEC rdf:%s=\"%s\">\n%s\t</cim:WindRefFrameRotIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindTurbineType1or2Dynamics rdf:%s=\"%s\">\n%s\t</cim:WindTurbineType1or2Dynamics>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindTurbineType1or2IEC rdf:%s=\"%s\">\n%s\t</cim:WindTurbineType1or2IEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindTurbineType3IEC rdf:%s=\"%s\">\n%s\t</cim:WindTurbineType3IEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindTurbineType3or4Dynamics rdf:%s=\"%s\">\n%s\t</cim:WindTurbineType3or4Dynamics>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindTurbineType3or4IEC rdf:%s=\"%s\">\n%s\t</cim:WindTurbineType3or4IEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindTurbineType4IEC rdf:%s=\"%s\">\n%s\t</cim:WindTurbineType4IEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindTurbineType4aIEC rdf:%s=\"%s\">\n%s\t</cim:WindTurbineType4aIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindTurbineType4bIEC rdf:%s=\"%s\">\n%s\t</cim:WindTurbineType4bIEC>".format(if (about) "about" else "ID", id, export_fields)
    }
}
