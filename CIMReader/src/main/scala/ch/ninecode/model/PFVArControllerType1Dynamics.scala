        ...
        Element
{
    ...
    {
        "\t<cim:PFVArControllerType1Dynamics rdf:%s=\"%s\">\n%s\t</cim:PFVArControllerType1Dynamics>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PFVArType1IEEEPFController rdf:%s=\"%s\">\n%s\t</cim:PFVArType1IEEEPFController>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PFVArType1IEEEVArController rdf:%s=\"%s\">\n%s\t</cim:PFVArType1IEEEVArController>".format(if (about) "about" else "ID", id, export_fields)
    }
}
