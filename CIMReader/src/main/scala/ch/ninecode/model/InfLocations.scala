    ...
    Element
{
    ...
    {
        "\t<cim:LandProperty rdf:%s=\"%s\">\n%s\t</cim:LandProperty>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:LocationGrant rdf:%s=\"%s\">\n%s\t</cim:LocationGrant>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:RedLine rdf:%s=\"%s\">\n%s\t</cim:RedLine>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:RightOfWay rdf:%s=\"%s\">\n%s\t</cim:RightOfWay>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Route rdf:%s=\"%s\">\n%s\t</cim:Route>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Zone rdf:%s=\"%s\">\n%s\t</cim:Zone>".format (if (about) "about" else "ID", id, export_fields)
    }
}
