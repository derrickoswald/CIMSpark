    ...
    Element
{
    ...
    {
        "\t<cim:PFVArControllerType2Dynamics rdf:%s=\"%s\">\n%s\t</cim:PFVArControllerType2Dynamics>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PFVArType2Common1 rdf:%s=\"%s\">\n%s\t</cim:PFVArType2Common1>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PFVArType2IEEEPFController rdf:%s=\"%s\">\n%s\t</cim:PFVArType2IEEEPFController>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PFVArType2IEEEVArController rdf:%s=\"%s\">\n%s\t</cim:PFVArType2IEEEVArController>".format (if (about) "about" else "ID", id, export_fields)
    }
}
