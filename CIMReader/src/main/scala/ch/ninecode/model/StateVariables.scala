        ...
        Element
{
    ...
    {
        "\t<cim:StateVariable rdf:%s=\"%s\">\n%s\t</cim:StateVariable>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:SvInjection rdf:%s=\"%s\">\n%s\t</cim:SvInjection>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:SvPowerFlow rdf:%s=\"%s\">\n%s\t</cim:SvPowerFlow>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:SvShuntCompensatorSections rdf:%s=\"%s\">\n%s\t</cim:SvShuntCompensatorSections>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:SvStatus rdf:%s=\"%s\">\n%s\t</cim:SvStatus>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:SvSwitch rdf:%s=\"%s\">\n%s\t</cim:SvSwitch>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:SvTapStep rdf:%s=\"%s\">\n%s\t</cim:SvTapStep>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:SvVoltage rdf:%s=\"%s\">\n%s\t</cim:SvVoltage>".format(if (about) "about" else "ID", id, export_fields)
    }
}
