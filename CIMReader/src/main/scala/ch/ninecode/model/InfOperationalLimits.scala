    ...
    Element
{
    ...
    {
        "\t<cim:EnvironmentalDependentLimit rdf:%s=\"%s\">\n%s\t</cim:EnvironmentalDependentLimit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:EquipmentLimitSeriesComponent rdf:%s=\"%s\">\n%s\t</cim:EquipmentLimitSeriesComponent>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:LimitDependency rdf:%s=\"%s\">\n%s\t</cim:LimitDependency>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:LimitScalingLimit rdf:%s=\"%s\">\n%s\t</cim:LimitScalingLimit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:OperatonalLimitTypeScaling rdf:%s=\"%s\">\n%s\t</cim:OperatonalLimitTypeScaling>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ScheduledActivePowerLimitValue rdf:%s=\"%s\">\n%s\t</cim:ScheduledActivePowerLimitValue>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ScheduledApparentPowerLimitValue rdf:%s=\"%s\">\n%s\t</cim:ScheduledApparentPowerLimitValue>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ScheduledCurrentLimitValue rdf:%s=\"%s\">\n%s\t</cim:ScheduledCurrentLimitValue>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ScheduledLimitDependency rdf:%s=\"%s\">\n%s\t</cim:ScheduledLimitDependency>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ScheduledLimitValue rdf:%s=\"%s\">\n%s\t</cim:ScheduledLimitValue>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ScheduledVoltageLimitValue rdf:%s=\"%s\">\n%s\t</cim:ScheduledVoltageLimitValue>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SeriesEquipmentDependentLimit rdf:%s=\"%s\">\n%s\t</cim:SeriesEquipmentDependentLimit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:TemperatureDependentLimitPoint rdf:%s=\"%s\">\n%s\t</cim:TemperatureDependentLimitPoint>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:TemperatureDependentLimitTable rdf:%s=\"%s\">\n%s\t</cim:TemperatureDependentLimitTable>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:TemperaturePolynomialLimit rdf:%s=\"%s\">\n%s\t</cim:TemperaturePolynomialLimit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:WeatherStation rdf:%s=\"%s\">\n%s\t</cim:WeatherStation>".format (if (about) "about" else "ID", id, export_fields)
    }
}
