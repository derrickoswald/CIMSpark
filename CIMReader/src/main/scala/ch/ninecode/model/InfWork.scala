    ...
    Element
{
    ...
    {
        "\t<cim:AccessPermit rdf:%s=\"%s\">\n%s\t</cim:AccessPermit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Assignment rdf:%s=\"%s\">\n%s\t</cim:Assignment>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:BusinessCase rdf:%s=\"%s\">\n%s\t</cim:BusinessCase>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CUAllowableAction rdf:%s=\"%s\">\n%s\t</cim:CUAllowableAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CUContractorItem rdf:%s=\"%s\">\n%s\t</cim:CUContractorItem>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CUGroup rdf:%s=\"%s\">\n%s\t</cim:CUGroup>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CULaborCode rdf:%s=\"%s\">\n%s\t</cim:CULaborCode>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CULaborItem rdf:%s=\"%s\">\n%s\t</cim:CULaborItem>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CUMaterialItem rdf:%s=\"%s\">\n%s\t</cim:CUMaterialItem>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CUWorkEquipmentItem rdf:%s=\"%s\">\n%s\t</cim:CUWorkEquipmentItem>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Capability rdf:%s=\"%s\">\n%s\t</cim:Capability>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CompatibleUnit rdf:%s=\"%s\">\n%s\t</cim:CompatibleUnit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ConditionFactor rdf:%s=\"%s\">\n%s\t</cim:ConditionFactor>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ContractorItem rdf:%s=\"%s\">\n%s\t</cim:ContractorItem>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CostType rdf:%s=\"%s\">\n%s\t</cim:CostType>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Design rdf:%s=\"%s\">\n%s\t</cim:Design>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:DesignLocation rdf:%s=\"%s\">\n%s\t</cim:DesignLocation>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:DesignLocationCU rdf:%s=\"%s\">\n%s\t</cim:DesignLocationCU>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:InfoQuestion rdf:%s=\"%s\">\n%s\t</cim:InfoQuestion>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:LaborItem rdf:%s=\"%s\">\n%s\t</cim:LaborItem>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:MiscCostItem rdf:%s=\"%s\">\n%s\t</cim:MiscCostItem>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:NonStandardItem rdf:%s=\"%s\">\n%s\t</cim:NonStandardItem>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:OldWorkTask rdf:%s=\"%s\">\n%s\t</cim:OldWorkTask>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:OneCallRequest rdf:%s=\"%s\">\n%s\t</cim:OneCallRequest>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:OverheadCost rdf:%s=\"%s\">\n%s\t</cim:OverheadCost>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Project rdf:%s=\"%s\">\n%s\t</cim:Project>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PropertyUnit rdf:%s=\"%s\">\n%s\t</cim:PropertyUnit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:QualificationRequirement rdf:%s=\"%s\">\n%s\t</cim:QualificationRequirement>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Regulation rdf:%s=\"%s\">\n%s\t</cim:Regulation>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ShiftPattern rdf:%s=\"%s\">\n%s\t</cim:ShiftPattern>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:TypeMaterial rdf:%s=\"%s\">\n%s\t</cim:TypeMaterial>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Usage rdf:%s=\"%s\">\n%s\t</cim:Usage>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:WorkCostDetail rdf:%s=\"%s\">\n%s\t</cim:WorkCostDetail>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:WorkCostSummary rdf:%s=\"%s\">\n%s\t</cim:WorkCostSummary>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:WorkDocument rdf:%s=\"%s\">\n%s\t</cim:WorkDocument>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:WorkFlowStep rdf:%s=\"%s\">\n%s\t</cim:WorkFlowStep>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:WorkIdentifiedObject rdf:%s=\"%s\">\n%s\t</cim:WorkIdentifiedObject>".format (if (about) "about" else "ID", id, export_fields)
    }
}
