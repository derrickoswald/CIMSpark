    ...
    Element
{
    ...
    {
        "\t<cim:CRROrgRole rdf:%s=\"%s\">\n%s\t</cim:CRROrgRole>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CRRSegment rdf:%s=\"%s\">\n%s\t</cim:CRRSegment>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CongestionRevenueRight rdf:%s=\"%s\">\n%s\t</cim:CongestionRevenueRight>".format (if (about) "about" else "ID", id, export_fields)
    }
}
