    ...
    Element
{
    ...
    {
        "\t<cim:ClampAction rdf:%s=\"%s\">\n%s\t</cim:ClampAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ClearanceAction rdf:%s=\"%s\">\n%s\t</cim:ClearanceAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ClearanceDocument rdf:%s=\"%s\">\n%s\t</cim:ClearanceDocument>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ControlAction rdf:%s=\"%s\">\n%s\t</cim:ControlAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CutAction rdf:%s=\"%s\">\n%s\t</cim:CutAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:EnergyConsumerAction rdf:%s=\"%s\">\n%s\t</cim:EnergyConsumerAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:EnergySourceAction rdf:%s=\"%s\">\n%s\t</cim:EnergySourceAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:EstimatedRestorationTime rdf:%s=\"%s\">\n%s\t</cim:EstimatedRestorationTime>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:FieldSafetySupervisor rdf:%s=\"%s\">\n%s\t</cim:FieldSafetySupervisor>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GenericAction rdf:%s=\"%s\">\n%s\t</cim:GenericAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GroundAction rdf:%s=\"%s\">\n%s\t</cim:GroundAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Incident rdf:%s=\"%s\">\n%s\t</cim:Incident>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:JumperAction rdf:%s=\"%s\">\n%s\t</cim:JumperAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:MeasurementAction rdf:%s=\"%s\">\n%s\t</cim:MeasurementAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:OperationalRestriction rdf:%s=\"%s\">\n%s\t</cim:OperationalRestriction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:OperationalTag rdf:%s=\"%s\">\n%s\t</cim:OperationalTag>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:OperationalUpdatedRating rdf:%s=\"%s\">\n%s\t</cim:OperationalUpdatedRating>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:OperationsSafetySupervisor rdf:%s=\"%s\">\n%s\t</cim:OperationsSafetySupervisor>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Outage rdf:%s=\"%s\">\n%s\t</cim:Outage>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:OutageArea rdf:%s=\"%s\">\n%s\t</cim:OutageArea>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:OutageOrder rdf:%s=\"%s\">\n%s\t</cim:OutageOrder>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:OutagePlan rdf:%s=\"%s\">\n%s\t</cim:OutagePlan>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PSREvent rdf:%s=\"%s\">\n%s\t</cim:PSREvent>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PlannedOutage rdf:%s=\"%s\">\n%s\t</cim:PlannedOutage>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PlannedOutageNotification rdf:%s=\"%s\">\n%s\t</cim:PlannedOutageNotification>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SafetyDocument rdf:%s=\"%s\">\n%s\t</cim:SafetyDocument>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ServicePointOutageSummary rdf:%s=\"%s\">\n%s\t</cim:ServicePointOutageSummary>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ShuntCompensatorAction rdf:%s=\"%s\">\n%s\t</cim:ShuntCompensatorAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SwitchAction rdf:%s=\"%s\">\n%s\t</cim:SwitchAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SwitchingAction rdf:%s=\"%s\">\n%s\t</cim:SwitchingAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SwitchingEvent rdf:%s=\"%s\">\n%s\t</cim:SwitchingEvent>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SwitchingOrder rdf:%s=\"%s\">\n%s\t</cim:SwitchingOrder>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SwitchingPlan rdf:%s=\"%s\">\n%s\t</cim:SwitchingPlan>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SwitchingPlanRequest rdf:%s=\"%s\">\n%s\t</cim:SwitchingPlanRequest>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SwitchingStep rdf:%s=\"%s\">\n%s\t</cim:SwitchingStep>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SwitchingStepGroup rdf:%s=\"%s\">\n%s\t</cim:SwitchingStepGroup>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:TagAction rdf:%s=\"%s\">\n%s\t</cim:TagAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:TroubleOrder rdf:%s=\"%s\">\n%s\t</cim:TroubleOrder>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:UnplannedOutage rdf:%s=\"%s\">\n%s\t</cim:UnplannedOutage>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:VerificationAction rdf:%s=\"%s\">\n%s\t</cim:VerificationAction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
