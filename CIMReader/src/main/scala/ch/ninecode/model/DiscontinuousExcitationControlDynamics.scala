        ...
        Element
{
    ...
    {
        clone ().asInstanceOf [DiscExcContIEEEDEC1A]
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [DiscExcContIEEEDEC2A]
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [DiscExcContIEEEDEC3A]
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [DiscontinuousExcitationControlDynamics]
    }
