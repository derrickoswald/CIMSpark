    ...
    Element
{
    ...
    {
        "\t<cim:AncillaryServiceClearing rdf:%s=\"%s\">\n%s\t</cim:AncillaryServiceClearing>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:BillDeterminant rdf:%s=\"%s\">\n%s\t</cim:BillDeterminant>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ChargeProfile rdf:%s=\"%s\">\n%s\t</cim:ChargeProfile>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ChargeProfileData rdf:%s=\"%s\">\n%s\t</cim:ChargeProfileData>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CommitmentClearing rdf:%s=\"%s\">\n%s\t</cim:CommitmentClearing>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Commitments rdf:%s=\"%s\">\n%s\t</cim:Commitments>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CommodityPrice rdf:%s=\"%s\">\n%s\t</cim:CommodityPrice>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ConstraintClearing rdf:%s=\"%s\">\n%s\t</cim:ConstraintClearing>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ConstraintResults rdf:%s=\"%s\">\n%s\t</cim:ConstraintResults>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:DopInstruction rdf:%s=\"%s\">\n%s\t</cim:DopInstruction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:DotInstruction rdf:%s=\"%s\">\n%s\t</cim:DotInstruction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExPostLoss rdf:%s=\"%s\">\n%s\t</cim:ExPostLoss>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExPostLossResults rdf:%s=\"%s\">\n%s\t</cim:ExPostLossResults>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExPostMarketRegion rdf:%s=\"%s\">\n%s\t</cim:ExPostMarketRegion>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExPostMarketRegionResults rdf:%s=\"%s\">\n%s\t</cim:ExPostMarketRegionResults>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExPostPricing rdf:%s=\"%s\">\n%s\t</cim:ExPostPricing>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExPostPricingResults rdf:%s=\"%s\">\n%s\t</cim:ExPostPricingResults>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExPostResource rdf:%s=\"%s\">\n%s\t</cim:ExPostResource>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExPostResourceResults rdf:%s=\"%s\">\n%s\t</cim:ExPostResourceResults>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GeneralClearing rdf:%s=\"%s\">\n%s\t</cim:GeneralClearing>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GeneralClearingResults rdf:%s=\"%s\">\n%s\t</cim:GeneralClearingResults>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:InstructionClearing rdf:%s=\"%s\">\n%s\t</cim:InstructionClearing>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:InstructionClearingDOP rdf:%s=\"%s\">\n%s\t</cim:InstructionClearingDOP>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:InstructionClearingDOT rdf:%s=\"%s\">\n%s\t</cim:InstructionClearingDOT>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Instructions rdf:%s=\"%s\">\n%s\t</cim:Instructions>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:LoadFollowingOperatorInput rdf:%s=\"%s\">\n%s\t</cim:LoadFollowingOperatorInput>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:LossClearing rdf:%s=\"%s\">\n%s\t</cim:LossClearing>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:LossClearingResults rdf:%s=\"%s\">\n%s\t</cim:LossClearingResults>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:MPMClearing rdf:%s=\"%s\">\n%s\t</cim:MPMClearing>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:MPMResourceStatus rdf:%s=\"%s\">\n%s\t</cim:MPMResourceStatus>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:MPMTestResults rdf:%s=\"%s\">\n%s\t</cim:MPMTestResults>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:MarketRegionResults rdf:%s=\"%s\">\n%s\t</cim:MarketRegionResults>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:MarketResults rdf:%s=\"%s\">\n%s\t</cim:MarketResults>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:MarketStatement rdf:%s=\"%s\">\n%s\t</cim:MarketStatement>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:MarketStatementLineItem rdf:%s=\"%s\">\n%s\t</cim:MarketStatementLineItem>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:MitigatedBid rdf:%s=\"%s\">\n%s\t</cim:MitigatedBid>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:MitigatedBidClearing rdf:%s=\"%s\">\n%s\t</cim:MitigatedBidClearing>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:MitigatedBidSegment rdf:%s=\"%s\">\n%s\t</cim:MitigatedBidSegment>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PassThroughBill rdf:%s=\"%s\">\n%s\t</cim:PassThroughBill>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PnodeClearing rdf:%s=\"%s\">\n%s\t</cim:PnodeClearing>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PnodeResults rdf:%s=\"%s\">\n%s\t</cim:PnodeResults>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PriceDescriptor rdf:%s=\"%s\">\n%s\t</cim:PriceDescriptor>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:RMRDetermination rdf:%s=\"%s\">\n%s\t</cim:RMRDetermination>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:RMROperatorInput rdf:%s=\"%s\">\n%s\t</cim:RMROperatorInput>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:RUCAwardInstruction rdf:%s=\"%s\">\n%s\t</cim:RUCAwardInstruction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ResourceAwardClearing rdf:%s=\"%s\">\n%s\t</cim:ResourceAwardClearing>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ResourceAwardInstruction rdf:%s=\"%s\">\n%s\t</cim:ResourceAwardInstruction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ResourceClearing rdf:%s=\"%s\">\n%s\t</cim:ResourceClearing>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ResourceDeploymentStatus rdf:%s=\"%s\">\n%s\t</cim:ResourceDeploymentStatus>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ResourceDispatchResults rdf:%s=\"%s\">\n%s\t</cim:ResourceDispatchResults>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ResourceLoadFollowingInst rdf:%s=\"%s\">\n%s\t</cim:ResourceLoadFollowingInst>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ResourcePerformanceEvaluation rdf:%s=\"%s\">\n%s\t</cim:ResourcePerformanceEvaluation>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ResourcePerformanceGlobalFactor rdf:%s=\"%s\">\n%s\t</cim:ResourcePerformanceGlobalFactor>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ResourcePerformanceRating rdf:%s=\"%s\">\n%s\t</cim:ResourcePerformanceRating>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ResourcePerformanceTimeSeriesFactor rdf:%s=\"%s\">\n%s\t</cim:ResourcePerformanceTimeSeriesFactor>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SelfScheduleBreakdown rdf:%s=\"%s\">\n%s\t</cim:SelfScheduleBreakdown>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Settlement rdf:%s=\"%s\">\n%s\t</cim:Settlement>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:TransactionBidClearing rdf:%s=\"%s\">\n%s\t</cim:TransactionBidClearing>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:TransactionBidResults rdf:%s=\"%s\">\n%s\t</cim:TransactionBidResults>".format (if (about) "about" else "ID", id, export_fields)
    }
}
