    ...
    Element
{
    ...
    {
        "\t<cim:BWRSteamSupply rdf:%s=\"%s\">\n%s\t</cim:BWRSteamSupply>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CTTempActivePowerCurve rdf:%s=\"%s\">\n%s\t</cim:CTTempActivePowerCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CombustionTurbine rdf:%s=\"%s\">\n%s\t</cim:CombustionTurbine>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:DrumBoiler rdf:%s=\"%s\">\n%s\t</cim:DrumBoiler>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:FossilSteamSupply rdf:%s=\"%s\">\n%s\t</cim:FossilSteamSupply>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:HeatRecoveryBoiler rdf:%s=\"%s\">\n%s\t</cim:HeatRecoveryBoiler>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:HydroTurbine rdf:%s=\"%s\">\n%s\t</cim:HydroTurbine>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PWRSteamSupply rdf:%s=\"%s\">\n%s\t</cim:PWRSteamSupply>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PrimeMover rdf:%s=\"%s\">\n%s\t</cim:PrimeMover>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SteamSupply rdf:%s=\"%s\">\n%s\t</cim:SteamSupply>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SteamTurbine rdf:%s=\"%s\">\n%s\t</cim:SteamTurbine>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Subcritical rdf:%s=\"%s\">\n%s\t</cim:Subcritical>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Supercritical rdf:%s=\"%s\">\n%s\t</cim:Supercritical>".format (if (about) "about" else "ID", id, export_fields)
    }
}
