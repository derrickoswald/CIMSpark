    ...
    Element
{
    ...
    {
        "\t<cim:AirCompressor rdf:%s=\"%s\">\n%s\t</cim:AirCompressor>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:BatteryUnit rdf:%s=\"%s\">\n%s\t</cim:BatteryUnit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CAESPlant rdf:%s=\"%s\">\n%s\t</cim:CAESPlant>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CogenerationPlant rdf:%s=\"%s\">\n%s\t</cim:CogenerationPlant>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CombinedCyclePlant rdf:%s=\"%s\">\n%s\t</cim:CombinedCyclePlant>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:EmissionAccount rdf:%s=\"%s\">\n%s\t</cim:EmissionAccount>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:EmissionCurve rdf:%s=\"%s\">\n%s\t</cim:EmissionCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:FossilFuel rdf:%s=\"%s\">\n%s\t</cim:FossilFuel>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:FuelAllocationSchedule rdf:%s=\"%s\">\n%s\t</cim:FuelAllocationSchedule>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GenUnitOpCostCurve rdf:%s=\"%s\">\n%s\t</cim:GenUnitOpCostCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GenUnitOpSchedule rdf:%s=\"%s\">\n%s\t</cim:GenUnitOpSchedule>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GeneratingUnit rdf:%s=\"%s\">\n%s\t</cim:GeneratingUnit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GrossToNetActivePowerCurve rdf:%s=\"%s\">\n%s\t</cim:GrossToNetActivePowerCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:HeatInputCurve rdf:%s=\"%s\">\n%s\t</cim:HeatInputCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:HeatRateCurve rdf:%s=\"%s\">\n%s\t</cim:HeatRateCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:HydroGeneratingEfficiencyCurve rdf:%s=\"%s\">\n%s\t</cim:HydroGeneratingEfficiencyCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:HydroGeneratingUnit rdf:%s=\"%s\">\n%s\t</cim:HydroGeneratingUnit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:HydroPowerPlant rdf:%s=\"%s\">\n%s\t</cim:HydroPowerPlant>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:HydroPump rdf:%s=\"%s\">\n%s\t</cim:HydroPump>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:HydroPumpOpSchedule rdf:%s=\"%s\">\n%s\t</cim:HydroPumpOpSchedule>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:IncrementalHeatRateCurve rdf:%s=\"%s\">\n%s\t</cim:IncrementalHeatRateCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:InflowForecast rdf:%s=\"%s\">\n%s\t</cim:InflowForecast>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:LevelVsVolumeCurve rdf:%s=\"%s\">\n%s\t</cim:LevelVsVolumeCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:NuclearGeneratingUnit rdf:%s=\"%s\">\n%s\t</cim:NuclearGeneratingUnit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PenstockLossCurve rdf:%s=\"%s\">\n%s\t</cim:PenstockLossCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PhotoVoltaicUnit rdf:%s=\"%s\">\n%s\t</cim:PhotoVoltaicUnit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PowerElectronicsUnit rdf:%s=\"%s\">\n%s\t</cim:PowerElectronicsUnit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PowerElectronicsWindUnit rdf:%s=\"%s\">\n%s\t</cim:PowerElectronicsWindUnit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Reservoir rdf:%s=\"%s\">\n%s\t</cim:Reservoir>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ShutdownCurve rdf:%s=\"%s\">\n%s\t</cim:ShutdownCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SolarGeneratingUnit rdf:%s=\"%s\">\n%s\t</cim:SolarGeneratingUnit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:StartIgnFuelCurve rdf:%s=\"%s\">\n%s\t</cim:StartIgnFuelCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:StartMainFuelCurve rdf:%s=\"%s\">\n%s\t</cim:StartMainFuelCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:StartRampCurve rdf:%s=\"%s\">\n%s\t</cim:StartRampCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:StartupModel rdf:%s=\"%s\">\n%s\t</cim:StartupModel>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SteamSendoutSchedule rdf:%s=\"%s\">\n%s\t</cim:SteamSendoutSchedule>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:TailbayLossCurve rdf:%s=\"%s\">\n%s\t</cim:TailbayLossCurve>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:TargetLevelSchedule rdf:%s=\"%s\">\n%s\t</cim:TargetLevelSchedule>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ThermalGeneratingUnit rdf:%s=\"%s\">\n%s\t</cim:ThermalGeneratingUnit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:WindGeneratingUnit rdf:%s=\"%s\">\n%s\t</cim:WindGeneratingUnit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
