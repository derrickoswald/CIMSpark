    ...
    Element
{
    ...
    {
        "\t<cim:ASTMStandard rdf:%s=\"%s\">\n%s\t</cim:ASTMStandard>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AcceptanceTest rdf:%s=\"%s\">\n%s\t</cim:AcceptanceTest>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AggregateScore rdf:%s=\"%s\">\n%s\t</cim:AggregateScore>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Analytic rdf:%s=\"%s\">\n%s\t</cim:Analytic>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AnalyticScore rdf:%s=\"%s\">\n%s\t</cim:AnalyticScore>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Asset rdf:%s=\"%s\">\n%s\t</cim:Asset>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AssetContainer rdf:%s=\"%s\">\n%s\t</cim:AssetContainer>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AssetDeployment rdf:%s=\"%s\">\n%s\t</cim:AssetDeployment>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AssetFunction rdf:%s=\"%s\">\n%s\t</cim:AssetFunction>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AssetGroup rdf:%s=\"%s\">\n%s\t</cim:AssetGroup>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AssetHealthEvent rdf:%s=\"%s\">\n%s\t</cim:AssetHealthEvent>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AssetInfo rdf:%s=\"%s\">\n%s\t</cim:AssetInfo>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AssetLocationHazard rdf:%s=\"%s\">\n%s\t</cim:AssetLocationHazard>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AssetOrganisationRole rdf:%s=\"%s\">\n%s\t</cim:AssetOrganisationRole>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AssetOwner rdf:%s=\"%s\">\n%s\t</cim:AssetOwner>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AssetTestLab rdf:%s=\"%s\">\n%s\t</cim:AssetTestLab>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AssetTestSampleTaker rdf:%s=\"%s\">\n%s\t</cim:AssetTestSampleTaker>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:AssetUser rdf:%s=\"%s\">\n%s\t</cim:AssetUser>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Bushing rdf:%s=\"%s\">\n%s\t</cim:Bushing>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CIGREStandard rdf:%s=\"%s\">\n%s\t</cim:CIGREStandard>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Cabinet rdf:%s=\"%s\">\n%s\t</cim:Cabinet>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:CatalogAssetType rdf:%s=\"%s\">\n%s\t</cim:CatalogAssetType>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ComMedia rdf:%s=\"%s\">\n%s\t</cim:ComMedia>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:DINStandard rdf:%s=\"%s\">\n%s\t</cim:DINStandard>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:DeploymentDate rdf:%s=\"%s\">\n%s\t</cim:DeploymentDate>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:DiagnosisDataSet rdf:%s=\"%s\">\n%s\t</cim:DiagnosisDataSet>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:DobleStandard rdf:%s=\"%s\">\n%s\t</cim:DobleStandard>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:DuctBank rdf:%s=\"%s\">\n%s\t</cim:DuctBank>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:EPAStandard rdf:%s=\"%s\">\n%s\t</cim:EPAStandard>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:FACTSDevice rdf:%s=\"%s\">\n%s\t</cim:FACTSDevice>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Facility rdf:%s=\"%s\">\n%s\t</cim:Facility>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:FailureEvent rdf:%s=\"%s\">\n%s\t</cim:FailureEvent>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:FinancialInfo rdf:%s=\"%s\">\n%s\t</cim:FinancialInfo>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:HealthScore rdf:%s=\"%s\">\n%s\t</cim:HealthScore>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:IECStandard rdf:%s=\"%s\">\n%s\t</cim:IECStandard>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:IEEEStandard rdf:%s=\"%s\">\n%s\t</cim:IEEEStandard>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ISOStandard rdf:%s=\"%s\">\n%s\t</cim:ISOStandard>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:InUseDate rdf:%s=\"%s\">\n%s\t</cim:InUseDate>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:InspectionDataSet rdf:%s=\"%s\">\n%s\t</cim:InspectionDataSet>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:InterrupterUnit rdf:%s=\"%s\">\n%s\t</cim:InterrupterUnit>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Joint rdf:%s=\"%s\">\n%s\t</cim:Joint>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:LabTestDataSet rdf:%s=\"%s\">\n%s\t</cim:LabTestDataSet>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:LaborelecStandard rdf:%s=\"%s\">\n%s\t</cim:LaborelecStandard>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:LifecycleDate rdf:%s=\"%s\">\n%s\t</cim:LifecycleDate>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Maintainer rdf:%s=\"%s\">\n%s\t</cim:Maintainer>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:MaintenanceDataSet rdf:%s=\"%s\">\n%s\t</cim:MaintenanceDataSet>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Manufacturer rdf:%s=\"%s\">\n%s\t</cim:Manufacturer>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Medium rdf:%s=\"%s\">\n%s\t</cim:Medium>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:OilSpecimen rdf:%s=\"%s\">\n%s\t</cim:OilSpecimen>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:OperatingMechanism rdf:%s=\"%s\">\n%s\t</cim:OperatingMechanism>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Procedure rdf:%s=\"%s\">\n%s\t</cim:Procedure>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ProcedureDataSet rdf:%s=\"%s\">\n%s\t</cim:ProcedureDataSet>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ProductAssetModel rdf:%s=\"%s\">\n%s\t</cim:ProductAssetModel>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:RiskScore rdf:%s=\"%s\">\n%s\t</cim:RiskScore>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Seal rdf:%s=\"%s\">\n%s\t</cim:Seal>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Specimen rdf:%s=\"%s\">\n%s\t</cim:Specimen>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Streetlight rdf:%s=\"%s\">\n%s\t</cim:Streetlight>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Structure rdf:%s=\"%s\">\n%s\t</cim:Structure>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:StructureSupport rdf:%s=\"%s\">\n%s\t</cim:StructureSupport>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SwitchOperationSummary rdf:%s=\"%s\">\n%s\t</cim:SwitchOperationSummary>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:TAPPIStandard rdf:%s=\"%s\">\n%s\t</cim:TAPPIStandard>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:TestDataSet rdf:%s=\"%s\">\n%s\t</cim:TestDataSet>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:TestStandard rdf:%s=\"%s\">\n%s\t</cim:TestStandard>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:UKMinistryOfDefenceStandard rdf:%s=\"%s\">\n%s\t</cim:UKMinistryOfDefenceStandard>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:WEPStandard rdf:%s=\"%s\">\n%s\t</cim:WEPStandard>".format (if (about) "about" else "ID", id, export_fields)
    }
}
