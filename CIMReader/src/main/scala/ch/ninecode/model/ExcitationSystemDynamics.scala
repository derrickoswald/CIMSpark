    ...
    Element
{
    ...
    {
        "\t<cim:ExcAC1A rdf:%s=\"%s\">\n%s\t</cim:ExcAC1A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcAC2A rdf:%s=\"%s\">\n%s\t</cim:ExcAC2A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcAC3A rdf:%s=\"%s\">\n%s\t</cim:ExcAC3A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcAC4A rdf:%s=\"%s\">\n%s\t</cim:ExcAC4A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcAC5A rdf:%s=\"%s\">\n%s\t</cim:ExcAC5A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcAC6A rdf:%s=\"%s\">\n%s\t</cim:ExcAC6A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcAC8B rdf:%s=\"%s\">\n%s\t</cim:ExcAC8B>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcANS rdf:%s=\"%s\">\n%s\t</cim:ExcANS>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcAVR1 rdf:%s=\"%s\">\n%s\t</cim:ExcAVR1>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcAVR2 rdf:%s=\"%s\">\n%s\t</cim:ExcAVR2>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcAVR3 rdf:%s=\"%s\">\n%s\t</cim:ExcAVR3>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcAVR4 rdf:%s=\"%s\">\n%s\t</cim:ExcAVR4>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcAVR5 rdf:%s=\"%s\">\n%s\t</cim:ExcAVR5>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcAVR7 rdf:%s=\"%s\">\n%s\t</cim:ExcAVR7>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcBBC rdf:%s=\"%s\">\n%s\t</cim:ExcBBC>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcCZ rdf:%s=\"%s\">\n%s\t</cim:ExcCZ>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcDC1A rdf:%s=\"%s\">\n%s\t</cim:ExcDC1A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcDC2A rdf:%s=\"%s\">\n%s\t</cim:ExcDC2A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcDC3A rdf:%s=\"%s\">\n%s\t</cim:ExcDC3A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcDC3A1 rdf:%s=\"%s\">\n%s\t</cim:ExcDC3A1>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcELIN1 rdf:%s=\"%s\">\n%s\t</cim:ExcELIN1>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcELIN2 rdf:%s=\"%s\">\n%s\t</cim:ExcELIN2>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcHU rdf:%s=\"%s\">\n%s\t</cim:ExcHU>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEAC1A rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEAC1A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEAC2A rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEAC2A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEAC3A rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEAC3A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEAC4A rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEAC4A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEAC5A rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEAC5A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEAC6A rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEAC6A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEAC7B rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEAC7B>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEAC8B rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEAC8B>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEDC1A rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEDC1A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEDC2A rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEDC2A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEDC3A rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEDC3A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEDC4B rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEDC4B>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEST1A rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEST1A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEST2A rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEST2A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEST3A rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEST3A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEST4B rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEST4B>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEST5B rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEST5B>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEST6B rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEST6B>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcIEEEST7B rdf:%s=\"%s\">\n%s\t</cim:ExcIEEEST7B>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcNI rdf:%s=\"%s\">\n%s\t</cim:ExcNI>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcOEX3T rdf:%s=\"%s\">\n%s\t</cim:ExcOEX3T>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcPIC rdf:%s=\"%s\">\n%s\t</cim:ExcPIC>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcREXS rdf:%s=\"%s\">\n%s\t</cim:ExcREXS>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcRQB rdf:%s=\"%s\">\n%s\t</cim:ExcRQB>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcSCRX rdf:%s=\"%s\">\n%s\t</cim:ExcSCRX>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcSEXS rdf:%s=\"%s\">\n%s\t</cim:ExcSEXS>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcSK rdf:%s=\"%s\">\n%s\t</cim:ExcSK>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcST1A rdf:%s=\"%s\">\n%s\t</cim:ExcST1A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcST2A rdf:%s=\"%s\">\n%s\t</cim:ExcST2A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcST3A rdf:%s=\"%s\">\n%s\t</cim:ExcST3A>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcST4B rdf:%s=\"%s\">\n%s\t</cim:ExcST4B>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcST6B rdf:%s=\"%s\">\n%s\t</cim:ExcST6B>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcST7B rdf:%s=\"%s\">\n%s\t</cim:ExcST7B>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ExcitationSystemDynamics rdf:%s=\"%s\">\n%s\t</cim:ExcitationSystemDynamics>".format (if (about) "about" else "ID", id, export_fields)
    }
}
