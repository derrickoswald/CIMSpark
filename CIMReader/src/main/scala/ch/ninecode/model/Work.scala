        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MaintenanceLocation]
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MaterialItem]
    }
        ...
        Element
{
    ...
    def this () =
    {
        this (null, null, List (), null, List (), List (), null, List (), null, null, List (), List (), List ())
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [WorkLocation]
    }
        ...
        Element
{
    ...
    def this () =
    {
        this (null, null, null, null, null, List (), List (), List (), null, null, null)
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [WorkTimeSchedule]
    }
