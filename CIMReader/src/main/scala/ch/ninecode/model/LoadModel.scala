    ...
    Element
{
    ...
    {
        "\t<cim:ConformLoad rdf:%s=\"%s\">\n%s\t</cim:ConformLoad>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ConformLoadGroup rdf:%s=\"%s\">\n%s\t</cim:ConformLoadGroup>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:ConformLoadSchedule rdf:%s=\"%s\">\n%s\t</cim:ConformLoadSchedule>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:DayType rdf:%s=\"%s\">\n%s\t</cim:DayType>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:EnergyArea rdf:%s=\"%s\">\n%s\t</cim:EnergyArea>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:LoadArea rdf:%s=\"%s\">\n%s\t</cim:LoadArea>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:LoadGroup rdf:%s=\"%s\">\n%s\t</cim:LoadGroup>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:LoadResponseCharacteristic rdf:%s=\"%s\">\n%s\t</cim:LoadResponseCharacteristic>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:NonConformLoad rdf:%s=\"%s\">\n%s\t</cim:NonConformLoad>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:NonConformLoadGroup rdf:%s=\"%s\">\n%s\t</cim:NonConformLoadGroup>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:NonConformLoadSchedule rdf:%s=\"%s\">\n%s\t</cim:NonConformLoadSchedule>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:PowerCutZone rdf:%s=\"%s\">\n%s\t</cim:PowerCutZone>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:Season rdf:%s=\"%s\">\n%s\t</cim:Season>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SeasonDayTypeSchedule rdf:%s=\"%s\">\n%s\t</cim:SeasonDayTypeSchedule>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:StationSupply rdf:%s=\"%s\">\n%s\t</cim:StationSupply>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:SubLoadArea rdf:%s=\"%s\">\n%s\t</cim:SubLoadArea>".format (if (about) "about" else "ID", id, export_fields)
    }
}
