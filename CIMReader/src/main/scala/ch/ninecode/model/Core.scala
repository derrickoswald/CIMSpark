        ...
        Element
{
    ...
    {
        "\t<cim:ACDCTerminal rdf:%s=\"%s\">\n%s\t</cim:ACDCTerminal>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:BaseFrequency rdf:%s=\"%s\">\n%s\t</cim:BaseFrequency>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:BasePower rdf:%s=\"%s\">\n%s\t</cim:BasePower>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:BaseVoltage rdf:%s=\"%s\">\n%s\t</cim:BaseVoltage>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:BasicIntervalSchedule rdf:%s=\"%s\">\n%s\t</cim:BasicIntervalSchedule>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:Bay rdf:%s=\"%s\">\n%s\t</cim:Bay>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:ConductingEquipment rdf:%s=\"%s\">\n%s\t</cim:ConductingEquipment>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:ConnectivityNode rdf:%s=\"%s\">\n%s\t</cim:ConnectivityNode>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:ConnectivityNodeContainer rdf:%s=\"%s\">\n%s\t</cim:ConnectivityNodeContainer>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:Curve rdf:%s=\"%s\">\n%s\t</cim:Curve>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:CurveData rdf:%s=\"%s\">\n%s\t</cim:CurveData>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:Equipment rdf:%s=\"%s\">\n%s\t</cim:Equipment>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:EquipmentContainer rdf:%s=\"%s\">\n%s\t</cim:EquipmentContainer>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:Feeder rdf:%s=\"%s\">\n%s\t</cim:Feeder>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:GeographicalRegion rdf:%s=\"%s\">\n%s\t</cim:GeographicalRegion>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:IdentifiedObject rdf:%s=\"%s\">\n%s\t</cim:IdentifiedObject>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:IrregularIntervalSchedule rdf:%s=\"%s\">\n%s\t</cim:IrregularIntervalSchedule>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:IrregularTimePoint rdf:%s=\"%s\">\n%s\t</cim:IrregularTimePoint>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:Name rdf:%s=\"%s\">\n%s\t</cim:Name>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:NameType rdf:%s=\"%s\">\n%s\t</cim:NameType>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:NameTypeAuthority rdf:%s=\"%s\">\n%s\t</cim:NameTypeAuthority>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:OperatingParticipant rdf:%s=\"%s\">\n%s\t</cim:OperatingParticipant>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:OperatingShare rdf:%s=\"%s\">\n%s\t</cim:OperatingShare>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PSRType rdf:%s=\"%s\">\n%s\t</cim:PSRType>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:PowerSystemResource rdf:%s=\"%s\">\n%s\t</cim:PowerSystemResource>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:RegularIntervalSchedule rdf:%s=\"%s\">\n%s\t</cim:RegularIntervalSchedule>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:RegularTimePoint rdf:%s=\"%s\">\n%s\t</cim:RegularTimePoint>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:ReportingGroup rdf:%s=\"%s\">\n%s\t</cim:ReportingGroup>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:ReportingSuperGroup rdf:%s=\"%s\">\n%s\t</cim:ReportingSuperGroup>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:SubGeographicalRegion rdf:%s=\"%s\">\n%s\t</cim:SubGeographicalRegion>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:Substation rdf:%s=\"%s\">\n%s\t</cim:Substation>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:Terminal rdf:%s=\"%s\">\n%s\t</cim:Terminal>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:VoltageLevel rdf:%s=\"%s\">\n%s\t</cim:VoltageLevel>".format(if (about) "about" else "ID", id, export_fields)
    }
}
