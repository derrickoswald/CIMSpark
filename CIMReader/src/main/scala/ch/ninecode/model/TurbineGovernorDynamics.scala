    ...
    Element
{
    ...
    {
        "\t<cim:CrossCompoundTurbineGovernorDynamics rdf:%s=\"%s\">\n%s\t</cim:CrossCompoundTurbineGovernorDynamics>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovCT1 rdf:%s=\"%s\">\n%s\t</cim:GovCT1>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovCT2 rdf:%s=\"%s\">\n%s\t</cim:GovCT2>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovGAST rdf:%s=\"%s\">\n%s\t</cim:GovGAST>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovGAST1 rdf:%s=\"%s\">\n%s\t</cim:GovGAST1>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovGAST2 rdf:%s=\"%s\">\n%s\t</cim:GovGAST2>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovGAST3 rdf:%s=\"%s\">\n%s\t</cim:GovGAST3>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovGAST4 rdf:%s=\"%s\">\n%s\t</cim:GovGAST4>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovGASTWD rdf:%s=\"%s\">\n%s\t</cim:GovGASTWD>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovHydro1 rdf:%s=\"%s\">\n%s\t</cim:GovHydro1>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovHydro2 rdf:%s=\"%s\">\n%s\t</cim:GovHydro2>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovHydro3 rdf:%s=\"%s\">\n%s\t</cim:GovHydro3>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovHydro4 rdf:%s=\"%s\">\n%s\t</cim:GovHydro4>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovHydroDD rdf:%s=\"%s\">\n%s\t</cim:GovHydroDD>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovHydroFrancis rdf:%s=\"%s\">\n%s\t</cim:GovHydroFrancis>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovHydroIEEE0 rdf:%s=\"%s\">\n%s\t</cim:GovHydroIEEE0>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovHydroIEEE2 rdf:%s=\"%s\">\n%s\t</cim:GovHydroIEEE2>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovHydroPID rdf:%s=\"%s\">\n%s\t</cim:GovHydroPID>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovHydroPID2 rdf:%s=\"%s\">\n%s\t</cim:GovHydroPID2>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovHydroPelton rdf:%s=\"%s\">\n%s\t</cim:GovHydroPelton>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovHydroR rdf:%s=\"%s\">\n%s\t</cim:GovHydroR>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovHydroWEH rdf:%s=\"%s\">\n%s\t</cim:GovHydroWEH>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovHydroWPID rdf:%s=\"%s\">\n%s\t</cim:GovHydroWPID>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovSteam0 rdf:%s=\"%s\">\n%s\t</cim:GovSteam0>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovSteam1 rdf:%s=\"%s\">\n%s\t</cim:GovSteam1>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovSteam2 rdf:%s=\"%s\">\n%s\t</cim:GovSteam2>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovSteamBB rdf:%s=\"%s\">\n%s\t</cim:GovSteamBB>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovSteamCC rdf:%s=\"%s\">\n%s\t</cim:GovSteamCC>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovSteamEU rdf:%s=\"%s\">\n%s\t</cim:GovSteamEU>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovSteamFV2 rdf:%s=\"%s\">\n%s\t</cim:GovSteamFV2>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovSteamFV3 rdf:%s=\"%s\">\n%s\t</cim:GovSteamFV3>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovSteamFV4 rdf:%s=\"%s\">\n%s\t</cim:GovSteamFV4>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovSteamIEEE1 rdf:%s=\"%s\">\n%s\t</cim:GovSteamIEEE1>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:GovSteamSGO rdf:%s=\"%s\">\n%s\t</cim:GovSteamSGO>".format (if (about) "about" else "ID", id, export_fields)
    }
}
    ...
    Element
{
    ...
    override def export: String =
    {
        "\t<cim:TurbineGovernorDynamics rdf:%s=\"%s\">\n%s\t</cim:TurbineGovernorDynamics>".format (if (about) "about" else "ID", id, export_fields)
    }
}
