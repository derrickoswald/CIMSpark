        ...
        Element
{
    ...
    {
        "\t<cim:UnderexcLim2Simplified rdf:%s=\"%s\">\n%s\t</cim:UnderexcLim2Simplified>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:UnderexcLimIEEE1 rdf:%s=\"%s\">\n%s\t</cim:UnderexcLimIEEE1>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:UnderexcLimIEEE2 rdf:%s=\"%s\">\n%s\t</cim:UnderexcLimIEEE2>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:UnderexcLimX1 rdf:%s=\"%s\">\n%s\t</cim:UnderexcLimX1>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:UnderexcLimX2 rdf:%s=\"%s\">\n%s\t</cim:UnderexcLimX2>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:UnderexcitationLimiterDynamics rdf:%s=\"%s\">\n%s\t</cim:UnderexcitationLimiterDynamics>".format(if (about) "about" else "ID", id, export_fields)
    }
}
