    ...
    Element
{
     ...
     */
    def ModelOperationArg: ModelOperationArg = sup.asInstanceOf[ModelOperationArg]
    override def copy (): Row = { clone ().asInstanceOf[DatasetArg] }
    ...
    Element
{
     ...
     * @groupdesc Hierarchy Members related to the nested hierarchy of CIM classes.
     */
    def ModelOperationArgDescription: ModelOperationArgDescription = sup.asInstanceOf[ModelOperationArgDescription]
    override def copy (): Row = { clone ().asInstanceOf[DatasetArgDescription] }
    override def get (i: Int): Object =
    {
        if (i < productArity)
            productElement (i).asInstanceOf[AnyRef]
    ...
    Element
{
     ...
     */
    def ModelOperationArg: ModelOperationArg = sup.asInstanceOf[ModelOperationArg]
    override def copy (): Row = { clone ().asInstanceOf[IncrementalDatasetArg] }
    override def get (i: Int): Object =
    {
        if (i < productArity)
            productElement (i).asInstanceOf[AnyRef]
    ...
    Element
{
     ...
     */
    def ModelOperationArgDescription: ModelOperationArgDescription = sup.asInstanceOf[ModelOperationArgDescription]
    override def copy (): Row = { clone ().asInstanceOf[IncrementalDatasetArgDescription] }
    override def get (i: Int): Object =
    {
        if (i < productArity)
            productElement (i).asInstanceOf[AnyRef]
    ...
    Element
{
    ...
    override def copy (): Row = { clone ().asInstanceOf[ModelOperation] }
    override def get (i: Int): Object =
    {
        if (i < productArity)
            productElement (i).asInstanceOf[AnyRef]
    ...
    Element
{
     ...
     */
    def IdentifiedObject: IdentifiedObject = sup.asInstanceOf[IdentifiedObject]
    override def copy (): Row = { clone ().asInstanceOf[ModelOperationArg] }
    override def get (i: Int): Object =
    {
        if (i < productArity)
            productElement (i).asInstanceOf[AnyRef]
    ...
    Element
{
     ...
     */
    def IdentifiedObject: IdentifiedObject = sup.asInstanceOf[IdentifiedObject]
    override def copy (): Row = { clone ().asInstanceOf[ModelOperationArgDescription] }
    override def get (i: Int): Object =
    {
        if (i < productArity)
            productElement (i).asInstanceOf[AnyRef]
    ...
    Element
{
     ...
     */
    def IdentifiedObject: IdentifiedObject = sup.asInstanceOf[IdentifiedObject]
    override def copy (): Row = { clone ().asInstanceOf[ModelOperationDescription] }
    override def get (i: Int): Object =
    {
        if (i < productArity)
            productElement (i).asInstanceOf[AnyRef]
    ...
    Element
{
     ...
     */
    def IdentifiedObject: IdentifiedObject = sup.asInstanceOf[IdentifiedObject]
    override def copy (): Row = { clone ().asInstanceOf[ModelOperationSequence] }
    override def get (i: Int): Object =
    {
        if (i < productArity)
            productElement (i).asInstanceOf[AnyRef]
