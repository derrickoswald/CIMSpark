    ...
    Element
{
     ...
     * @groupdesc Hierarchy Members related to the nested hierarchy of CIM classes.
     */
    def DocumentPersonRole: DocumentPersonRole = sup
    //
    // Row overrides
    //
    ...
    Element
{
     ...
     * @groupdesc Hierarchy Members related to the nested hierarchy of CIM classes.
     */
    def OperationPersonRole: OperationPersonRole = sup
    //
    // Row overrides
    //
...
(
    override val sup: PersonRole = null
)
extends
    Element
{
