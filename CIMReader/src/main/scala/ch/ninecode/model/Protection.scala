        ...
        Element
{
    ...
    {
        "\t<cim:CurrentRelay rdf:%s=\"%s\">\n%s\t</cim:CurrentRelay>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        CIMParseable[CurrentRelay]
{
    ...
    def serializer: Serializer[CurrentRelay] = CurrentRelaySerializer
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:ProtectionEquipment rdf:%s=\"%s\">\n%s\t</cim:ProtectionEquipment>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        CIMParseable[ProtectionEquipment]
{
    ...
    def serializer: Serializer[ProtectionEquipment] = ProtectionEquipmentSerializer
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:RecloseSequence rdf:%s=\"%s\">\n%s\t</cim:RecloseSequence>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        CIMParseable[RecloseSequence]
{
    ...
    def serializer: Serializer[RecloseSequence] = RecloseSequenceSerializer
}
        ...
        Element
{
    ...
    override def export: String =
    {
        "\t<cim:SynchrocheckRelay rdf:%s=\"%s\">\n%s\t</cim:SynchrocheckRelay>".format(if (about) "about" else "ID", id, export_fields)
    }
}
        ...
        CIMParseable[SynchrocheckRelay]
{
    ...
    def serializer: Serializer[SynchrocheckRelay] = SynchrocheckRelaySerializer
}
