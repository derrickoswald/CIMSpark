        ...
        Element
{
    ...
    def this () =
    {
        this (null, null, null, null, null, null, null, false, List (), List (), List (), List (), List (), List (), List ())
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [CustomerAccount]
    }
        ...
        Element
{
    ...
    def this () =
    {
        this (null, null, List (), null, null, List (), List (), List (), null, List (), null, null, List ())
    }
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [CustomerAgreement]
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [CustomerNotification]
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [IncidentHazard]
    }
        ...
        Element
{
    ...
    def this () =
    {
        this (null, null, 0, 0, 0, null, false, List (), null, List (), List (), List ())
    }
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [PricingStructure]
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [ServiceCategory]
    }
        ...
        Element
{
    ...
    def this () =
    {
        this (null, null, false, null, List (), List (), List ())
    }
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [ServiceLocation]
    }
        ...
        Element
{
    ...
    def this () =
    {
        this (null, null, null, null, null, null, null, List (), null, null)
    }
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [TroubleTicket]
    }
