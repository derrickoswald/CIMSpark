        ...
        Element
{
    ...
    def this () =
    {
        this (null, 0.0, null, null, null, null, false, null, null, null, List (), List ())
    }
    ...
    {
        clone ().asInstanceOf [MarketInvoice]
    }
        ...
        Element
{
    ...
    def this () =
    {
        this (null, null, null, null, null, 0.0, null, null, 0.0, 0.0, List (), null, null, List ())
    }
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MarketInvoiceLineItem]
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MarketLedger]
    }
        ...
        Element
{
    ...
    def this () =
    {
        this (null, null, null, 0.0, null, null, null, null, List ())
    }
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MarketLedgerEntry]
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MktActivityRecord]
    }
        ...
        Element
{
    ...
    def this () =
    {
        this (null, null, null, List (), null, List (), List (), null, List (), null)
    }
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MktConnectivityNode]
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MktEnergyConsumer]
    }
    ...
    override def export_fields: String =
    {
        ...
        def emitattrs (position: Int, value: List[String]): Unit = if (mask (position) && (null != value)) value.foreach (x ⇒ emit_attribute (MktEnergyConsumer.fields (position), x))
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MktGeneratingUnit]
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MktLoadArea]
    }
    ...
    override def export_fields: String =
    {
        ...
        def emitattrs (position: Int, value: List[String]): Unit = if (mask (position) && (null != value)) value.foreach (x ⇒ emit_attribute (MktLoadArea.fields (position), x))
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MktMeasurement]
    }
        ...
        Element
{
    ...
    def this () =
    {
        this (null, null, null, null, null, 0, null, null, List (), List (), List (), List (), List (), List (), List (), List ())
    }
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MktOrganisation]
    }
    ...
    override def export_fields: String =
    {
        ...
        def emitattrs (position: Int, value: List[String]): Unit = if (mask (position) && (null != value)) value.foreach (x ⇒ emit_attribute (MktOrganisation.fields (position), x))
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MktPowerTransformer]
    }
        ...
        Element
{
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MktTerminal]
    }
        ...
        Element
{
    ...
    def this () =
    {
        this (null, List (), List (), List (), List (), List (), List ())
    }
    ...
    override def copy (): Row =
    {
        clone ().asInstanceOf [MktUserAttribute]
    }
