...
sparkR.session (sparkJars = c ("/disktemp/transfer/CIMReader-2.11-2.4.3-4.0.1.jar"), sparkEnvir = list (spark.driver.memory="16g", spark.executor.memory="16g", spark.driver.maxResultSize="2g"))
