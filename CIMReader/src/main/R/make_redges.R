...
spark = sparkR.session (sparkJars = c ("/opt/code/CIMReader-2.11-2.4.3-4.0.1.jar"), sparkEnvir = list (spark.driver.memory="2g", spark.executor.memory="4g", spark.driver.maxResultSize="1g", spark.ui.showConsoleProgress="false"))
