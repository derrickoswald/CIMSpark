...
sc = sparkR.init ("yarn-client", "Sample", sparkJars = c ("/home/derrick/code/CIMScala/target/CIMScala-1.4.1-SNAPSHOT.jar"), sparkEnvir = list (spark.driver.memory="4g", spark.executor.memory="4g"))
