...
sc = sparkR.init ("yarn-client", "Sample", sparkJars = c ("/home/derrick/code/CIMScala/target/CIMScala-2.10-1.4.1-0.6.0.jar"), sparkEnvir = list (spark.driver.memory="4g", spark.executor.memory="4g"))
