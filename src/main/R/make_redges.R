...
sparkR.session (sparkJars = c ("/opt/code/CIMReader-2.11-2.0.2-1.9.0.jar"), sparkEnvir = list (spark.driver.memory="2g", spark.executor.memory="4g", spark.driver.maxResultSize="1g", spark.ui.showConsoleProgress="false"))
