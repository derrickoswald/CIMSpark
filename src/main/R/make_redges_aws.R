...
sparkR.session (sparkJars = c ("/disktemp/transfer/CIMReader-2.11-2.0.2-1.9.0.jar"), sparkEnvir = list (spark.driver.memory="16g", spark.executor.memory="16g", spark.driver.maxResultSize="2g", spark.sql.warehouse.dir="/home/nis03/"))
...
elements = sql ("create temporary view elements using ch.ninecode.cim options (path 'hdfs:/data/bkw_cim_export_defaultall.rdf', StorageLevel 'MEMORY_AND_DISK_SER', ch.ninecode.cim.make_edges 'true', ch.ninecode.cim.do_topo 'false', ch.ninecode.cim.do_topo_islands 'false', ch.ninecode.cim.split_maxsize '256000000')")
...
save ("redges", file="./NIS_CIM_Export_sias_current_20161220_V11a_new.RData")
