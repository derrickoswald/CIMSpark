...
(
    ...
    fuelValveStroke: String,
    governorOutput: String,
    none: String
)
extends
    Element
{
    ...
    override def copy (): Row = { clone ().asInstanceOf[DroopSignalFeedbackKind] }
    ...
    {
        sup.export_fields +
        (if (null != electricalPower) "\t\t<cim:DroopSignalFeedbackKind.electricalPower rdf:resource=\"#" + electricalPower + "\"/>\n" else "") +
        (if (null != fuelValveStroke) "\t\t<cim:DroopSignalFeedbackKind.fuelValveStroke rdf:resource=\"#" + fuelValveStroke + "\"/>\n" else "") +
        (if (null != governorOutput) "\t\t<cim:DroopSignalFeedbackKind.governorOutput rdf:resource=\"#" + governorOutput + "\"/>\n" else "") +
        (if (null != none) "\t\t<cim:DroopSignalFeedbackKind.none rdf:resource=\"#" + none + "\"/>\n" else "")
    }
    override def export: String =
    {
        "\t<cim:DroopSignalFeedbackKind rdf:ID=\"" + id + "\">\n" +
        export_fields +
...
{
    val electricalPower: (Context) => String = parse_attribute (attribute ("""DroopSignalFeedbackKind.electricalPower"""))
    val fuelValveStroke: (Context) => String = parse_attribute (attribute ("""DroopSignalFeedbackKind.fuelValveStroke"""))
    val governorOutput: (Context) => String = parse_attribute (attribute ("""DroopSignalFeedbackKind.governorOutput"""))
    val none: (Context) => String = parse_attribute (attribute ("""DroopSignalFeedbackKind.none"""))
...
(
    override val sup: BasicElement,
    electromechanicalElectrohydraulic: String,
    mechanicHydraulicTransientFeedback: String,
    mechanicHydrolicTachoAccelerator: String
)
extends
    Element
{
    ...
    def Element: Element = sup.asInstanceOf[Element]
    override def copy (): Row = { clone ().asInstanceOf[FrancisGovernorControlKind] }
    override def get (i: Int): Object =
    {
        if (i < productArity)
            productElement (i).asInstanceOf[AnyRef]
    ...
    {
        sup.export_fields +
        (if (null != electromechanicalElectrohydraulic) "\t\t<cim:FrancisGovernorControlKind.electromechanicalElectrohydraulic rdf:resource=\"#" + electromechanicalElectrohydraulic + "\"/>\n" else "") +
        (if (null != mechanicHydraulicTransientFeedback) "\t\t<cim:FrancisGovernorControlKind.mechanicHydraulicTransientFeedback rdf:resource=\"#" + mechanicHydraulicTransientFeedback + "\"/>\n" else "") +
        (if (null != mechanicHydrolicTachoAccelerator) "\t\t<cim:FrancisGovernorControlKind.mechanicHydrolicTachoAccelerator rdf:resource=\"#" + mechanicHydrolicTachoAccelerator + "\"/>\n" else "")
    }
    override def export: String =
    {
        "\t<cim:FrancisGovernorControlKind rdf:ID=\"" + id + "\">\n" +
        export_fields +
...
{
    val electromechanicalElectrohydraulic: (Context) => String = parse_attribute (attribute ("""FrancisGovernorControlKind.electromechanicalElectrohydraulic"""))
    val mechanicHydraulicTransientFeedback: (Context) => String = parse_attribute (attribute ("""FrancisGovernorControlKind.mechanicHydraulicTransientFeedback"""))
    val mechanicHydrolicTachoAccelerator: (Context) => String = parse_attribute (attribute ("""FrancisGovernorControlKind.mechanicHydrolicTachoAccelerator"""))
...
extends
    Parseable[GovCT1]
{
    val aset: (Context) => String = parse_element (element ("""GovCT1.aset"""))
    val db: (Context) => String = parse_element (element ("""GovCT1.db"""))
    val dm: (Context) => String = parse_element (element ("""GovCT1.dm"""))
    val ka: (Context) => String = parse_element (element ("""GovCT1.ka"""))
    val kdgov: (Context) => String = parse_element (element ("""GovCT1.kdgov"""))
    val kigov: (Context) => String = parse_element (element ("""GovCT1.kigov"""))
    val kiload: (Context) => String = parse_element (element ("""GovCT1.kiload"""))
    val kimw: (Context) => String = parse_element (element ("""GovCT1.kimw"""))
    val kpgov: (Context) => String = parse_element (element ("""GovCT1.kpgov"""))
    val kpload: (Context) => String = parse_element (element ("""GovCT1.kpload"""))
    val kturb: (Context) => String = parse_element (element ("""GovCT1.kturb"""))
    val ldref: (Context) => String = parse_element (element ("""GovCT1.ldref"""))
    val maxerr: (Context) => String = parse_element (element ("""GovCT1.maxerr"""))
    val minerr: (Context) => String = parse_element (element ("""GovCT1.minerr"""))
    val mwbase: (Context) => String = parse_element (element ("""GovCT1.mwbase"""))
    val r: (Context) => String = parse_element (element ("""GovCT1.r"""))
    val rclose: (Context) => String = parse_element (element ("""GovCT1.rclose"""))
    val rdown: (Context) => String = parse_element (element ("""GovCT1.rdown"""))
    val ropen: (Context) => String = parse_element (element ("""GovCT1.ropen"""))
    val rselect: (Context) => String = parse_attribute (attribute ("""GovCT1.rselect"""))
    val rup: (Context) => String = parse_element (element ("""GovCT1.rup"""))
    val ta: (Context) => String = parse_element (element ("""GovCT1.ta"""))
    val tact: (Context) => String = parse_element (element ("""GovCT1.tact"""))
    val tb: (Context) => String = parse_element (element ("""GovCT1.tb"""))
    val tc: (Context) => String = parse_element (element ("""GovCT1.tc"""))
    val tdgov: (Context) => String = parse_element (element ("""GovCT1.tdgov"""))
    val teng: (Context) => String = parse_element (element ("""GovCT1.teng"""))
    val tfload: (Context) => String = parse_element (element ("""GovCT1.tfload"""))
    val tpelec: (Context) => String = parse_element (element ("""GovCT1.tpelec"""))
    val tsa: (Context) => String = parse_element (element ("""GovCT1.tsa"""))
    val tsb: (Context) => String = parse_element (element ("""GovCT1.tsb"""))
    val vmax: (Context) => String = parse_element (element ("""GovCT1.vmax"""))
    val vmin: (Context) => String = parse_element (element ("""GovCT1.vmin"""))
    val wfnl: (Context) => String = parse_element (element ("""GovCT1.wfnl"""))
    val wfspd: (Context) => String = parse_element (element ("""GovCT1.wfspd"""))
...
extends
    Parseable[GovCT2]
{
    val aset: (Context) => String = parse_element (element ("""GovCT2.aset"""))
    val db: (Context) => String = parse_element (element ("""GovCT2.db"""))
    val dm: (Context) => String = parse_element (element ("""GovCT2.dm"""))
    val flim1: (Context) => String = parse_element (element ("""GovCT2.flim1"""))
    val flim10: (Context) => String = parse_element (element ("""GovCT2.flim10"""))
    val flim2: (Context) => String = parse_element (element ("""GovCT2.flim2"""))
    val flim3: (Context) => String = parse_element (element ("""GovCT2.flim3"""))
    val flim4: (Context) => String = parse_element (element ("""GovCT2.flim4"""))
    val flim5: (Context) => String = parse_element (element ("""GovCT2.flim5"""))
    val flim6: (Context) => String = parse_element (element ("""GovCT2.flim6"""))
    val flim7: (Context) => String = parse_element (element ("""GovCT2.flim7"""))
    val flim8: (Context) => String = parse_element (element ("""GovCT2.flim8"""))
    val flim9: (Context) => String = parse_element (element ("""GovCT2.flim9"""))
    val ka: (Context) => String = parse_element (element ("""GovCT2.ka"""))
    val kdgov: (Context) => String = parse_element (element ("""GovCT2.kdgov"""))
    val kigov: (Context) => String = parse_element (element ("""GovCT2.kigov"""))
    val kiload: (Context) => String = parse_element (element ("""GovCT2.kiload"""))
    val kimw: (Context) => String = parse_element (element ("""GovCT2.kimw"""))
    val kpgov: (Context) => String = parse_element (element ("""GovCT2.kpgov"""))
    val kpload: (Context) => String = parse_element (element ("""GovCT2.kpload"""))
    val kturb: (Context) => String = parse_element (element ("""GovCT2.kturb"""))
    val ldref: (Context) => String = parse_element (element ("""GovCT2.ldref"""))
    val maxerr: (Context) => String = parse_element (element ("""GovCT2.maxerr"""))
    val minerr: (Context) => String = parse_element (element ("""GovCT2.minerr"""))
    val mwbase: (Context) => String = parse_element (element ("""GovCT2.mwbase"""))
    val plim1: (Context) => String = parse_element (element ("""GovCT2.plim1"""))
    val plim10: (Context) => String = parse_element (element ("""GovCT2.plim10"""))
    val plim2: (Context) => String = parse_element (element ("""GovCT2.plim2"""))
    val plim3: (Context) => String = parse_element (element ("""GovCT2.plim3"""))
    val plim4: (Context) => String = parse_element (element ("""GovCT2.plim4"""))
    val plim5: (Context) => String = parse_element (element ("""GovCT2.plim5"""))
    val plim6: (Context) => String = parse_element (element ("""GovCT2.plim6"""))
    val plim7: (Context) => String = parse_element (element ("""GovCT2.plim7"""))
    val plim8: (Context) => String = parse_element (element ("""GovCT2.plim8"""))
    val plim9: (Context) => String = parse_element (element ("""GovCT2.plim9"""))
    val prate: (Context) => String = parse_element (element ("""GovCT2.prate"""))
    val r: (Context) => String = parse_element (element ("""GovCT2.r"""))
    val rclose: (Context) => String = parse_element (element ("""GovCT2.rclose"""))
    val rdown: (Context) => String = parse_element (element ("""GovCT2.rdown"""))
    val ropen: (Context) => String = parse_element (element ("""GovCT2.ropen"""))
    val rselect: (Context) => String = parse_attribute (attribute ("""GovCT2.rselect"""))
    val rup: (Context) => String = parse_element (element ("""GovCT2.rup"""))
    val ta: (Context) => String = parse_element (element ("""GovCT2.ta"""))
    val tact: (Context) => String = parse_element (element ("""GovCT2.tact"""))
    val tb: (Context) => String = parse_element (element ("""GovCT2.tb"""))
    val tc: (Context) => String = parse_element (element ("""GovCT2.tc"""))
    val tdgov: (Context) => String = parse_element (element ("""GovCT2.tdgov"""))
    val teng: (Context) => String = parse_element (element ("""GovCT2.teng"""))
    val tfload: (Context) => String = parse_element (element ("""GovCT2.tfload"""))
    val tpelec: (Context) => String = parse_element (element ("""GovCT2.tpelec"""))
    val tsa: (Context) => String = parse_element (element ("""GovCT2.tsa"""))
    val tsb: (Context) => String = parse_element (element ("""GovCT2.tsb"""))
    val vmax: (Context) => String = parse_element (element ("""GovCT2.vmax"""))
    val vmin: (Context) => String = parse_element (element ("""GovCT2.vmin"""))
    val wfnl: (Context) => String = parse_element (element ("""GovCT2.wfnl"""))
    val wfspd: (Context) => String = parse_element (element ("""GovCT2.wfspd"""))
...
extends
    Parseable[GovGAST]
{
    val at: (Context) => String = parse_element (element ("""GovGAST.at"""))
    val dturb: (Context) => String = parse_element (element ("""GovGAST.dturb"""))
    val kt: (Context) => String = parse_element (element ("""GovGAST.kt"""))
    val mwbase: (Context) => String = parse_element (element ("""GovGAST.mwbase"""))
    val r: (Context) => String = parse_element (element ("""GovGAST.r"""))
    val t1: (Context) => String = parse_element (element ("""GovGAST.t1"""))
    val t2: (Context) => String = parse_element (element ("""GovGAST.t2"""))
    val t3: (Context) => String = parse_element (element ("""GovGAST.t3"""))
    val vmax: (Context) => String = parse_element (element ("""GovGAST.vmax"""))
    val vmin: (Context) => String = parse_element (element ("""GovGAST.vmin"""))
...
extends
    Parseable[GovGAST1]
{
    val a: (Context) => String = parse_element (element ("""GovGAST1.a"""))
    val b: (Context) => String = parse_element (element ("""GovGAST1.b"""))
    val db1: (Context) => String = parse_element (element ("""GovGAST1.db1"""))
    val db2: (Context) => String = parse_element (element ("""GovGAST1.db2"""))
    val eps: (Context) => String = parse_element (element ("""GovGAST1.eps"""))
    val fidle: (Context) => String = parse_element (element ("""GovGAST1.fidle"""))
    val gv1: (Context) => String = parse_element (element ("""GovGAST1.gv1"""))
    val gv2: (Context) => String = parse_element (element ("""GovGAST1.gv2"""))
    val gv3: (Context) => String = parse_element (element ("""GovGAST1.gv3"""))
    val gv4: (Context) => String = parse_element (element ("""GovGAST1.gv4"""))
    val gv5: (Context) => String = parse_element (element ("""GovGAST1.gv5"""))
    val gv6: (Context) => String = parse_element (element ("""GovGAST1.gv6"""))
    val ka: (Context) => String = parse_element (element ("""GovGAST1.ka"""))
    val kt: (Context) => String = parse_element (element ("""GovGAST1.kt"""))
    val lmax: (Context) => String = parse_element (element ("""GovGAST1.lmax"""))
    val loadinc: (Context) => String = parse_element (element ("""GovGAST1.loadinc"""))
    val ltrate: (Context) => String = parse_element (element ("""GovGAST1.ltrate"""))
    val mwbase: (Context) => String = parse_element (element ("""GovGAST1.mwbase"""))
    val pgv1: (Context) => String = parse_element (element ("""GovGAST1.pgv1"""))
    val pgv2: (Context) => String = parse_element (element ("""GovGAST1.pgv2"""))
    val pgv3: (Context) => String = parse_element (element ("""GovGAST1.pgv3"""))
    val pgv4: (Context) => String = parse_element (element ("""GovGAST1.pgv4"""))
    val pgv5: (Context) => String = parse_element (element ("""GovGAST1.pgv5"""))
    val pgv6: (Context) => String = parse_element (element ("""GovGAST1.pgv6"""))
    val r: (Context) => String = parse_element (element ("""GovGAST1.r"""))
    val rmax: (Context) => String = parse_element (element ("""GovGAST1.rmax"""))
    val t1: (Context) => String = parse_element (element ("""GovGAST1.t1"""))
    val t2: (Context) => String = parse_element (element ("""GovGAST1.t2"""))
    val t3: (Context) => String = parse_element (element ("""GovGAST1.t3"""))
    val t4: (Context) => String = parse_element (element ("""GovGAST1.t4"""))
    val t5: (Context) => String = parse_element (element ("""GovGAST1.t5"""))
    val tltr: (Context) => String = parse_element (element ("""GovGAST1.tltr"""))
    val vmax: (Context) => String = parse_element (element ("""GovGAST1.vmax"""))
    val vmin: (Context) => String = parse_element (element ("""GovGAST1.vmin"""))
...
extends
    Parseable[GovGAST2]
{
    val a: (Context) => String = parse_element (element ("""GovGAST2.a"""))
    val af1: (Context) => String = parse_element (element ("""GovGAST2.af1"""))
    val af2: (Context) => String = parse_element (element ("""GovGAST2.af2"""))
    val b: (Context) => String = parse_element (element ("""GovGAST2.b"""))
    val bf1: (Context) => String = parse_element (element ("""GovGAST2.bf1"""))
    val bf2: (Context) => String = parse_element (element ("""GovGAST2.bf2"""))
    val c: (Context) => String = parse_element (element ("""GovGAST2.c"""))
    val cf2: (Context) => String = parse_element (element ("""GovGAST2.cf2"""))
    val ecr: (Context) => String = parse_element (element ("""GovGAST2.ecr"""))
    val etd: (Context) => String = parse_element (element ("""GovGAST2.etd"""))
    val k3: (Context) => String = parse_element (element ("""GovGAST2.k3"""))
    val k4: (Context) => String = parse_element (element ("""GovGAST2.k4"""))
    val k5: (Context) => String = parse_element (element ("""GovGAST2.k5"""))
    val k6: (Context) => String = parse_element (element ("""GovGAST2.k6"""))
    val kf: (Context) => String = parse_element (element ("""GovGAST2.kf"""))
    val mwbase: (Context) => String = parse_element (element ("""GovGAST2.mwbase"""))
    val t: (Context) => String = parse_element (element ("""GovGAST2.t"""))
    val t3: (Context) => String = parse_element (element ("""GovGAST2.t3"""))
    val t4: (Context) => String = parse_element (element ("""GovGAST2.t4"""))
    val t5: (Context) => String = parse_element (element ("""GovGAST2.t5"""))
    val tc: (Context) => String = parse_element (element ("""GovGAST2.tc"""))
    val tcd: (Context) => String = parse_element (element ("""GovGAST2.tcd"""))
    val tf: (Context) => String = parse_element (element ("""GovGAST2.tf"""))
    val tmax: (Context) => String = parse_element (element ("""GovGAST2.tmax"""))
    val tmin: (Context) => String = parse_element (element ("""GovGAST2.tmin"""))
    val tr: (Context) => String = parse_element (element ("""GovGAST2.tr"""))
    val trate: (Context) => String = parse_element (element ("""GovGAST2.trate"""))
    val tt: (Context) => String = parse_element (element ("""GovGAST2.tt"""))
    val w: (Context) => String = parse_element (element ("""GovGAST2.w"""))
    val x: (Context) => String = parse_element (element ("""GovGAST2.x"""))
    val y: (Context) => String = parse_element (element ("""GovGAST2.y"""))
    val z: (Context) => String = parse_element (element ("""GovGAST2.z"""))
...
extends
    Parseable[GovGAST3]
{
    val bca: (Context) => String = parse_element (element ("""GovGAST3.bca"""))
    val bp: (Context) => String = parse_element (element ("""GovGAST3.bp"""))
    val dtc: (Context) => String = parse_element (element ("""GovGAST3.dtc"""))
    val ka: (Context) => String = parse_element (element ("""GovGAST3.ka"""))
    val kac: (Context) => String = parse_element (element ("""GovGAST3.kac"""))
    val kca: (Context) => String = parse_element (element ("""GovGAST3.kca"""))
    val ksi: (Context) => String = parse_element (element ("""GovGAST3.ksi"""))
    val ky: (Context) => String = parse_element (element ("""GovGAST3.ky"""))
    val mnef: (Context) => String = parse_element (element ("""GovGAST3.mnef"""))
    val mxef: (Context) => String = parse_element (element ("""GovGAST3.mxef"""))
    val rcmn: (Context) => String = parse_element (element ("""GovGAST3.rcmn"""))
    val rcmx: (Context) => String = parse_element (element ("""GovGAST3.rcmx"""))
    val tac: (Context) => String = parse_element (element ("""GovGAST3.tac"""))
    val tc: (Context) => String = parse_element (element ("""GovGAST3.tc"""))
    val td: (Context) => String = parse_element (element ("""GovGAST3.td"""))
    val tfen: (Context) => String = parse_element (element ("""GovGAST3.tfen"""))
    val tg: (Context) => String = parse_element (element ("""GovGAST3.tg"""))
    val tsi: (Context) => String = parse_element (element ("""GovGAST3.tsi"""))
    val tt: (Context) => String = parse_element (element ("""GovGAST3.tt"""))
    val ttc: (Context) => String = parse_element (element ("""GovGAST3.ttc"""))
    val ty: (Context) => String = parse_element (element ("""GovGAST3.ty"""))
...
extends
    Parseable[GovGAST4]
{
    val bp: (Context) => String = parse_element (element ("""GovGAST4.bp"""))
    val ktm: (Context) => String = parse_element (element ("""GovGAST4.ktm"""))
    val mnef: (Context) => String = parse_element (element ("""GovGAST4.mnef"""))
    val mxef: (Context) => String = parse_element (element ("""GovGAST4.mxef"""))
    val rymn: (Context) => String = parse_element (element ("""GovGAST4.rymn"""))
    val rymx: (Context) => String = parse_element (element ("""GovGAST4.rymx"""))
    val ta: (Context) => String = parse_element (element ("""GovGAST4.ta"""))
    val tc: (Context) => String = parse_element (element ("""GovGAST4.tc"""))
    val tcm: (Context) => String = parse_element (element ("""GovGAST4.tcm"""))
    val tm: (Context) => String = parse_element (element ("""GovGAST4.tm"""))
    val tv: (Context) => String = parse_element (element ("""GovGAST4.tv"""))
...
extends
    Parseable[GovGASTWD]
{
    val a: (Context) => String = parse_element (element ("""GovGASTWD.a"""))
    val af1: (Context) => String = parse_element (element ("""GovGASTWD.af1"""))
    val af2: (Context) => String = parse_element (element ("""GovGASTWD.af2"""))
    val b: (Context) => String = parse_element (element ("""GovGASTWD.b"""))
    val bf1: (Context) => String = parse_element (element ("""GovGASTWD.bf1"""))
    val bf2: (Context) => String = parse_element (element ("""GovGASTWD.bf2"""))
    val c: (Context) => String = parse_element (element ("""GovGASTWD.c"""))
    val cf2: (Context) => String = parse_element (element ("""GovGASTWD.cf2"""))
    val ecr: (Context) => String = parse_element (element ("""GovGASTWD.ecr"""))
    val etd: (Context) => String = parse_element (element ("""GovGASTWD.etd"""))
    val k3: (Context) => String = parse_element (element ("""GovGASTWD.k3"""))
    val k4: (Context) => String = parse_element (element ("""GovGASTWD.k4"""))
    val k5: (Context) => String = parse_element (element ("""GovGASTWD.k5"""))
    val k6: (Context) => String = parse_element (element ("""GovGASTWD.k6"""))
    val kd: (Context) => String = parse_element (element ("""GovGASTWD.kd"""))
    val kdroop: (Context) => String = parse_element (element ("""GovGASTWD.kdroop"""))
    val kf: (Context) => String = parse_element (element ("""GovGASTWD.kf"""))
    val ki: (Context) => String = parse_element (element ("""GovGASTWD.ki"""))
    val kp: (Context) => String = parse_element (element ("""GovGASTWD.kp"""))
    val mwbase: (Context) => String = parse_element (element ("""GovGASTWD.mwbase"""))
    val t: (Context) => String = parse_element (element ("""GovGASTWD.t"""))
    val t3: (Context) => String = parse_element (element ("""GovGASTWD.t3"""))
    val t4: (Context) => String = parse_element (element ("""GovGASTWD.t4"""))
    val t5: (Context) => String = parse_element (element ("""GovGASTWD.t5"""))
    val tc: (Context) => String = parse_element (element ("""GovGASTWD.tc"""))
    val tcd: (Context) => String = parse_element (element ("""GovGASTWD.tcd"""))
    val td: (Context) => String = parse_element (element ("""GovGASTWD.td"""))
    val tf: (Context) => String = parse_element (element ("""GovGASTWD.tf"""))
    val tmax: (Context) => String = parse_element (element ("""GovGASTWD.tmax"""))
    val tmin: (Context) => String = parse_element (element ("""GovGASTWD.tmin"""))
    val tr: (Context) => String = parse_element (element ("""GovGASTWD.tr"""))
    val trate: (Context) => String = parse_element (element ("""GovGASTWD.trate"""))
    val tt: (Context) => String = parse_element (element ("""GovGASTWD.tt"""))
...
extends
    Parseable[GovHydro1]
{
    val at: (Context) => String = parse_element (element ("""GovHydro1.at"""))
    val dturb: (Context) => String = parse_element (element ("""GovHydro1.dturb"""))
    val gmax: (Context) => String = parse_element (element ("""GovHydro1.gmax"""))
    val gmin: (Context) => String = parse_element (element ("""GovHydro1.gmin"""))
    val hdam: (Context) => String = parse_element (element ("""GovHydro1.hdam"""))
    val mwbase: (Context) => String = parse_element (element ("""GovHydro1.mwbase"""))
    val qnl: (Context) => String = parse_element (element ("""GovHydro1.qnl"""))
    val rperm: (Context) => String = parse_element (element ("""GovHydro1.rperm"""))
    val rtemp: (Context) => String = parse_element (element ("""GovHydro1.rtemp"""))
    val tf: (Context) => String = parse_element (element ("""GovHydro1.tf"""))
    val tg: (Context) => String = parse_element (element ("""GovHydro1.tg"""))
    val tr: (Context) => String = parse_element (element ("""GovHydro1.tr"""))
    val tw: (Context) => String = parse_element (element ("""GovHydro1.tw"""))
    val velm: (Context) => String = parse_element (element ("""GovHydro1.velm"""))
...
extends
    Parseable[GovHydro2]
{
    val aturb: (Context) => String = parse_element (element ("""GovHydro2.aturb"""))
    val bturb: (Context) => String = parse_element (element ("""GovHydro2.bturb"""))
    val db1: (Context) => String = parse_element (element ("""GovHydro2.db1"""))
    val db2: (Context) => String = parse_element (element ("""GovHydro2.db2"""))
    val eps: (Context) => String = parse_element (element ("""GovHydro2.eps"""))
    val gv1: (Context) => String = parse_element (element ("""GovHydro2.gv1"""))
    val gv2: (Context) => String = parse_element (element ("""GovHydro2.gv2"""))
    val gv3: (Context) => String = parse_element (element ("""GovHydro2.gv3"""))
    val gv4: (Context) => String = parse_element (element ("""GovHydro2.gv4"""))
    val gv5: (Context) => String = parse_element (element ("""GovHydro2.gv5"""))
    val gv6: (Context) => String = parse_element (element ("""GovHydro2.gv6"""))
    val kturb: (Context) => String = parse_element (element ("""GovHydro2.kturb"""))
    val mwbase: (Context) => String = parse_element (element ("""GovHydro2.mwbase"""))
    val pgv1: (Context) => String = parse_element (element ("""GovHydro2.pgv1"""))
    val pgv2: (Context) => String = parse_element (element ("""GovHydro2.pgv2"""))
    val pgv3: (Context) => String = parse_element (element ("""GovHydro2.pgv3"""))
    val pgv4: (Context) => String = parse_element (element ("""GovHydro2.pgv4"""))
    val pgv5: (Context) => String = parse_element (element ("""GovHydro2.pgv5"""))
    val pgv6: (Context) => String = parse_element (element ("""GovHydro2.pgv6"""))
    val pmax: (Context) => String = parse_element (element ("""GovHydro2.pmax"""))
    val pmin: (Context) => String = parse_element (element ("""GovHydro2.pmin"""))
    val rperm: (Context) => String = parse_element (element ("""GovHydro2.rperm"""))
    val rtemp: (Context) => String = parse_element (element ("""GovHydro2.rtemp"""))
    val tg: (Context) => String = parse_element (element ("""GovHydro2.tg"""))
    val tp: (Context) => String = parse_element (element ("""GovHydro2.tp"""))
    val tr: (Context) => String = parse_element (element ("""GovHydro2.tr"""))
    val tw: (Context) => String = parse_element (element ("""GovHydro2.tw"""))
    val uc: (Context) => String = parse_element (element ("""GovHydro2.uc"""))
    val uo: (Context) => String = parse_element (element ("""GovHydro2.uo"""))
...
extends
    Parseable[GovHydro3]
{
    val at: (Context) => String = parse_element (element ("""GovHydro3.at"""))
    val db1: (Context) => String = parse_element (element ("""GovHydro3.db1"""))
    val db2: (Context) => String = parse_element (element ("""GovHydro3.db2"""))
    val dturb: (Context) => String = parse_element (element ("""GovHydro3.dturb"""))
    val eps: (Context) => String = parse_element (element ("""GovHydro3.eps"""))
    val governorControl: (Context) => String = parse_element (element ("""GovHydro3.governorControl"""))
    val gv1: (Context) => String = parse_element (element ("""GovHydro3.gv1"""))
    val gv2: (Context) => String = parse_element (element ("""GovHydro3.gv2"""))
    val gv3: (Context) => String = parse_element (element ("""GovHydro3.gv3"""))
    val gv4: (Context) => String = parse_element (element ("""GovHydro3.gv4"""))
    val gv5: (Context) => String = parse_element (element ("""GovHydro3.gv5"""))
    val gv6: (Context) => String = parse_element (element ("""GovHydro3.gv6"""))
    val h0: (Context) => String = parse_element (element ("""GovHydro3.h0"""))
    val k1: (Context) => String = parse_element (element ("""GovHydro3.k1"""))
    val k2: (Context) => String = parse_element (element ("""GovHydro3.k2"""))
    val kg: (Context) => String = parse_element (element ("""GovHydro3.kg"""))
    val ki: (Context) => String = parse_element (element ("""GovHydro3.ki"""))
    val mwbase: (Context) => String = parse_element (element ("""GovHydro3.mwbase"""))
    val pgv1: (Context) => String = parse_element (element ("""GovHydro3.pgv1"""))
    val pgv2: (Context) => String = parse_element (element ("""GovHydro3.pgv2"""))
    val pgv3: (Context) => String = parse_element (element ("""GovHydro3.pgv3"""))
    val pgv4: (Context) => String = parse_element (element ("""GovHydro3.pgv4"""))
    val pgv5: (Context) => String = parse_element (element ("""GovHydro3.pgv5"""))
    val pgv6: (Context) => String = parse_element (element ("""GovHydro3.pgv6"""))
    val pmax: (Context) => String = parse_element (element ("""GovHydro3.pmax"""))
    val pmin: (Context) => String = parse_element (element ("""GovHydro3.pmin"""))
    val qnl: (Context) => String = parse_element (element ("""GovHydro3.qnl"""))
    val relec: (Context) => String = parse_element (element ("""GovHydro3.relec"""))
    val rgate: (Context) => String = parse_element (element ("""GovHydro3.rgate"""))
    val td: (Context) => String = parse_element (element ("""GovHydro3.td"""))
    val tf: (Context) => String = parse_element (element ("""GovHydro3.tf"""))
    val tp: (Context) => String = parse_element (element ("""GovHydro3.tp"""))
    val tt: (Context) => String = parse_element (element ("""GovHydro3.tt"""))
    val tw: (Context) => String = parse_element (element ("""GovHydro3.tw"""))
    val velcl: (Context) => String = parse_element (element ("""GovHydro3.velcl"""))
    val velop: (Context) => String = parse_element (element ("""GovHydro3.velop"""))
...
extends
    Parseable[GovHydro4]
{
    val at: (Context) => String = parse_element (element ("""GovHydro4.at"""))
    val bgv0: (Context) => String = parse_element (element ("""GovHydro4.bgv0"""))
    val bgv1: (Context) => String = parse_element (element ("""GovHydro4.bgv1"""))
    val bgv2: (Context) => String = parse_element (element ("""GovHydro4.bgv2"""))
    val bgv3: (Context) => String = parse_element (element ("""GovHydro4.bgv3"""))
    val bgv4: (Context) => String = parse_element (element ("""GovHydro4.bgv4"""))
    val bgv5: (Context) => String = parse_element (element ("""GovHydro4.bgv5"""))
    val bmax: (Context) => String = parse_element (element ("""GovHydro4.bmax"""))
    val db1: (Context) => String = parse_element (element ("""GovHydro4.db1"""))
    val db2: (Context) => String = parse_element (element ("""GovHydro4.db2"""))
    val dturb: (Context) => String = parse_element (element ("""GovHydro4.dturb"""))
    val eps: (Context) => String = parse_element (element ("""GovHydro4.eps"""))
    val gmax: (Context) => String = parse_element (element ("""GovHydro4.gmax"""))
    val gmin: (Context) => String = parse_element (element ("""GovHydro4.gmin"""))
    val gv0: (Context) => String = parse_element (element ("""GovHydro4.gv0"""))
    val gv1: (Context) => String = parse_element (element ("""GovHydro4.gv1"""))
    val gv2: (Context) => String = parse_element (element ("""GovHydro4.gv2"""))
    val gv3: (Context) => String = parse_element (element ("""GovHydro4.gv3"""))
    val gv4: (Context) => String = parse_element (element ("""GovHydro4.gv4"""))
    val gv5: (Context) => String = parse_element (element ("""GovHydro4.gv5"""))
    val hdam: (Context) => String = parse_element (element ("""GovHydro4.hdam"""))
    val mwbase: (Context) => String = parse_element (element ("""GovHydro4.mwbase"""))
    val pgv0: (Context) => String = parse_element (element ("""GovHydro4.pgv0"""))
    val pgv1: (Context) => String = parse_element (element ("""GovHydro4.pgv1"""))
    val pgv2: (Context) => String = parse_element (element ("""GovHydro4.pgv2"""))
    val pgv3: (Context) => String = parse_element (element ("""GovHydro4.pgv3"""))
    val pgv4: (Context) => String = parse_element (element ("""GovHydro4.pgv4"""))
    val pgv5: (Context) => String = parse_element (element ("""GovHydro4.pgv5"""))
    val qn1: (Context) => String = parse_element (element ("""GovHydro4.qn1"""))
    val rperm: (Context) => String = parse_element (element ("""GovHydro4.rperm"""))
    val rtemp: (Context) => String = parse_element (element ("""GovHydro4.rtemp"""))
    val tblade: (Context) => String = parse_element (element ("""GovHydro4.tblade"""))
    val tg: (Context) => String = parse_element (element ("""GovHydro4.tg"""))
    val tp: (Context) => String = parse_element (element ("""GovHydro4.tp"""))
    val tr: (Context) => String = parse_element (element ("""GovHydro4.tr"""))
    val tw: (Context) => String = parse_element (element ("""GovHydro4.tw"""))
    val uc: (Context) => String = parse_element (element ("""GovHydro4.uc"""))
    val uo: (Context) => String = parse_element (element ("""GovHydro4.uo"""))
...
{
    val aturb: (Context) => String = parse_element (element ("""GovHydroDD.aturb"""))
    val bturb: (Context) => String = parse_element (element ("""GovHydroDD.bturb"""))
    val db1: (Context) => String = parse_element (element ("""GovHydroDD.db1"""))
    val db2: (Context) => String = parse_element (element ("""GovHydroDD.db2"""))
    val eps: (Context) => String = parse_element (element ("""GovHydroDD.eps"""))
    val gmax: (Context) => String = parse_element (element ("""GovHydroDD.gmax"""))
    val gmin: (Context) => String = parse_element (element ("""GovHydroDD.gmin"""))
    val gv1: (Context) => String = parse_element (element ("""GovHydroDD.gv1"""))
    val gv2: (Context) => String = parse_element (element ("""GovHydroDD.gv2"""))
    val gv3: (Context) => String = parse_element (element ("""GovHydroDD.gv3"""))
    val gv4: (Context) => String = parse_element (element ("""GovHydroDD.gv4"""))
    val gv5: (Context) => String = parse_element (element ("""GovHydroDD.gv5"""))
    val gv6: (Context) => String = parse_element (element ("""GovHydroDD.gv6"""))
    val inputSignal: (Context) => String = parse_element (element ("""GovHydroDD.inputSignal"""))
    val k1: (Context) => String = parse_element (element ("""GovHydroDD.k1"""))
    val k2: (Context) => String = parse_element (element ("""GovHydroDD.k2"""))
    val kg: (Context) => String = parse_element (element ("""GovHydroDD.kg"""))
    val ki: (Context) => String = parse_element (element ("""GovHydroDD.ki"""))
    val mwbase: (Context) => String = parse_element (element ("""GovHydroDD.mwbase"""))
    val pgv1: (Context) => String = parse_element (element ("""GovHydroDD.pgv1"""))
    val pgv2: (Context) => String = parse_element (element ("""GovHydroDD.pgv2"""))
    val pgv3: (Context) => String = parse_element (element ("""GovHydroDD.pgv3"""))
    val pgv4: (Context) => String = parse_element (element ("""GovHydroDD.pgv4"""))
    val pgv5: (Context) => String = parse_element (element ("""GovHydroDD.pgv5"""))
    val pgv6: (Context) => String = parse_element (element ("""GovHydroDD.pgv6"""))
    val pmax: (Context) => String = parse_element (element ("""GovHydroDD.pmax"""))
    val pmin: (Context) => String = parse_element (element ("""GovHydroDD.pmin"""))
    val r: (Context) => String = parse_element (element ("""GovHydroDD.r"""))
    val td: (Context) => String = parse_element (element ("""GovHydroDD.td"""))
    val tf: (Context) => String = parse_element (element ("""GovHydroDD.tf"""))
    val tp: (Context) => String = parse_element (element ("""GovHydroDD.tp"""))
    val tt: (Context) => String = parse_element (element ("""GovHydroDD.tt"""))
    val tturb: (Context) => String = parse_element (element ("""GovHydroDD.tturb"""))
    val velcl: (Context) => String = parse_element (element ("""GovHydroDD.velcl"""))
    val velop: (Context) => String = parse_element (element ("""GovHydroDD.velop"""))
...
{
    val am: (Context) => String = parse_element (element ("""GovHydroFrancis.am"""))
    val av0: (Context) => String = parse_element (element ("""GovHydroFrancis.av0"""))
    val av1: (Context) => String = parse_element (element ("""GovHydroFrancis.av1"""))
    val bp: (Context) => String = parse_element (element ("""GovHydroFrancis.bp"""))
    val db1: (Context) => String = parse_element (element ("""GovHydroFrancis.db1"""))
    val etamax: (Context) => String = parse_element (element ("""GovHydroFrancis.etamax"""))
    val governorControl: (Context) => String = parse_attribute (attribute ("""GovHydroFrancis.governorControl"""))
    val h1: (Context) => String = parse_element (element ("""GovHydroFrancis.h1"""))
    val h2: (Context) => String = parse_element (element ("""GovHydroFrancis.h2"""))
    val hn: (Context) => String = parse_element (element ("""GovHydroFrancis.hn"""))
    val kc: (Context) => String = parse_element (element ("""GovHydroFrancis.kc"""))
    val kg: (Context) => String = parse_element (element ("""GovHydroFrancis.kg"""))
    val kt: (Context) => String = parse_element (element ("""GovHydroFrancis.kt"""))
    val qc0: (Context) => String = parse_element (element ("""GovHydroFrancis.qc0"""))
    val qn: (Context) => String = parse_element (element ("""GovHydroFrancis.qn"""))
    val ta: (Context) => String = parse_element (element ("""GovHydroFrancis.ta"""))
    val td: (Context) => String = parse_element (element ("""GovHydroFrancis.td"""))
    val ts: (Context) => String = parse_element (element ("""GovHydroFrancis.ts"""))
    val twnc: (Context) => String = parse_element (element ("""GovHydroFrancis.twnc"""))
    val twng: (Context) => String = parse_element (element ("""GovHydroFrancis.twng"""))
    val tx: (Context) => String = parse_element (element ("""GovHydroFrancis.tx"""))
    val va: (Context) => String = parse_element (element ("""GovHydroFrancis.va"""))
    val valvmax: (Context) => String = parse_element (element ("""GovHydroFrancis.valvmax"""))
    val valvmin: (Context) => String = parse_element (element ("""GovHydroFrancis.valvmin"""))
    val vc: (Context) => String = parse_element (element ("""GovHydroFrancis.vc"""))
    val waterTunnelSurgeChamberSimulation: (Context) => String = parse_element (element ("""GovHydroFrancis.waterTunnelSurgeChamberSimulation"""))
    val zsfc: (Context) => String = parse_element (element ("""GovHydroFrancis.zsfc"""))
...
{
    val k: (Context) => String = parse_element (element ("""GovHydroIEEE0.k"""))
    val mwbase: (Context) => String = parse_element (element ("""GovHydroIEEE0.mwbase"""))
    val pmax: (Context) => String = parse_element (element ("""GovHydroIEEE0.pmax"""))
    val pmin: (Context) => String = parse_element (element ("""GovHydroIEEE0.pmin"""))
    val t1: (Context) => String = parse_element (element ("""GovHydroIEEE0.t1"""))
    val t2: (Context) => String = parse_element (element ("""GovHydroIEEE0.t2"""))
    val t3: (Context) => String = parse_element (element ("""GovHydroIEEE0.t3"""))
    val t4: (Context) => String = parse_element (element ("""GovHydroIEEE0.t4"""))
...
{
    val aturb: (Context) => String = parse_element (element ("""GovHydroIEEE2.aturb"""))
    val bturb: (Context) => String = parse_element (element ("""GovHydroIEEE2.bturb"""))
    val gv1: (Context) => String = parse_element (element ("""GovHydroIEEE2.gv1"""))
    val gv2: (Context) => String = parse_element (element ("""GovHydroIEEE2.gv2"""))
    val gv3: (Context) => String = parse_element (element ("""GovHydroIEEE2.gv3"""))
    val gv4: (Context) => String = parse_element (element ("""GovHydroIEEE2.gv4"""))
    val gv5: (Context) => String = parse_element (element ("""GovHydroIEEE2.gv5"""))
    val gv6: (Context) => String = parse_element (element ("""GovHydroIEEE2.gv6"""))
    val kturb: (Context) => String = parse_element (element ("""GovHydroIEEE2.kturb"""))
    val mwbase: (Context) => String = parse_element (element ("""GovHydroIEEE2.mwbase"""))
    val pgv1: (Context) => String = parse_element (element ("""GovHydroIEEE2.pgv1"""))
    val pgv2: (Context) => String = parse_element (element ("""GovHydroIEEE2.pgv2"""))
    val pgv3: (Context) => String = parse_element (element ("""GovHydroIEEE2.pgv3"""))
    val pgv4: (Context) => String = parse_element (element ("""GovHydroIEEE2.pgv4"""))
    val pgv5: (Context) => String = parse_element (element ("""GovHydroIEEE2.pgv5"""))
    val pgv6: (Context) => String = parse_element (element ("""GovHydroIEEE2.pgv6"""))
    val pmax: (Context) => String = parse_element (element ("""GovHydroIEEE2.pmax"""))
    val pmin: (Context) => String = parse_element (element ("""GovHydroIEEE2.pmin"""))
    val rperm: (Context) => String = parse_element (element ("""GovHydroIEEE2.rperm"""))
    val rtemp: (Context) => String = parse_element (element ("""GovHydroIEEE2.rtemp"""))
    val tg: (Context) => String = parse_element (element ("""GovHydroIEEE2.tg"""))
    val tp: (Context) => String = parse_element (element ("""GovHydroIEEE2.tp"""))
    val tr: (Context) => String = parse_element (element ("""GovHydroIEEE2.tr"""))
    val tw: (Context) => String = parse_element (element ("""GovHydroIEEE2.tw"""))
    val uc: (Context) => String = parse_element (element ("""GovHydroIEEE2.uc"""))
    val uo: (Context) => String = parse_element (element ("""GovHydroIEEE2.uo"""))
...
{
    val aturb: (Context) => String = parse_element (element ("""GovHydroPID.aturb"""))
    val bturb: (Context) => String = parse_element (element ("""GovHydroPID.bturb"""))
    val db1: (Context) => String = parse_element (element ("""GovHydroPID.db1"""))
    val db2: (Context) => String = parse_element (element ("""GovHydroPID.db2"""))
    val eps: (Context) => String = parse_element (element ("""GovHydroPID.eps"""))
    val gv1: (Context) => String = parse_element (element ("""GovHydroPID.gv1"""))
    val gv2: (Context) => String = parse_element (element ("""GovHydroPID.gv2"""))
    val gv3: (Context) => String = parse_element (element ("""GovHydroPID.gv3"""))
    val gv4: (Context) => String = parse_element (element ("""GovHydroPID.gv4"""))
    val gv5: (Context) => String = parse_element (element ("""GovHydroPID.gv5"""))
    val gv6: (Context) => String = parse_element (element ("""GovHydroPID.gv6"""))
    val inputSignal: (Context) => String = parse_element (element ("""GovHydroPID.inputSignal"""))
    val kd: (Context) => String = parse_element (element ("""GovHydroPID.kd"""))
    val kg: (Context) => String = parse_element (element ("""GovHydroPID.kg"""))
    val ki: (Context) => String = parse_element (element ("""GovHydroPID.ki"""))
    val kp: (Context) => String = parse_element (element ("""GovHydroPID.kp"""))
    val mwbase: (Context) => String = parse_element (element ("""GovHydroPID.mwbase"""))
    val pgv1: (Context) => String = parse_element (element ("""GovHydroPID.pgv1"""))
    val pgv2: (Context) => String = parse_element (element ("""GovHydroPID.pgv2"""))
    val pgv3: (Context) => String = parse_element (element ("""GovHydroPID.pgv3"""))
    val pgv4: (Context) => String = parse_element (element ("""GovHydroPID.pgv4"""))
    val pgv5: (Context) => String = parse_element (element ("""GovHydroPID.pgv5"""))
    val pgv6: (Context) => String = parse_element (element ("""GovHydroPID.pgv6"""))
    val pmax: (Context) => String = parse_element (element ("""GovHydroPID.pmax"""))
    val pmin: (Context) => String = parse_element (element ("""GovHydroPID.pmin"""))
    val r: (Context) => String = parse_element (element ("""GovHydroPID.r"""))
    val td: (Context) => String = parse_element (element ("""GovHydroPID.td"""))
    val tf: (Context) => String = parse_element (element ("""GovHydroPID.tf"""))
    val tp: (Context) => String = parse_element (element ("""GovHydroPID.tp"""))
    val tt: (Context) => String = parse_element (element ("""GovHydroPID.tt"""))
    val tturb: (Context) => String = parse_element (element ("""GovHydroPID.tturb"""))
    val velcl: (Context) => String = parse_element (element ("""GovHydroPID.velcl"""))
    val velop: (Context) => String = parse_element (element ("""GovHydroPID.velop"""))
...
{
    val atw: (Context) => String = parse_element (element ("""GovHydroPID2.atw"""))
    val d: (Context) => String = parse_element (element ("""GovHydroPID2.d"""))
    val feedbackSignal: (Context) => String = parse_element (element ("""GovHydroPID2.feedbackSignal"""))
    val g0: (Context) => String = parse_element (element ("""GovHydroPID2.g0"""))
    val g1: (Context) => String = parse_element (element ("""GovHydroPID2.g1"""))
    val g2: (Context) => String = parse_element (element ("""GovHydroPID2.g2"""))
    val gmax: (Context) => String = parse_element (element ("""GovHydroPID2.gmax"""))
    val gmin: (Context) => String = parse_element (element ("""GovHydroPID2.gmin"""))
    val kd: (Context) => String = parse_element (element ("""GovHydroPID2.kd"""))
    val ki: (Context) => String = parse_element (element ("""GovHydroPID2.ki"""))
    val kp: (Context) => String = parse_element (element ("""GovHydroPID2.kp"""))
    val mwbase: (Context) => String = parse_element (element ("""GovHydroPID2.mwbase"""))
    val p1: (Context) => String = parse_element (element ("""GovHydroPID2.p1"""))
    val p2: (Context) => String = parse_element (element ("""GovHydroPID2.p2"""))
    val p3: (Context) => String = parse_element (element ("""GovHydroPID2.p3"""))
    val rperm: (Context) => String = parse_element (element ("""GovHydroPID2.rperm"""))
    val ta: (Context) => String = parse_element (element ("""GovHydroPID2.ta"""))
    val tb: (Context) => String = parse_element (element ("""GovHydroPID2.tb"""))
    val treg: (Context) => String = parse_element (element ("""GovHydroPID2.treg"""))
    val tw: (Context) => String = parse_element (element ("""GovHydroPID2.tw"""))
    val velmax: (Context) => String = parse_element (element ("""GovHydroPID2.velmax"""))
    val velmin: (Context) => String = parse_element (element ("""GovHydroPID2.velmin"""))
...
{
    val av0: (Context) => String = parse_element (element ("""GovHydroPelton.av0"""))
    val av1: (Context) => String = parse_element (element ("""GovHydroPelton.av1"""))
    val bp: (Context) => String = parse_element (element ("""GovHydroPelton.bp"""))
    val db1: (Context) => String = parse_element (element ("""GovHydroPelton.db1"""))
    val db2: (Context) => String = parse_element (element ("""GovHydroPelton.db2"""))
    val h1: (Context) => String = parse_element (element ("""GovHydroPelton.h1"""))
    val h2: (Context) => String = parse_element (element ("""GovHydroPelton.h2"""))
    val hn: (Context) => String = parse_element (element ("""GovHydroPelton.hn"""))
    val kc: (Context) => String = parse_element (element ("""GovHydroPelton.kc"""))
    val kg: (Context) => String = parse_element (element ("""GovHydroPelton.kg"""))
    val qc0: (Context) => String = parse_element (element ("""GovHydroPelton.qc0"""))
    val qn: (Context) => String = parse_element (element ("""GovHydroPelton.qn"""))
    val simplifiedPelton: (Context) => String = parse_element (element ("""GovHydroPelton.simplifiedPelton"""))
    val staticCompensating: (Context) => String = parse_element (element ("""GovHydroPelton.staticCompensating"""))
    val ta: (Context) => String = parse_element (element ("""GovHydroPelton.ta"""))
    val ts: (Context) => String = parse_element (element ("""GovHydroPelton.ts"""))
    val tv: (Context) => String = parse_element (element ("""GovHydroPelton.tv"""))
    val twnc: (Context) => String = parse_element (element ("""GovHydroPelton.twnc"""))
    val twng: (Context) => String = parse_element (element ("""GovHydroPelton.twng"""))
    val tx: (Context) => String = parse_element (element ("""GovHydroPelton.tx"""))
    val va: (Context) => String = parse_element (element ("""GovHydroPelton.va"""))
    val valvmax: (Context) => String = parse_element (element ("""GovHydroPelton.valvmax"""))
    val valvmin: (Context) => String = parse_element (element ("""GovHydroPelton.valvmin"""))
    val vav: (Context) => String = parse_element (element ("""GovHydroPelton.vav"""))
    val vc: (Context) => String = parse_element (element ("""GovHydroPelton.vc"""))
    val vcv: (Context) => String = parse_element (element ("""GovHydroPelton.vcv"""))
    val waterTunnelSurgeChamberSimulation: (Context) => String = parse_element (element ("""GovHydroPelton.waterTunnelSurgeChamberSimulation"""))
    val zsfc: (Context) => String = parse_element (element ("""GovHydroPelton.zsfc"""))
...
extends
    Parseable[GovHydroR]
{
    val at: (Context) => String = parse_element (element ("""GovHydroR.at"""))
    val db1: (Context) => String = parse_element (element ("""GovHydroR.db1"""))
    val db2: (Context) => String = parse_element (element ("""GovHydroR.db2"""))
    val dturb: (Context) => String = parse_element (element ("""GovHydroR.dturb"""))
    val eps: (Context) => String = parse_element (element ("""GovHydroR.eps"""))
    val gmax: (Context) => String = parse_element (element ("""GovHydroR.gmax"""))
    val gmin: (Context) => String = parse_element (element ("""GovHydroR.gmin"""))
    val gv1: (Context) => String = parse_element (element ("""GovHydroR.gv1"""))
    val gv2: (Context) => String = parse_element (element ("""GovHydroR.gv2"""))
    val gv3: (Context) => String = parse_element (element ("""GovHydroR.gv3"""))
    val gv4: (Context) => String = parse_element (element ("""GovHydroR.gv4"""))
    val gv5: (Context) => String = parse_element (element ("""GovHydroR.gv5"""))
    val gv6: (Context) => String = parse_element (element ("""GovHydroR.gv6"""))
    val h0: (Context) => String = parse_element (element ("""GovHydroR.h0"""))
    val inputSignal: (Context) => String = parse_element (element ("""GovHydroR.inputSignal"""))
    val kg: (Context) => String = parse_element (element ("""GovHydroR.kg"""))
    val ki: (Context) => String = parse_element (element ("""GovHydroR.ki"""))
    val mwbase: (Context) => String = parse_element (element ("""GovHydroR.mwbase"""))
    val pgv1: (Context) => String = parse_element (element ("""GovHydroR.pgv1"""))
    val pgv2: (Context) => String = parse_element (element ("""GovHydroR.pgv2"""))
    val pgv3: (Context) => String = parse_element (element ("""GovHydroR.pgv3"""))
    val pgv4: (Context) => String = parse_element (element ("""GovHydroR.pgv4"""))
    val pgv5: (Context) => String = parse_element (element ("""GovHydroR.pgv5"""))
    val pgv6: (Context) => String = parse_element (element ("""GovHydroR.pgv6"""))
    val pmax: (Context) => String = parse_element (element ("""GovHydroR.pmax"""))
    val pmin: (Context) => String = parse_element (element ("""GovHydroR.pmin"""))
    val qnl: (Context) => String = parse_element (element ("""GovHydroR.qnl"""))
    val r: (Context) => String = parse_element (element ("""GovHydroR.r"""))
    val t1: (Context) => String = parse_element (element ("""GovHydroR.t1"""))
    val t2: (Context) => String = parse_element (element ("""GovHydroR.t2"""))
    val t3: (Context) => String = parse_element (element ("""GovHydroR.t3"""))
    val t4: (Context) => String = parse_element (element ("""GovHydroR.t4"""))
    val t5: (Context) => String = parse_element (element ("""GovHydroR.t5"""))
    val t6: (Context) => String = parse_element (element ("""GovHydroR.t6"""))
    val t7: (Context) => String = parse_element (element ("""GovHydroR.t7"""))
    val t8: (Context) => String = parse_element (element ("""GovHydroR.t8"""))
    val td: (Context) => String = parse_element (element ("""GovHydroR.td"""))
    val tp: (Context) => String = parse_element (element ("""GovHydroR.tp"""))
    val tt: (Context) => String = parse_element (element ("""GovHydroR.tt"""))
    val tw: (Context) => String = parse_element (element ("""GovHydroR.tw"""))
    val velcl: (Context) => String = parse_element (element ("""GovHydroR.velcl"""))
    val velop: (Context) => String = parse_element (element ("""GovHydroR.velop"""))
...
{
    val db: (Context) => String = parse_element (element ("""GovHydroWEH.db"""))
    val dicn: (Context) => String = parse_element (element ("""GovHydroWEH.dicn"""))
    val dpv: (Context) => String = parse_element (element ("""GovHydroWEH.dpv"""))
    val dturb: (Context) => String = parse_element (element ("""GovHydroWEH.dturb"""))
    val feedbackSignal: (Context) => String = parse_element (element ("""GovHydroWEH.feedbackSignal"""))
    val fl1: (Context) => String = parse_element (element ("""GovHydroWEH.fl1"""))
    val fl2: (Context) => String = parse_element (element ("""GovHydroWEH.fl2"""))
    val fl3: (Context) => String = parse_element (element ("""GovHydroWEH.fl3"""))
    val fl4: (Context) => String = parse_element (element ("""GovHydroWEH.fl4"""))
    val fl5: (Context) => String = parse_element (element ("""GovHydroWEH.fl5"""))
    val fp1: (Context) => String = parse_element (element ("""GovHydroWEH.fp1"""))
    val fp10: (Context) => String = parse_element (element ("""GovHydroWEH.fp10"""))
    val fp2: (Context) => String = parse_element (element ("""GovHydroWEH.fp2"""))
    val fp3: (Context) => String = parse_element (element ("""GovHydroWEH.fp3"""))
    val fp4: (Context) => String = parse_element (element ("""GovHydroWEH.fp4"""))
    val fp5: (Context) => String = parse_element (element ("""GovHydroWEH.fp5"""))
    val fp6: (Context) => String = parse_element (element ("""GovHydroWEH.fp6"""))
    val fp7: (Context) => String = parse_element (element ("""GovHydroWEH.fp7"""))
    val fp8: (Context) => String = parse_element (element ("""GovHydroWEH.fp8"""))
    val fp9: (Context) => String = parse_element (element ("""GovHydroWEH.fp9"""))
    val gmax: (Context) => String = parse_element (element ("""GovHydroWEH.gmax"""))
    val gmin: (Context) => String = parse_element (element ("""GovHydroWEH.gmin"""))
    val gtmxcl: (Context) => String = parse_element (element ("""GovHydroWEH.gtmxcl"""))
    val gtmxop: (Context) => String = parse_element (element ("""GovHydroWEH.gtmxop"""))
    val gv1: (Context) => String = parse_element (element ("""GovHydroWEH.gv1"""))
    val gv2: (Context) => String = parse_element (element ("""GovHydroWEH.gv2"""))
    val gv3: (Context) => String = parse_element (element ("""GovHydroWEH.gv3"""))
    val gv4: (Context) => String = parse_element (element ("""GovHydroWEH.gv4"""))
    val gv5: (Context) => String = parse_element (element ("""GovHydroWEH.gv5"""))
    val kd: (Context) => String = parse_element (element ("""GovHydroWEH.kd"""))
    val ki: (Context) => String = parse_element (element ("""GovHydroWEH.ki"""))
    val kp: (Context) => String = parse_element (element ("""GovHydroWEH.kp"""))
    val mwbase: (Context) => String = parse_element (element ("""GovHydroWEH.mwbase"""))
    val pmss1: (Context) => String = parse_element (element ("""GovHydroWEH.pmss1"""))
    val pmss10: (Context) => String = parse_element (element ("""GovHydroWEH.pmss10"""))
    val pmss2: (Context) => String = parse_element (element ("""GovHydroWEH.pmss2"""))
    val pmss3: (Context) => String = parse_element (element ("""GovHydroWEH.pmss3"""))
    val pmss4: (Context) => String = parse_element (element ("""GovHydroWEH.pmss4"""))
    val pmss5: (Context) => String = parse_element (element ("""GovHydroWEH.pmss5"""))
    val pmss6: (Context) => String = parse_element (element ("""GovHydroWEH.pmss6"""))
    val pmss7: (Context) => String = parse_element (element ("""GovHydroWEH.pmss7"""))
    val pmss8: (Context) => String = parse_element (element ("""GovHydroWEH.pmss8"""))
    val pmss9: (Context) => String = parse_element (element ("""GovHydroWEH.pmss9"""))
    val rpg: (Context) => String = parse_element (element ("""GovHydroWEH.rpg"""))
    val rpp: (Context) => String = parse_element (element ("""GovHydroWEH.rpp"""))
    val td: (Context) => String = parse_element (element ("""GovHydroWEH.td"""))
    val tdv: (Context) => String = parse_element (element ("""GovHydroWEH.tdv"""))
    val tg: (Context) => String = parse_element (element ("""GovHydroWEH.tg"""))
    val tp: (Context) => String = parse_element (element ("""GovHydroWEH.tp"""))
    val tpe: (Context) => String = parse_element (element ("""GovHydroWEH.tpe"""))
    val tw: (Context) => String = parse_element (element ("""GovHydroWEH.tw"""))
...
{
    val d: (Context) => String = parse_element (element ("""GovHydroWPID.d"""))
    val gatmax: (Context) => String = parse_element (element ("""GovHydroWPID.gatmax"""))
    val gatmin: (Context) => String = parse_element (element ("""GovHydroWPID.gatmin"""))
    val gv1: (Context) => String = parse_element (element ("""GovHydroWPID.gv1"""))
    val gv2: (Context) => String = parse_element (element ("""GovHydroWPID.gv2"""))
    val gv3: (Context) => String = parse_element (element ("""GovHydroWPID.gv3"""))
    val kd: (Context) => String = parse_element (element ("""GovHydroWPID.kd"""))
    val ki: (Context) => String = parse_element (element ("""GovHydroWPID.ki"""))
    val kp: (Context) => String = parse_element (element ("""GovHydroWPID.kp"""))
    val mwbase: (Context) => String = parse_element (element ("""GovHydroWPID.mwbase"""))
    val pgv1: (Context) => String = parse_element (element ("""GovHydroWPID.pgv1"""))
    val pgv2: (Context) => String = parse_element (element ("""GovHydroWPID.pgv2"""))
    val pgv3: (Context) => String = parse_element (element ("""GovHydroWPID.pgv3"""))
    val pmax: (Context) => String = parse_element (element ("""GovHydroWPID.pmax"""))
    val pmin: (Context) => String = parse_element (element ("""GovHydroWPID.pmin"""))
    val reg: (Context) => String = parse_element (element ("""GovHydroWPID.reg"""))
    val ta: (Context) => String = parse_element (element ("""GovHydroWPID.ta"""))
    val tb: (Context) => String = parse_element (element ("""GovHydroWPID.tb"""))
    val treg: (Context) => String = parse_element (element ("""GovHydroWPID.treg"""))
    val tw: (Context) => String = parse_element (element ("""GovHydroWPID.tw"""))
    val velmax: (Context) => String = parse_element (element ("""GovHydroWPID.velmax"""))
    val velmin: (Context) => String = parse_element (element ("""GovHydroWPID.velmin"""))
...
extends
    Parseable[GovSteam0]
{
    val dt: (Context) => String = parse_element (element ("""GovSteam0.dt"""))
    val mwbase: (Context) => String = parse_element (element ("""GovSteam0.mwbase"""))
    val r: (Context) => String = parse_element (element ("""GovSteam0.r"""))
    val t1: (Context) => String = parse_element (element ("""GovSteam0.t1"""))
    val t2: (Context) => String = parse_element (element ("""GovSteam0.t2"""))
    val t3: (Context) => String = parse_element (element ("""GovSteam0.t3"""))
    val vmax: (Context) => String = parse_element (element ("""GovSteam0.vmax"""))
    val vmin: (Context) => String = parse_element (element ("""GovSteam0.vmin"""))
...
extends
    Parseable[GovSteam1]
{
    val db1: (Context) => String = parse_element (element ("""GovSteam1.db1"""))
    val db2: (Context) => String = parse_element (element ("""GovSteam1.db2"""))
    val eps: (Context) => String = parse_element (element ("""GovSteam1.eps"""))
    val gv1: (Context) => String = parse_element (element ("""GovSteam1.gv1"""))
    val gv2: (Context) => String = parse_element (element ("""GovSteam1.gv2"""))
    val gv3: (Context) => String = parse_element (element ("""GovSteam1.gv3"""))
    val gv4: (Context) => String = parse_element (element ("""GovSteam1.gv4"""))
    val gv5: (Context) => String = parse_element (element ("""GovSteam1.gv5"""))
    val gv6: (Context) => String = parse_element (element ("""GovSteam1.gv6"""))
    val k: (Context) => String = parse_element (element ("""GovSteam1.k"""))
    val k1: (Context) => String = parse_element (element ("""GovSteam1.k1"""))
    val k2: (Context) => String = parse_element (element ("""GovSteam1.k2"""))
    val k3: (Context) => String = parse_element (element ("""GovSteam1.k3"""))
    val k4: (Context) => String = parse_element (element ("""GovSteam1.k4"""))
    val k5: (Context) => String = parse_element (element ("""GovSteam1.k5"""))
    val k6: (Context) => String = parse_element (element ("""GovSteam1.k6"""))
    val k7: (Context) => String = parse_element (element ("""GovSteam1.k7"""))
    val k8: (Context) => String = parse_element (element ("""GovSteam1.k8"""))
    val mwbase: (Context) => String = parse_element (element ("""GovSteam1.mwbase"""))
    val pgv1: (Context) => String = parse_element (element ("""GovSteam1.pgv1"""))
    val pgv2: (Context) => String = parse_element (element ("""GovSteam1.pgv2"""))
    val pgv3: (Context) => String = parse_element (element ("""GovSteam1.pgv3"""))
    val pgv4: (Context) => String = parse_element (element ("""GovSteam1.pgv4"""))
    val pgv5: (Context) => String = parse_element (element ("""GovSteam1.pgv5"""))
    val pgv6: (Context) => String = parse_element (element ("""GovSteam1.pgv6"""))
    val pmax: (Context) => String = parse_element (element ("""GovSteam1.pmax"""))
    val pmin: (Context) => String = parse_element (element ("""GovSteam1.pmin"""))
    val sdb1: (Context) => String = parse_element (element ("""GovSteam1.sdb1"""))
    val sdb2: (Context) => String = parse_element (element ("""GovSteam1.sdb2"""))
    val t1: (Context) => String = parse_element (element ("""GovSteam1.t1"""))
    val t2: (Context) => String = parse_element (element ("""GovSteam1.t2"""))
    val t3: (Context) => String = parse_element (element ("""GovSteam1.t3"""))
    val t4: (Context) => String = parse_element (element ("""GovSteam1.t4"""))
    val t5: (Context) => String = parse_element (element ("""GovSteam1.t5"""))
    val t6: (Context) => String = parse_element (element ("""GovSteam1.t6"""))
    val t7: (Context) => String = parse_element (element ("""GovSteam1.t7"""))
    val uc: (Context) => String = parse_element (element ("""GovSteam1.uc"""))
    val uo: (Context) => String = parse_element (element ("""GovSteam1.uo"""))
    val valve: (Context) => String = parse_element (element ("""GovSteam1.valve"""))
...
extends
    Parseable[GovSteam2]
{
    val dbf: (Context) => String = parse_element (element ("""GovSteam2.dbf"""))
    val k: (Context) => String = parse_element (element ("""GovSteam2.k"""))
    val mnef: (Context) => String = parse_element (element ("""GovSteam2.mnef"""))
    val mxef: (Context) => String = parse_element (element ("""GovSteam2.mxef"""))
    val pmax: (Context) => String = parse_element (element ("""GovSteam2.pmax"""))
    val pmin: (Context) => String = parse_element (element ("""GovSteam2.pmin"""))
    val t1: (Context) => String = parse_element (element ("""GovSteam2.t1"""))
    val t2: (Context) => String = parse_element (element ("""GovSteam2.t2"""))
...
{
    val dhp: (Context) => String = parse_element (element ("""GovSteamCC.dhp"""))
    val dlp: (Context) => String = parse_element (element ("""GovSteamCC.dlp"""))
    val fhp: (Context) => String = parse_element (element ("""GovSteamCC.fhp"""))
    val flp: (Context) => String = parse_element (element ("""GovSteamCC.flp"""))
    val mwbase: (Context) => String = parse_element (element ("""GovSteamCC.mwbase"""))
    val pmaxhp: (Context) => String = parse_element (element ("""GovSteamCC.pmaxhp"""))
    val pmaxlp: (Context) => String = parse_element (element ("""GovSteamCC.pmaxlp"""))
    val rhp: (Context) => String = parse_element (element ("""GovSteamCC.rhp"""))
    val rlp: (Context) => String = parse_element (element ("""GovSteamCC.rlp"""))
    val t1hp: (Context) => String = parse_element (element ("""GovSteamCC.t1hp"""))
    val t1lp: (Context) => String = parse_element (element ("""GovSteamCC.t1lp"""))
    val t3hp: (Context) => String = parse_element (element ("""GovSteamCC.t3hp"""))
    val t3lp: (Context) => String = parse_element (element ("""GovSteamCC.t3lp"""))
    val t4hp: (Context) => String = parse_element (element ("""GovSteamCC.t4hp"""))
    val t4lp: (Context) => String = parse_element (element ("""GovSteamCC.t4lp"""))
    val t5hp: (Context) => String = parse_element (element ("""GovSteamCC.t5hp"""))
    val t5lp: (Context) => String = parse_element (element ("""GovSteamCC.t5lp"""))
...
{
    val chc: (Context) => String = parse_element (element ("""GovSteamEU.chc"""))
    val cho: (Context) => String = parse_element (element ("""GovSteamEU.cho"""))
    val cic: (Context) => String = parse_element (element ("""GovSteamEU.cic"""))
    val cio: (Context) => String = parse_element (element ("""GovSteamEU.cio"""))
    val db1: (Context) => String = parse_element (element ("""GovSteamEU.db1"""))
    val db2: (Context) => String = parse_element (element ("""GovSteamEU.db2"""))
    val hhpmax: (Context) => String = parse_element (element ("""GovSteamEU.hhpmax"""))
    val ke: (Context) => String = parse_element (element ("""GovSteamEU.ke"""))
    val kfcor: (Context) => String = parse_element (element ("""GovSteamEU.kfcor"""))
    val khp: (Context) => String = parse_element (element ("""GovSteamEU.khp"""))
    val klp: (Context) => String = parse_element (element ("""GovSteamEU.klp"""))
    val kwcor: (Context) => String = parse_element (element ("""GovSteamEU.kwcor"""))
    val mwbase: (Context) => String = parse_element (element ("""GovSteamEU.mwbase"""))
    val pmax: (Context) => String = parse_element (element ("""GovSteamEU.pmax"""))
    val prhmax: (Context) => String = parse_element (element ("""GovSteamEU.prhmax"""))
    val simx: (Context) => String = parse_element (element ("""GovSteamEU.simx"""))
    val tb: (Context) => String = parse_element (element ("""GovSteamEU.tb"""))
    val tdp: (Context) => String = parse_element (element ("""GovSteamEU.tdp"""))
    val ten: (Context) => String = parse_element (element ("""GovSteamEU.ten"""))
    val tf: (Context) => String = parse_element (element ("""GovSteamEU.tf"""))
    val tfp: (Context) => String = parse_element (element ("""GovSteamEU.tfp"""))
    val thp: (Context) => String = parse_element (element ("""GovSteamEU.thp"""))
    val tip: (Context) => String = parse_element (element ("""GovSteamEU.tip"""))
    val tlp: (Context) => String = parse_element (element ("""GovSteamEU.tlp"""))
    val tp: (Context) => String = parse_element (element ("""GovSteamEU.tp"""))
    val trh: (Context) => String = parse_element (element ("""GovSteamEU.trh"""))
    val tvhp: (Context) => String = parse_element (element ("""GovSteamEU.tvhp"""))
    val tvip: (Context) => String = parse_element (element ("""GovSteamEU.tvip"""))
    val tw: (Context) => String = parse_element (element ("""GovSteamEU.tw"""))
    val wfmax: (Context) => String = parse_element (element ("""GovSteamEU.wfmax"""))
    val wfmin: (Context) => String = parse_element (element ("""GovSteamEU.wfmin"""))
    val wmax1: (Context) => String = parse_element (element ("""GovSteamEU.wmax1"""))
    val wmax2: (Context) => String = parse_element (element ("""GovSteamEU.wmax2"""))
    val wwmax: (Context) => String = parse_element (element ("""GovSteamEU.wwmax"""))
    val wwmin: (Context) => String = parse_element (element ("""GovSteamEU.wwmin"""))
...
{
    val dt: (Context) => String = parse_element (element ("""GovSteamFV2.dt"""))
    val k: (Context) => String = parse_element (element ("""GovSteamFV2.k"""))
    val mwbase: (Context) => String = parse_element (element ("""GovSteamFV2.mwbase"""))
    val r: (Context) => String = parse_element (element ("""GovSteamFV2.r"""))
    val t1: (Context) => String = parse_element (element ("""GovSteamFV2.t1"""))
    val t3: (Context) => String = parse_element (element ("""GovSteamFV2.t3"""))
    val ta: (Context) => String = parse_element (element ("""GovSteamFV2.ta"""))
    val tb: (Context) => String = parse_element (element ("""GovSteamFV2.tb"""))
    val tc: (Context) => String = parse_element (element ("""GovSteamFV2.tc"""))
    val ti: (Context) => String = parse_element (element ("""GovSteamFV2.ti"""))
    val tt: (Context) => String = parse_element (element ("""GovSteamFV2.tt"""))
    val vmax: (Context) => String = parse_element (element ("""GovSteamFV2.vmax"""))
    val vmin: (Context) => String = parse_element (element ("""GovSteamFV2.vmin"""))
...
{
    val k: (Context) => String = parse_element (element ("""GovSteamFV3.k"""))
    val k1: (Context) => String = parse_element (element ("""GovSteamFV3.k1"""))
    val k2: (Context) => String = parse_element (element ("""GovSteamFV3.k2"""))
    val k3: (Context) => String = parse_element (element ("""GovSteamFV3.k3"""))
    val mwbase: (Context) => String = parse_element (element ("""GovSteamFV3.mwbase"""))
    val pmax: (Context) => String = parse_element (element ("""GovSteamFV3.pmax"""))
    val pmin: (Context) => String = parse_element (element ("""GovSteamFV3.pmin"""))
    val prmax: (Context) => String = parse_element (element ("""GovSteamFV3.prmax"""))
    val t1: (Context) => String = parse_element (element ("""GovSteamFV3.t1"""))
    val t2: (Context) => String = parse_element (element ("""GovSteamFV3.t2"""))
    val t3: (Context) => String = parse_element (element ("""GovSteamFV3.t3"""))
    val t4: (Context) => String = parse_element (element ("""GovSteamFV3.t4"""))
    val t5: (Context) => String = parse_element (element ("""GovSteamFV3.t5"""))
    val t6: (Context) => String = parse_element (element ("""GovSteamFV3.t6"""))
    val ta: (Context) => String = parse_element (element ("""GovSteamFV3.ta"""))
    val tb: (Context) => String = parse_element (element ("""GovSteamFV3.tb"""))
    val tc: (Context) => String = parse_element (element ("""GovSteamFV3.tc"""))
    val uc: (Context) => String = parse_element (element ("""GovSteamFV3.uc"""))
    val uo: (Context) => String = parse_element (element ("""GovSteamFV3.uo"""))
...
{
    val cpsmn: (Context) => String = parse_element (element ("""GovSteamFV4.cpsmn"""))
    val cpsmx: (Context) => String = parse_element (element ("""GovSteamFV4.cpsmx"""))
    val crmn: (Context) => String = parse_element (element ("""GovSteamFV4.crmn"""))
    val crmx: (Context) => String = parse_element (element ("""GovSteamFV4.crmx"""))
    val kdc: (Context) => String = parse_element (element ("""GovSteamFV4.kdc"""))
    val kf1: (Context) => String = parse_element (element ("""GovSteamFV4.kf1"""))
    val kf3: (Context) => String = parse_element (element ("""GovSteamFV4.kf3"""))
    val khp: (Context) => String = parse_element (element ("""GovSteamFV4.khp"""))
    val kic: (Context) => String = parse_element (element ("""GovSteamFV4.kic"""))
    val kip: (Context) => String = parse_element (element ("""GovSteamFV4.kip"""))
    val kit: (Context) => String = parse_element (element ("""GovSteamFV4.kit"""))
    val kmp1: (Context) => String = parse_element (element ("""GovSteamFV4.kmp1"""))
    val kmp2: (Context) => String = parse_element (element ("""GovSteamFV4.kmp2"""))
    val kpc: (Context) => String = parse_element (element ("""GovSteamFV4.kpc"""))
    val kpp: (Context) => String = parse_element (element ("""GovSteamFV4.kpp"""))
    val kpt: (Context) => String = parse_element (element ("""GovSteamFV4.kpt"""))
    val krc: (Context) => String = parse_element (element ("""GovSteamFV4.krc"""))
    val ksh: (Context) => String = parse_element (element ("""GovSteamFV4.ksh"""))
    val lpi: (Context) => String = parse_element (element ("""GovSteamFV4.lpi"""))
    val lps: (Context) => String = parse_element (element ("""GovSteamFV4.lps"""))
    val mnef: (Context) => String = parse_element (element ("""GovSteamFV4.mnef"""))
    val mxef: (Context) => String = parse_element (element ("""GovSteamFV4.mxef"""))
    val pr1: (Context) => String = parse_element (element ("""GovSteamFV4.pr1"""))
    val pr2: (Context) => String = parse_element (element ("""GovSteamFV4.pr2"""))
    val psmn: (Context) => String = parse_element (element ("""GovSteamFV4.psmn"""))
    val rsmimn: (Context) => String = parse_element (element ("""GovSteamFV4.rsmimn"""))
    val rsmimx: (Context) => String = parse_element (element ("""GovSteamFV4.rsmimx"""))
    val rvgmn: (Context) => String = parse_element (element ("""GovSteamFV4.rvgmn"""))
    val rvgmx: (Context) => String = parse_element (element ("""GovSteamFV4.rvgmx"""))
    val srmn: (Context) => String = parse_element (element ("""GovSteamFV4.srmn"""))
    val srmx: (Context) => String = parse_element (element ("""GovSteamFV4.srmx"""))
    val srsmp: (Context) => String = parse_element (element ("""GovSteamFV4.srsmp"""))
    val svmn: (Context) => String = parse_element (element ("""GovSteamFV4.svmn"""))
    val svmx: (Context) => String = parse_element (element ("""GovSteamFV4.svmx"""))
    val ta: (Context) => String = parse_element (element ("""GovSteamFV4.ta"""))
    val tam: (Context) => String = parse_element (element ("""GovSteamFV4.tam"""))
    val tc: (Context) => String = parse_element (element ("""GovSteamFV4.tc"""))
    val tcm: (Context) => String = parse_element (element ("""GovSteamFV4.tcm"""))
    val tdc: (Context) => String = parse_element (element ("""GovSteamFV4.tdc"""))
    val tf1: (Context) => String = parse_element (element ("""GovSteamFV4.tf1"""))
    val tf2: (Context) => String = parse_element (element ("""GovSteamFV4.tf2"""))
    val thp: (Context) => String = parse_element (element ("""GovSteamFV4.thp"""))
    val tmp: (Context) => String = parse_element (element ("""GovSteamFV4.tmp"""))
    val trh: (Context) => String = parse_element (element ("""GovSteamFV4.trh"""))
    val tv: (Context) => String = parse_element (element ("""GovSteamFV4.tv"""))
    val ty: (Context) => String = parse_element (element ("""GovSteamFV4.ty"""))
    val y: (Context) => String = parse_element (element ("""GovSteamFV4.y"""))
    val yhpmn: (Context) => String = parse_element (element ("""GovSteamFV4.yhpmn"""))
    val yhpmx: (Context) => String = parse_element (element ("""GovSteamFV4.yhpmx"""))
    val ympmn: (Context) => String = parse_element (element ("""GovSteamFV4.ympmn"""))
    val ympmx: (Context) => String = parse_element (element ("""GovSteamFV4.ympmx"""))
...
{
    val k: (Context) => String = parse_element (element ("""GovSteamIEEE1.k"""))
    val k1: (Context) => String = parse_element (element ("""GovSteamIEEE1.k1"""))
    val k2: (Context) => String = parse_element (element ("""GovSteamIEEE1.k2"""))
    val k3: (Context) => String = parse_element (element ("""GovSteamIEEE1.k3"""))
    val k4: (Context) => String = parse_element (element ("""GovSteamIEEE1.k4"""))
    val k5: (Context) => String = parse_element (element ("""GovSteamIEEE1.k5"""))
    val k6: (Context) => String = parse_element (element ("""GovSteamIEEE1.k6"""))
    val k7: (Context) => String = parse_element (element ("""GovSteamIEEE1.k7"""))
    val k8: (Context) => String = parse_element (element ("""GovSteamIEEE1.k8"""))
    val mwbase: (Context) => String = parse_element (element ("""GovSteamIEEE1.mwbase"""))
    val pmax: (Context) => String = parse_element (element ("""GovSteamIEEE1.pmax"""))
    val pmin: (Context) => String = parse_element (element ("""GovSteamIEEE1.pmin"""))
    val t1: (Context) => String = parse_element (element ("""GovSteamIEEE1.t1"""))
    val t2: (Context) => String = parse_element (element ("""GovSteamIEEE1.t2"""))
    val t3: (Context) => String = parse_element (element ("""GovSteamIEEE1.t3"""))
    val t4: (Context) => String = parse_element (element ("""GovSteamIEEE1.t4"""))
    val t5: (Context) => String = parse_element (element ("""GovSteamIEEE1.t5"""))
    val t6: (Context) => String = parse_element (element ("""GovSteamIEEE1.t6"""))
    val t7: (Context) => String = parse_element (element ("""GovSteamIEEE1.t7"""))
    val uc: (Context) => String = parse_element (element ("""GovSteamIEEE1.uc"""))
    val uo: (Context) => String = parse_element (element ("""GovSteamIEEE1.uo"""))
...
{
    val k1: (Context) => String = parse_element (element ("""GovSteamSGO.k1"""))
    val k2: (Context) => String = parse_element (element ("""GovSteamSGO.k2"""))
    val k3: (Context) => String = parse_element (element ("""GovSteamSGO.k3"""))
    val mwbase: (Context) => String = parse_element (element ("""GovSteamSGO.mwbase"""))
    val pmax: (Context) => String = parse_element (element ("""GovSteamSGO.pmax"""))
    val pmin: (Context) => String = parse_element (element ("""GovSteamSGO.pmin"""))
    val t1: (Context) => String = parse_element (element ("""GovSteamSGO.t1"""))
    val t2: (Context) => String = parse_element (element ("""GovSteamSGO.t2"""))
    val t3: (Context) => String = parse_element (element ("""GovSteamSGO.t3"""))
    val t4: (Context) => String = parse_element (element ("""GovSteamSGO.t4"""))
    val t5: (Context) => String = parse_element (element ("""GovSteamSGO.t5"""))
    val t6: (Context) => String = parse_element (element ("""GovSteamSGO.t6"""))
...
{
    val AsynchronousMachineDynamics: (Context) => String = parse_attribute (attribute ("""TurbineGovernorDynamics.AsynchronousMachineDynamics"""))
    val TurbineLoadControllerDynamics: (Context) => String = parse_attribute (attribute ("""TurbineGovernorDynamics.TurbineLoadControllerDynamics"""))
