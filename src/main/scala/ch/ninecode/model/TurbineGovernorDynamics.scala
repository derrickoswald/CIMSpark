    ...
    Parseable[DroopSignalFeedbackKind]
{
    ...
    val electricalPower = parse_attribute (attribute ("""DroopSignalFeedbackKind.electricalPower"""))
    val fuelValveStroke = parse_attribute (attribute ("""DroopSignalFeedbackKind.fuelValveStroke"""))
    val governorOutput = parse_attribute (attribute ("""DroopSignalFeedbackKind.governorOutput"""))
    val none = parse_attribute (attribute ("""DroopSignalFeedbackKind.none"""))
...
{
    val sup = BasicElement.parse _
    val electromechanicalElectrohydraulic = parse_attribute (attribute ("""FrancisGovernorControlKind.electromechanicalElectrohydraulic"""))
    val mechanicHydraulicTransientFeedback = parse_attribute (attribute ("""FrancisGovernorControlKind.mechanicHydraulicTransientFeedback"""))
    val mechanicHydrolicTachoAccelerator = parse_attribute (attribute ("""FrancisGovernorControlKind.mechanicHydrolicTachoAccelerator"""))
