...
extends
    Parseable[ExcAC1A]
{
    val hvlvgates: (Context) => String = parse_element (element ("""ExcAC1A.hvlvgates"""))
    val ka: (Context) => String = parse_element (element ("""ExcAC1A.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcAC1A.kc"""))
    val kd: (Context) => String = parse_element (element ("""ExcAC1A.kd"""))
    val ke: (Context) => String = parse_element (element ("""ExcAC1A.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcAC1A.kf"""))
    val kf1: (Context) => String = parse_element (element ("""ExcAC1A.kf1"""))
    val kf2: (Context) => String = parse_element (element ("""ExcAC1A.kf2"""))
    val ks: (Context) => String = parse_element (element ("""ExcAC1A.ks"""))
    val seve1: (Context) => String = parse_element (element ("""ExcAC1A.seve1"""))
    val seve2: (Context) => String = parse_element (element ("""ExcAC1A.seve2"""))
    val ta: (Context) => String = parse_element (element ("""ExcAC1A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcAC1A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcAC1A.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcAC1A.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcAC1A.tf"""))
    val vamax: (Context) => String = parse_element (element ("""ExcAC1A.vamax"""))
    val vamin: (Context) => String = parse_element (element ("""ExcAC1A.vamin"""))
    val ve1: (Context) => String = parse_element (element ("""ExcAC1A.ve1"""))
    val ve2: (Context) => String = parse_element (element ("""ExcAC1A.ve2"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcAC1A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcAC1A.vrmin"""))
...
extends
    Parseable[ExcAC2A]
{
    val hvgate: (Context) => String = parse_element (element ("""ExcAC2A.hvgate"""))
    val ka: (Context) => String = parse_element (element ("""ExcAC2A.ka"""))
    val kb: (Context) => String = parse_element (element ("""ExcAC2A.kb"""))
    val kb1: (Context) => String = parse_element (element ("""ExcAC2A.kb1"""))
    val kc: (Context) => String = parse_element (element ("""ExcAC2A.kc"""))
    val kd: (Context) => String = parse_element (element ("""ExcAC2A.kd"""))
    val ke: (Context) => String = parse_element (element ("""ExcAC2A.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcAC2A.kf"""))
    val kh: (Context) => String = parse_element (element ("""ExcAC2A.kh"""))
    val kl: (Context) => String = parse_element (element ("""ExcAC2A.kl"""))
    val kl1: (Context) => String = parse_element (element ("""ExcAC2A.kl1"""))
    val ks: (Context) => String = parse_element (element ("""ExcAC2A.ks"""))
    val lvgate: (Context) => String = parse_element (element ("""ExcAC2A.lvgate"""))
    val seve1: (Context) => String = parse_element (element ("""ExcAC2A.seve1"""))
    val seve2: (Context) => String = parse_element (element ("""ExcAC2A.seve2"""))
    val ta: (Context) => String = parse_element (element ("""ExcAC2A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcAC2A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcAC2A.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcAC2A.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcAC2A.tf"""))
    val vamax: (Context) => String = parse_element (element ("""ExcAC2A.vamax"""))
    val vamin: (Context) => String = parse_element (element ("""ExcAC2A.vamin"""))
    val ve1: (Context) => String = parse_element (element ("""ExcAC2A.ve1"""))
    val ve2: (Context) => String = parse_element (element ("""ExcAC2A.ve2"""))
    val vfemax: (Context) => String = parse_element (element ("""ExcAC2A.vfemax"""))
    val vlr: (Context) => String = parse_element (element ("""ExcAC2A.vlr"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcAC2A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcAC2A.vrmin"""))
...
extends
    Parseable[ExcAC3A]
{
    val efdn: (Context) => String = parse_element (element ("""ExcAC3A.efdn"""))
    val ka: (Context) => String = parse_element (element ("""ExcAC3A.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcAC3A.kc"""))
    val kd: (Context) => String = parse_element (element ("""ExcAC3A.kd"""))
    val ke: (Context) => String = parse_element (element ("""ExcAC3A.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcAC3A.kf"""))
    val kf1: (Context) => String = parse_element (element ("""ExcAC3A.kf1"""))
    val kf2: (Context) => String = parse_element (element ("""ExcAC3A.kf2"""))
    val klv: (Context) => String = parse_element (element ("""ExcAC3A.klv"""))
    val kn: (Context) => String = parse_element (element ("""ExcAC3A.kn"""))
    val kr: (Context) => String = parse_element (element ("""ExcAC3A.kr"""))
    val ks: (Context) => String = parse_element (element ("""ExcAC3A.ks"""))
    val seve1: (Context) => String = parse_element (element ("""ExcAC3A.seve1"""))
    val seve2: (Context) => String = parse_element (element ("""ExcAC3A.seve2"""))
    val ta: (Context) => String = parse_element (element ("""ExcAC3A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcAC3A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcAC3A.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcAC3A.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcAC3A.tf"""))
    val vamax: (Context) => String = parse_element (element ("""ExcAC3A.vamax"""))
    val vamin: (Context) => String = parse_element (element ("""ExcAC3A.vamin"""))
    val ve1: (Context) => String = parse_element (element ("""ExcAC3A.ve1"""))
    val ve2: (Context) => String = parse_element (element ("""ExcAC3A.ve2"""))
    val vemin: (Context) => String = parse_element (element ("""ExcAC3A.vemin"""))
    val vfemax: (Context) => String = parse_element (element ("""ExcAC3A.vfemax"""))
    val vlv: (Context) => String = parse_element (element ("""ExcAC3A.vlv"""))
...
extends
    Parseable[ExcAC4A]
{
    val ka: (Context) => String = parse_element (element ("""ExcAC4A.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcAC4A.kc"""))
    val ta: (Context) => String = parse_element (element ("""ExcAC4A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcAC4A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcAC4A.tc"""))
    val vimax: (Context) => String = parse_element (element ("""ExcAC4A.vimax"""))
    val vimin: (Context) => String = parse_element (element ("""ExcAC4A.vimin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcAC4A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcAC4A.vrmin"""))
...
extends
    Parseable[ExcAC5A]
{
    val a: (Context) => String = parse_element (element ("""ExcAC5A.a"""))
    val efd1: (Context) => String = parse_element (element ("""ExcAC5A.efd1"""))
    val efd2: (Context) => String = parse_element (element ("""ExcAC5A.efd2"""))
    val ka: (Context) => String = parse_element (element ("""ExcAC5A.ka"""))
    val ke: (Context) => String = parse_element (element ("""ExcAC5A.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcAC5A.kf"""))
    val ks: (Context) => String = parse_element (element ("""ExcAC5A.ks"""))
    val seefd1: (Context) => String = parse_element (element ("""ExcAC5A.seefd1"""))
    val seefd2: (Context) => String = parse_element (element ("""ExcAC5A.seefd2"""))
    val ta: (Context) => String = parse_element (element ("""ExcAC5A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcAC5A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcAC5A.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcAC5A.te"""))
    val tf1: (Context) => String = parse_element (element ("""ExcAC5A.tf1"""))
    val tf2: (Context) => String = parse_element (element ("""ExcAC5A.tf2"""))
    val tf3: (Context) => String = parse_element (element ("""ExcAC5A.tf3"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcAC5A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcAC5A.vrmin"""))
...
extends
    Parseable[ExcAC6A]
{
    val ka: (Context) => String = parse_element (element ("""ExcAC6A.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcAC6A.kc"""))
    val kd: (Context) => String = parse_element (element ("""ExcAC6A.kd"""))
    val ke: (Context) => String = parse_element (element ("""ExcAC6A.ke"""))
    val kh: (Context) => String = parse_element (element ("""ExcAC6A.kh"""))
    val ks: (Context) => String = parse_element (element ("""ExcAC6A.ks"""))
    val seve1: (Context) => String = parse_element (element ("""ExcAC6A.seve1"""))
    val seve2: (Context) => String = parse_element (element ("""ExcAC6A.seve2"""))
    val ta: (Context) => String = parse_element (element ("""ExcAC6A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcAC6A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcAC6A.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcAC6A.te"""))
    val th: (Context) => String = parse_element (element ("""ExcAC6A.th"""))
    val tj: (Context) => String = parse_element (element ("""ExcAC6A.tj"""))
    val tk: (Context) => String = parse_element (element ("""ExcAC6A.tk"""))
    val vamax: (Context) => String = parse_element (element ("""ExcAC6A.vamax"""))
    val vamin: (Context) => String = parse_element (element ("""ExcAC6A.vamin"""))
    val ve1: (Context) => String = parse_element (element ("""ExcAC6A.ve1"""))
    val ve2: (Context) => String = parse_element (element ("""ExcAC6A.ve2"""))
    val vfelim: (Context) => String = parse_element (element ("""ExcAC6A.vfelim"""))
    val vhmax: (Context) => String = parse_element (element ("""ExcAC6A.vhmax"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcAC6A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcAC6A.vrmin"""))
...
extends
    Parseable[ExcAC8B]
{
    val inlim: (Context) => String = parse_element (element ("""ExcAC8B.inlim"""))
    val ka: (Context) => String = parse_element (element ("""ExcAC8B.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcAC8B.kc"""))
    val kd: (Context) => String = parse_element (element ("""ExcAC8B.kd"""))
    val kdr: (Context) => String = parse_element (element ("""ExcAC8B.kdr"""))
    val ke: (Context) => String = parse_element (element ("""ExcAC8B.ke"""))
    val kir: (Context) => String = parse_element (element ("""ExcAC8B.kir"""))
    val kpr: (Context) => String = parse_element (element ("""ExcAC8B.kpr"""))
    val ks: (Context) => String = parse_element (element ("""ExcAC8B.ks"""))
    val pidlim: (Context) => String = parse_element (element ("""ExcAC8B.pidlim"""))
    val seve1: (Context) => String = parse_element (element ("""ExcAC8B.seve1"""))
    val seve2: (Context) => String = parse_element (element ("""ExcAC8B.seve2"""))
    val ta: (Context) => String = parse_element (element ("""ExcAC8B.ta"""))
    val tdr: (Context) => String = parse_element (element ("""ExcAC8B.tdr"""))
    val te: (Context) => String = parse_element (element ("""ExcAC8B.te"""))
    val telim: (Context) => String = parse_element (element ("""ExcAC8B.telim"""))
    val ve1: (Context) => String = parse_element (element ("""ExcAC8B.ve1"""))
    val ve2: (Context) => String = parse_element (element ("""ExcAC8B.ve2"""))
    val vemin: (Context) => String = parse_element (element ("""ExcAC8B.vemin"""))
    val vfemax: (Context) => String = parse_element (element ("""ExcAC8B.vfemax"""))
    val vimax: (Context) => String = parse_element (element ("""ExcAC8B.vimax"""))
    val vimin: (Context) => String = parse_element (element ("""ExcAC8B.vimin"""))
    val vpidmax: (Context) => String = parse_element (element ("""ExcAC8B.vpidmax"""))
    val vpidmin: (Context) => String = parse_element (element ("""ExcAC8B.vpidmin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcAC8B.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcAC8B.vrmin"""))
    val vtmult: (Context) => String = parse_element (element ("""ExcAC8B.vtmult"""))
...
extends
    Parseable[ExcANS]
{
    val blint: (Context) => String = parse_element (element ("""ExcANS.blint"""))
    val ifmn: (Context) => String = parse_element (element ("""ExcANS.ifmn"""))
    val ifmx: (Context) => String = parse_element (element ("""ExcANS.ifmx"""))
    val k2: (Context) => String = parse_element (element ("""ExcANS.k2"""))
    val k3: (Context) => String = parse_element (element ("""ExcANS.k3"""))
    val kce: (Context) => String = parse_element (element ("""ExcANS.kce"""))
    val krvecc: (Context) => String = parse_element (element ("""ExcANS.krvecc"""))
    val kvfif: (Context) => String = parse_element (element ("""ExcANS.kvfif"""))
    val t1: (Context) => String = parse_element (element ("""ExcANS.t1"""))
    val t2: (Context) => String = parse_element (element ("""ExcANS.t2"""))
    val t3: (Context) => String = parse_element (element ("""ExcANS.t3"""))
    val tb: (Context) => String = parse_element (element ("""ExcANS.tb"""))
    val vrmn: (Context) => String = parse_element (element ("""ExcANS.vrmn"""))
    val vrmx: (Context) => String = parse_element (element ("""ExcANS.vrmx"""))
...
extends
    Parseable[ExcAVR1]
{
    val e1: (Context) => String = parse_element (element ("""ExcAVR1.e1"""))
    val e2: (Context) => String = parse_element (element ("""ExcAVR1.e2"""))
    val ka: (Context) => String = parse_element (element ("""ExcAVR1.ka"""))
    val kf: (Context) => String = parse_element (element ("""ExcAVR1.kf"""))
    val se1: (Context) => String = parse_element (element ("""ExcAVR1.se1"""))
    val se2: (Context) => String = parse_element (element ("""ExcAVR1.se2"""))
    val ta: (Context) => String = parse_element (element ("""ExcAVR1.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcAVR1.tb"""))
    val te: (Context) => String = parse_element (element ("""ExcAVR1.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcAVR1.tf"""))
    val vrmn: (Context) => String = parse_element (element ("""ExcAVR1.vrmn"""))
    val vrmx: (Context) => String = parse_element (element ("""ExcAVR1.vrmx"""))
...
extends
    Parseable[ExcAVR2]
{
    val e1: (Context) => String = parse_element (element ("""ExcAVR2.e1"""))
    val e2: (Context) => String = parse_element (element ("""ExcAVR2.e2"""))
    val ka: (Context) => String = parse_element (element ("""ExcAVR2.ka"""))
    val kf: (Context) => String = parse_element (element ("""ExcAVR2.kf"""))
    val se1: (Context) => String = parse_element (element ("""ExcAVR2.se1"""))
    val se2: (Context) => String = parse_element (element ("""ExcAVR2.se2"""))
    val ta: (Context) => String = parse_element (element ("""ExcAVR2.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcAVR2.tb"""))
    val te: (Context) => String = parse_element (element ("""ExcAVR2.te"""))
    val tf1: (Context) => String = parse_element (element ("""ExcAVR2.tf1"""))
    val tf2: (Context) => String = parse_element (element ("""ExcAVR2.tf2"""))
    val vrmn: (Context) => String = parse_element (element ("""ExcAVR2.vrmn"""))
    val vrmx: (Context) => String = parse_element (element ("""ExcAVR2.vrmx"""))
...
extends
    Parseable[ExcAVR3]
{
    val e1: (Context) => String = parse_element (element ("""ExcAVR3.e1"""))
    val e2: (Context) => String = parse_element (element ("""ExcAVR3.e2"""))
    val ka: (Context) => String = parse_element (element ("""ExcAVR3.ka"""))
    val se1: (Context) => String = parse_element (element ("""ExcAVR3.se1"""))
    val se2: (Context) => String = parse_element (element ("""ExcAVR3.se2"""))
    val t1: (Context) => String = parse_element (element ("""ExcAVR3.t1"""))
    val t2: (Context) => String = parse_element (element ("""ExcAVR3.t2"""))
    val t3: (Context) => String = parse_element (element ("""ExcAVR3.t3"""))
    val t4: (Context) => String = parse_element (element ("""ExcAVR3.t4"""))
    val te: (Context) => String = parse_element (element ("""ExcAVR3.te"""))
    val vrmn: (Context) => String = parse_element (element ("""ExcAVR3.vrmn"""))
    val vrmx: (Context) => String = parse_element (element ("""ExcAVR3.vrmx"""))
...
extends
    Parseable[ExcAVR4]
{
    val imul: (Context) => String = parse_element (element ("""ExcAVR4.imul"""))
    val ka: (Context) => String = parse_element (element ("""ExcAVR4.ka"""))
    val ke: (Context) => String = parse_element (element ("""ExcAVR4.ke"""))
    val kif: (Context) => String = parse_element (element ("""ExcAVR4.kif"""))
    val t1: (Context) => String = parse_element (element ("""ExcAVR4.t1"""))
    val t1if: (Context) => String = parse_element (element ("""ExcAVR4.t1if"""))
    val t2: (Context) => String = parse_element (element ("""ExcAVR4.t2"""))
    val t3: (Context) => String = parse_element (element ("""ExcAVR4.t3"""))
    val t4: (Context) => String = parse_element (element ("""ExcAVR4.t4"""))
    val tif: (Context) => String = parse_element (element ("""ExcAVR4.tif"""))
    val vfmn: (Context) => String = parse_element (element ("""ExcAVR4.vfmn"""))
    val vfmx: (Context) => String = parse_element (element ("""ExcAVR4.vfmx"""))
    val vrmn: (Context) => String = parse_element (element ("""ExcAVR4.vrmn"""))
    val vrmx: (Context) => String = parse_element (element ("""ExcAVR4.vrmx"""))
...
extends
    Parseable[ExcAVR5]
{
    val ka: (Context) => String = parse_element (element ("""ExcAVR5.ka"""))
    val rex: (Context) => String = parse_element (element ("""ExcAVR5.rex"""))
    val ta: (Context) => String = parse_element (element ("""ExcAVR5.ta"""))
...
extends
    Parseable[ExcAVR7]
{
    val a1: (Context) => String = parse_element (element ("""ExcAVR7.a1"""))
    val a2: (Context) => String = parse_element (element ("""ExcAVR7.a2"""))
    val a3: (Context) => String = parse_element (element ("""ExcAVR7.a3"""))
    val a4: (Context) => String = parse_element (element ("""ExcAVR7.a4"""))
    val a5: (Context) => String = parse_element (element ("""ExcAVR7.a5"""))
    val a6: (Context) => String = parse_element (element ("""ExcAVR7.a6"""))
    val k1: (Context) => String = parse_element (element ("""ExcAVR7.k1"""))
    val k3: (Context) => String = parse_element (element ("""ExcAVR7.k3"""))
    val k5: (Context) => String = parse_element (element ("""ExcAVR7.k5"""))
    val t1: (Context) => String = parse_element (element ("""ExcAVR7.t1"""))
    val t2: (Context) => String = parse_element (element ("""ExcAVR7.t2"""))
    val t3: (Context) => String = parse_element (element ("""ExcAVR7.t3"""))
    val t4: (Context) => String = parse_element (element ("""ExcAVR7.t4"""))
    val t5: (Context) => String = parse_element (element ("""ExcAVR7.t5"""))
    val t6: (Context) => String = parse_element (element ("""ExcAVR7.t6"""))
    val vmax1: (Context) => String = parse_element (element ("""ExcAVR7.vmax1"""))
    val vmax3: (Context) => String = parse_element (element ("""ExcAVR7.vmax3"""))
    val vmax5: (Context) => String = parse_element (element ("""ExcAVR7.vmax5"""))
    val vmin1: (Context) => String = parse_element (element ("""ExcAVR7.vmin1"""))
    val vmin3: (Context) => String = parse_element (element ("""ExcAVR7.vmin3"""))
    val vmin5: (Context) => String = parse_element (element ("""ExcAVR7.vmin5"""))
    ...
    Parseable[ExcBBC]
{
    ...
    val t4: (Context) => String = parse_element (element ("""ExcBBC.t4"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcBBC.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcBBC.vrmin"""))
    val xe: (Context) => String = parse_element (element ("""ExcBBC.xe"""))
...
extends
    Parseable[ExcCZ]
{
    val efdmax: (Context) => String = parse_element (element ("""ExcCZ.efdmax"""))
    val efdmin: (Context) => String = parse_element (element ("""ExcCZ.efdmin"""))
    val ka: (Context) => String = parse_element (element ("""ExcCZ.ka"""))
    val ke: (Context) => String = parse_element (element ("""ExcCZ.ke"""))
    val kp: (Context) => String = parse_element (element ("""ExcCZ.kp"""))
    val ta: (Context) => String = parse_element (element ("""ExcCZ.ta"""))
    val tc: (Context) => String = parse_element (element ("""ExcCZ.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcCZ.te"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcCZ.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcCZ.vrmin"""))
...
extends
    Parseable[ExcDC1A]
{
    val edfmax: (Context) => String = parse_element (element ("""ExcDC1A.edfmax"""))
    val efd1: (Context) => String = parse_element (element ("""ExcDC1A.efd1"""))
    val efd2: (Context) => String = parse_element (element ("""ExcDC1A.efd2"""))
    val efdmin: (Context) => String = parse_element (element ("""ExcDC1A.efdmin"""))
    val exclim: (Context) => String = parse_element (element ("""ExcDC1A.exclim"""))
    val ka: (Context) => String = parse_element (element ("""ExcDC1A.ka"""))
    val ke: (Context) => String = parse_element (element ("""ExcDC1A.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcDC1A.kf"""))
    val ks: (Context) => String = parse_element (element ("""ExcDC1A.ks"""))
    val seefd1: (Context) => String = parse_element (element ("""ExcDC1A.seefd1"""))
    val seefd2: (Context) => String = parse_element (element ("""ExcDC1A.seefd2"""))
    val ta: (Context) => String = parse_element (element ("""ExcDC1A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcDC1A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcDC1A.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcDC1A.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcDC1A.tf"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcDC1A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcDC1A.vrmin"""))
...
extends
    Parseable[ExcDC2A]
{
    val efd1: (Context) => String = parse_element (element ("""ExcDC2A.efd1"""))
    val efd2: (Context) => String = parse_element (element ("""ExcDC2A.efd2"""))
    val exclim: (Context) => String = parse_element (element ("""ExcDC2A.exclim"""))
    val ka: (Context) => String = parse_element (element ("""ExcDC2A.ka"""))
    val ke: (Context) => String = parse_element (element ("""ExcDC2A.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcDC2A.kf"""))
    val ks: (Context) => String = parse_element (element ("""ExcDC2A.ks"""))
    val seefd1: (Context) => String = parse_element (element ("""ExcDC2A.seefd1"""))
    val seefd2: (Context) => String = parse_element (element ("""ExcDC2A.seefd2"""))
    val ta: (Context) => String = parse_element (element ("""ExcDC2A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcDC2A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcDC2A.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcDC2A.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcDC2A.tf"""))
    val tf1: (Context) => String = parse_element (element ("""ExcDC2A.tf1"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcDC2A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcDC2A.vrmin"""))
    val vtlim: (Context) => String = parse_element (element ("""ExcDC2A.vtlim"""))
...
extends
    Parseable[ExcDC3A]
{
    val edfmax: (Context) => String = parse_element (element ("""ExcDC3A.edfmax"""))
    val efd1: (Context) => String = parse_element (element ("""ExcDC3A.efd1"""))
    val efd2: (Context) => String = parse_element (element ("""ExcDC3A.efd2"""))
    val efdlim: (Context) => String = parse_element (element ("""ExcDC3A.efdlim"""))
    val efdmin: (Context) => String = parse_element (element ("""ExcDC3A.efdmin"""))
    val exclim: (Context) => String = parse_element (element ("""ExcDC3A.exclim"""))
    val ke: (Context) => String = parse_element (element ("""ExcDC3A.ke"""))
    val kr: (Context) => String = parse_element (element ("""ExcDC3A.kr"""))
    val ks: (Context) => String = parse_element (element ("""ExcDC3A.ks"""))
    val kv: (Context) => String = parse_element (element ("""ExcDC3A.kv"""))
    val seefd1: (Context) => String = parse_element (element ("""ExcDC3A.seefd1"""))
    val seefd2: (Context) => String = parse_element (element ("""ExcDC3A.seefd2"""))
    val te: (Context) => String = parse_element (element ("""ExcDC3A.te"""))
    val trh: (Context) => String = parse_element (element ("""ExcDC3A.trh"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcDC3A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcDC3A.vrmin"""))
...
extends
    Parseable[ExcDC3A1]
{
    val exclim: (Context) => String = parse_element (element ("""ExcDC3A1.exclim"""))
    val ka: (Context) => String = parse_element (element ("""ExcDC3A1.ka"""))
    val ke: (Context) => String = parse_element (element ("""ExcDC3A1.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcDC3A1.kf"""))
    val ki: (Context) => String = parse_element (element ("""ExcDC3A1.ki"""))
    val kp: (Context) => String = parse_element (element ("""ExcDC3A1.kp"""))
    val ta: (Context) => String = parse_element (element ("""ExcDC3A1.ta"""))
    val te: (Context) => String = parse_element (element ("""ExcDC3A1.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcDC3A1.tf"""))
    val vb1max: (Context) => String = parse_element (element ("""ExcDC3A1.vb1max"""))
    val vblim: (Context) => String = parse_element (element ("""ExcDC3A1.vblim"""))
    val vbmax: (Context) => String = parse_element (element ("""ExcDC3A1.vbmax"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcDC3A1.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcDC3A1.vrmin"""))
...
extends
    Parseable[ExcELIN1]
{
    val dpnf: (Context) => String = parse_element (element ("""ExcELIN1.dpnf"""))
    val efmax: (Context) => String = parse_element (element ("""ExcELIN1.efmax"""))
    val efmin: (Context) => String = parse_element (element ("""ExcELIN1.efmin"""))
    val ks1: (Context) => String = parse_element (element ("""ExcELIN1.ks1"""))
    val ks2: (Context) => String = parse_element (element ("""ExcELIN1.ks2"""))
    val smax: (Context) => String = parse_element (element ("""ExcELIN1.smax"""))
    val tfi: (Context) => String = parse_element (element ("""ExcELIN1.tfi"""))
    val tnu: (Context) => String = parse_element (element ("""ExcELIN1.tnu"""))
    val ts1: (Context) => String = parse_element (element ("""ExcELIN1.ts1"""))
    val ts2: (Context) => String = parse_element (element ("""ExcELIN1.ts2"""))
    val tsw: (Context) => String = parse_element (element ("""ExcELIN1.tsw"""))
    val vpi: (Context) => String = parse_element (element ("""ExcELIN1.vpi"""))
    val vpnf: (Context) => String = parse_element (element ("""ExcELIN1.vpnf"""))
    val vpu: (Context) => String = parse_element (element ("""ExcELIN1.vpu"""))
    val xe: (Context) => String = parse_element (element ("""ExcELIN1.xe"""))
...
extends
    Parseable[ExcELIN2]
{
    val efdbas: (Context) => String = parse_element (element ("""ExcELIN2.efdbas"""))
    val iefmax: (Context) => String = parse_element (element ("""ExcELIN2.iefmax"""))
    val iefmax2: (Context) => String = parse_element (element ("""ExcELIN2.iefmax2"""))
    val iefmin: (Context) => String = parse_element (element ("""ExcELIN2.iefmin"""))
    val k1: (Context) => String = parse_element (element ("""ExcELIN2.k1"""))
    val k1ec: (Context) => String = parse_element (element ("""ExcELIN2.k1ec"""))
    val k2: (Context) => String = parse_element (element ("""ExcELIN2.k2"""))
    val k3: (Context) => String = parse_element (element ("""ExcELIN2.k3"""))
    val k4: (Context) => String = parse_element (element ("""ExcELIN2.k4"""))
    val kd1: (Context) => String = parse_element (element ("""ExcELIN2.kd1"""))
    val ke2: (Context) => String = parse_element (element ("""ExcELIN2.ke2"""))
    val ketb: (Context) => String = parse_element (element ("""ExcELIN2.ketb"""))
    val pid1max: (Context) => String = parse_element (element ("""ExcELIN2.pid1max"""))
    val seve1: (Context) => String = parse_element (element ("""ExcELIN2.seve1"""))
    val seve2: (Context) => String = parse_element (element ("""ExcELIN2.seve2"""))
    val tb1: (Context) => String = parse_element (element ("""ExcELIN2.tb1"""))
    val te: (Context) => String = parse_element (element ("""ExcELIN2.te"""))
    val te2: (Context) => String = parse_element (element ("""ExcELIN2.te2"""))
    val ti1: (Context) => String = parse_element (element ("""ExcELIN2.ti1"""))
    val ti3: (Context) => String = parse_element (element ("""ExcELIN2.ti3"""))
    val ti4: (Context) => String = parse_element (element ("""ExcELIN2.ti4"""))
    val tr4: (Context) => String = parse_element (element ("""ExcELIN2.tr4"""))
    val upmax: (Context) => String = parse_element (element ("""ExcELIN2.upmax"""))
    val upmin: (Context) => String = parse_element (element ("""ExcELIN2.upmin"""))
    val ve1: (Context) => String = parse_element (element ("""ExcELIN2.ve1"""))
    val ve2: (Context) => String = parse_element (element ("""ExcELIN2.ve2"""))
    val xp: (Context) => String = parse_element (element ("""ExcELIN2.xp"""))
...
extends
    Parseable[ExcHU]
{
    val ae: (Context) => String = parse_element (element ("""ExcHU.ae"""))
    val ai: (Context) => String = parse_element (element ("""ExcHU.ai"""))
    val atr: (Context) => String = parse_element (element ("""ExcHU.atr"""))
    val emax: (Context) => String = parse_element (element ("""ExcHU.emax"""))
    val emin: (Context) => String = parse_element (element ("""ExcHU.emin"""))
    val imax: (Context) => String = parse_element (element ("""ExcHU.imax"""))
    val imin: (Context) => String = parse_element (element ("""ExcHU.imin"""))
    val ke: (Context) => String = parse_element (element ("""ExcHU.ke"""))
    val ki: (Context) => String = parse_element (element ("""ExcHU.ki"""))
    val te: (Context) => String = parse_element (element ("""ExcHU.te"""))
    val ti: (Context) => String = parse_element (element ("""ExcHU.ti"""))
    val tr: (Context) => String = parse_element (element ("""ExcHU.tr"""))
...
{
    val ka: (Context) => String = parse_element (element ("""ExcIEEEAC1A.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcIEEEAC1A.kc"""))
    val kd: (Context) => String = parse_element (element ("""ExcIEEEAC1A.kd"""))
    val ke: (Context) => String = parse_element (element ("""ExcIEEEAC1A.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcIEEEAC1A.kf"""))
    val seve1: (Context) => String = parse_element (element ("""ExcIEEEAC1A.seve1"""))
    val seve2: (Context) => String = parse_element (element ("""ExcIEEEAC1A.seve2"""))
    val ta: (Context) => String = parse_element (element ("""ExcIEEEAC1A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcIEEEAC1A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcIEEEAC1A.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcIEEEAC1A.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcIEEEAC1A.tf"""))
    val vamax: (Context) => String = parse_element (element ("""ExcIEEEAC1A.vamax"""))
    val vamin: (Context) => String = parse_element (element ("""ExcIEEEAC1A.vamin"""))
    val ve1: (Context) => String = parse_element (element ("""ExcIEEEAC1A.ve1"""))
    val ve2: (Context) => String = parse_element (element ("""ExcIEEEAC1A.ve2"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEAC1A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEAC1A.vrmin"""))
...
{
    val ka: (Context) => String = parse_element (element ("""ExcIEEEAC2A.ka"""))
    val kb: (Context) => String = parse_element (element ("""ExcIEEEAC2A.kb"""))
    val kc: (Context) => String = parse_element (element ("""ExcIEEEAC2A.kc"""))
    val kd: (Context) => String = parse_element (element ("""ExcIEEEAC2A.kd"""))
    val ke: (Context) => String = parse_element (element ("""ExcIEEEAC2A.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcIEEEAC2A.kf"""))
    val kh: (Context) => String = parse_element (element ("""ExcIEEEAC2A.kh"""))
    val seve1: (Context) => String = parse_element (element ("""ExcIEEEAC2A.seve1"""))
    val seve2: (Context) => String = parse_element (element ("""ExcIEEEAC2A.seve2"""))
    val ta: (Context) => String = parse_element (element ("""ExcIEEEAC2A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcIEEEAC2A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcIEEEAC2A.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcIEEEAC2A.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcIEEEAC2A.tf"""))
    val vamax: (Context) => String = parse_element (element ("""ExcIEEEAC2A.vamax"""))
    val vamin: (Context) => String = parse_element (element ("""ExcIEEEAC2A.vamin"""))
    val ve1: (Context) => String = parse_element (element ("""ExcIEEEAC2A.ve1"""))
    val ve2: (Context) => String = parse_element (element ("""ExcIEEEAC2A.ve2"""))
    val vfemax: (Context) => String = parse_element (element ("""ExcIEEEAC2A.vfemax"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEAC2A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEAC2A.vrmin"""))
...
{
    val efdn: (Context) => String = parse_element (element ("""ExcIEEEAC3A.efdn"""))
    val ka: (Context) => String = parse_element (element ("""ExcIEEEAC3A.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcIEEEAC3A.kc"""))
    val kd: (Context) => String = parse_element (element ("""ExcIEEEAC3A.kd"""))
    val ke: (Context) => String = parse_element (element ("""ExcIEEEAC3A.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcIEEEAC3A.kf"""))
    val kn: (Context) => String = parse_element (element ("""ExcIEEEAC3A.kn"""))
    val kr: (Context) => String = parse_element (element ("""ExcIEEEAC3A.kr"""))
    val seve1: (Context) => String = parse_element (element ("""ExcIEEEAC3A.seve1"""))
    val seve2: (Context) => String = parse_element (element ("""ExcIEEEAC3A.seve2"""))
    val ta: (Context) => String = parse_element (element ("""ExcIEEEAC3A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcIEEEAC3A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcIEEEAC3A.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcIEEEAC3A.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcIEEEAC3A.tf"""))
    val vamax: (Context) => String = parse_element (element ("""ExcIEEEAC3A.vamax"""))
    val vamin: (Context) => String = parse_element (element ("""ExcIEEEAC3A.vamin"""))
    val ve1: (Context) => String = parse_element (element ("""ExcIEEEAC3A.ve1"""))
    val ve2: (Context) => String = parse_element (element ("""ExcIEEEAC3A.ve2"""))
    val vemin: (Context) => String = parse_element (element ("""ExcIEEEAC3A.vemin"""))
    val vfemax: (Context) => String = parse_element (element ("""ExcIEEEAC3A.vfemax"""))
...
{
    val ka: (Context) => String = parse_element (element ("""ExcIEEEAC4A.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcIEEEAC4A.kc"""))
    val ta: (Context) => String = parse_element (element ("""ExcIEEEAC4A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcIEEEAC4A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcIEEEAC4A.tc"""))
    val vimax: (Context) => String = parse_element (element ("""ExcIEEEAC4A.vimax"""))
    val vimin: (Context) => String = parse_element (element ("""ExcIEEEAC4A.vimin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEAC4A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEAC4A.vrmin"""))
...
{
    val efd1: (Context) => String = parse_element (element ("""ExcIEEEAC5A.efd1"""))
    val efd2: (Context) => String = parse_element (element ("""ExcIEEEAC5A.efd2"""))
    val ka: (Context) => String = parse_element (element ("""ExcIEEEAC5A.ka"""))
    val ke: (Context) => String = parse_element (element ("""ExcIEEEAC5A.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcIEEEAC5A.kf"""))
    val seefd1: (Context) => String = parse_element (element ("""ExcIEEEAC5A.seefd1"""))
    val seefd2: (Context) => String = parse_element (element ("""ExcIEEEAC5A.seefd2"""))
    val ta: (Context) => String = parse_element (element ("""ExcIEEEAC5A.ta"""))
    val te: (Context) => String = parse_element (element ("""ExcIEEEAC5A.te"""))
    val tf1: (Context) => String = parse_element (element ("""ExcIEEEAC5A.tf1"""))
    val tf2: (Context) => String = parse_element (element ("""ExcIEEEAC5A.tf2"""))
    val tf3: (Context) => String = parse_element (element ("""ExcIEEEAC5A.tf3"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEAC5A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEAC5A.vrmin"""))
...
{
    val ka: (Context) => String = parse_element (element ("""ExcIEEEAC6A.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcIEEEAC6A.kc"""))
    val kd: (Context) => String = parse_element (element ("""ExcIEEEAC6A.kd"""))
    val ke: (Context) => String = parse_element (element ("""ExcIEEEAC6A.ke"""))
    val kh: (Context) => String = parse_element (element ("""ExcIEEEAC6A.kh"""))
    val seve1: (Context) => String = parse_element (element ("""ExcIEEEAC6A.seve1"""))
    val seve2: (Context) => String = parse_element (element ("""ExcIEEEAC6A.seve2"""))
    val ta: (Context) => String = parse_element (element ("""ExcIEEEAC6A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcIEEEAC6A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcIEEEAC6A.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcIEEEAC6A.te"""))
    val th: (Context) => String = parse_element (element ("""ExcIEEEAC6A.th"""))
    val tj: (Context) => String = parse_element (element ("""ExcIEEEAC6A.tj"""))
    val tk: (Context) => String = parse_element (element ("""ExcIEEEAC6A.tk"""))
    val vamax: (Context) => String = parse_element (element ("""ExcIEEEAC6A.vamax"""))
    val vamin: (Context) => String = parse_element (element ("""ExcIEEEAC6A.vamin"""))
    val ve1: (Context) => String = parse_element (element ("""ExcIEEEAC6A.ve1"""))
    val ve2: (Context) => String = parse_element (element ("""ExcIEEEAC6A.ve2"""))
    val vfelim: (Context) => String = parse_element (element ("""ExcIEEEAC6A.vfelim"""))
    val vhmax: (Context) => String = parse_element (element ("""ExcIEEEAC6A.vhmax"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEAC6A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEAC6A.vrmin"""))
...
{
    val kc: (Context) => String = parse_element (element ("""ExcIEEEAC7B.kc"""))
    val kd: (Context) => String = parse_element (element ("""ExcIEEEAC7B.kd"""))
    val kdr: (Context) => String = parse_element (element ("""ExcIEEEAC7B.kdr"""))
    val ke: (Context) => String = parse_element (element ("""ExcIEEEAC7B.ke"""))
    val kf1: (Context) => String = parse_element (element ("""ExcIEEEAC7B.kf1"""))
    val kf2: (Context) => String = parse_element (element ("""ExcIEEEAC7B.kf2"""))
    val kf3: (Context) => String = parse_element (element ("""ExcIEEEAC7B.kf3"""))
    val kia: (Context) => String = parse_element (element ("""ExcIEEEAC7B.kia"""))
    val kir: (Context) => String = parse_element (element ("""ExcIEEEAC7B.kir"""))
    val kl: (Context) => String = parse_element (element ("""ExcIEEEAC7B.kl"""))
    val kp: (Context) => String = parse_element (element ("""ExcIEEEAC7B.kp"""))
    val kpa: (Context) => String = parse_element (element ("""ExcIEEEAC7B.kpa"""))
    val kpr: (Context) => String = parse_element (element ("""ExcIEEEAC7B.kpr"""))
    val seve1: (Context) => String = parse_element (element ("""ExcIEEEAC7B.seve1"""))
    val seve2: (Context) => String = parse_element (element ("""ExcIEEEAC7B.seve2"""))
    val tdr: (Context) => String = parse_element (element ("""ExcIEEEAC7B.tdr"""))
    val te: (Context) => String = parse_element (element ("""ExcIEEEAC7B.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcIEEEAC7B.tf"""))
    val vamax: (Context) => String = parse_element (element ("""ExcIEEEAC7B.vamax"""))
    val vamin: (Context) => String = parse_element (element ("""ExcIEEEAC7B.vamin"""))
    val ve1: (Context) => String = parse_element (element ("""ExcIEEEAC7B.ve1"""))
    val ve2: (Context) => String = parse_element (element ("""ExcIEEEAC7B.ve2"""))
    val vemin: (Context) => String = parse_element (element ("""ExcIEEEAC7B.vemin"""))
    val vfemax: (Context) => String = parse_element (element ("""ExcIEEEAC7B.vfemax"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEAC7B.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEAC7B.vrmin"""))
...
{
    val ka: (Context) => String = parse_element (element ("""ExcIEEEAC8B.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcIEEEAC8B.kc"""))
    val kd: (Context) => String = parse_element (element ("""ExcIEEEAC8B.kd"""))
    val kdr: (Context) => String = parse_element (element ("""ExcIEEEAC8B.kdr"""))
    val ke: (Context) => String = parse_element (element ("""ExcIEEEAC8B.ke"""))
    val kir: (Context) => String = parse_element (element ("""ExcIEEEAC8B.kir"""))
    val kpr: (Context) => String = parse_element (element ("""ExcIEEEAC8B.kpr"""))
    val seve1: (Context) => String = parse_element (element ("""ExcIEEEAC8B.seve1"""))
    val seve2: (Context) => String = parse_element (element ("""ExcIEEEAC8B.seve2"""))
    val ta: (Context) => String = parse_element (element ("""ExcIEEEAC8B.ta"""))
    val tdr: (Context) => String = parse_element (element ("""ExcIEEEAC8B.tdr"""))
    val te: (Context) => String = parse_element (element ("""ExcIEEEAC8B.te"""))
    val ve1: (Context) => String = parse_element (element ("""ExcIEEEAC8B.ve1"""))
    val ve2: (Context) => String = parse_element (element ("""ExcIEEEAC8B.ve2"""))
    val vemin: (Context) => String = parse_element (element ("""ExcIEEEAC8B.vemin"""))
    val vfemax: (Context) => String = parse_element (element ("""ExcIEEEAC8B.vfemax"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEAC8B.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEAC8B.vrmin"""))
...
{
    val efd1: (Context) => String = parse_element (element ("""ExcIEEEDC1A.efd1"""))
    val efd2: (Context) => String = parse_element (element ("""ExcIEEEDC1A.efd2"""))
    val exclim: (Context) => String = parse_element (element ("""ExcIEEEDC1A.exclim"""))
    val ka: (Context) => String = parse_element (element ("""ExcIEEEDC1A.ka"""))
    val ke: (Context) => String = parse_element (element ("""ExcIEEEDC1A.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcIEEEDC1A.kf"""))
    val seefd1: (Context) => String = parse_element (element ("""ExcIEEEDC1A.seefd1"""))
    val seefd2: (Context) => String = parse_element (element ("""ExcIEEEDC1A.seefd2"""))
    val ta: (Context) => String = parse_element (element ("""ExcIEEEDC1A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcIEEEDC1A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcIEEEDC1A.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcIEEEDC1A.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcIEEEDC1A.tf"""))
    val uelin: (Context) => String = parse_element (element ("""ExcIEEEDC1A.uelin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEDC1A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEDC1A.vrmin"""))
...
{
    val efd1: (Context) => String = parse_element (element ("""ExcIEEEDC2A.efd1"""))
    val efd2: (Context) => String = parse_element (element ("""ExcIEEEDC2A.efd2"""))
    val exclim: (Context) => String = parse_element (element ("""ExcIEEEDC2A.exclim"""))
    val ka: (Context) => String = parse_element (element ("""ExcIEEEDC2A.ka"""))
    val ke: (Context) => String = parse_element (element ("""ExcIEEEDC2A.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcIEEEDC2A.kf"""))
    val seefd1: (Context) => String = parse_element (element ("""ExcIEEEDC2A.seefd1"""))
    val seefd2: (Context) => String = parse_element (element ("""ExcIEEEDC2A.seefd2"""))
    val ta: (Context) => String = parse_element (element ("""ExcIEEEDC2A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcIEEEDC2A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcIEEEDC2A.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcIEEEDC2A.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcIEEEDC2A.tf"""))
    val uelin: (Context) => String = parse_element (element ("""ExcIEEEDC2A.uelin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEDC2A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEDC2A.vrmin"""))
...
{
    val efd1: (Context) => String = parse_element (element ("""ExcIEEEDC3A.efd1"""))
    val efd2: (Context) => String = parse_element (element ("""ExcIEEEDC3A.efd2"""))
    val exclim: (Context) => String = parse_element (element ("""ExcIEEEDC3A.exclim"""))
    val ke: (Context) => String = parse_element (element ("""ExcIEEEDC3A.ke"""))
    val kv: (Context) => String = parse_element (element ("""ExcIEEEDC3A.kv"""))
    val seefd1: (Context) => String = parse_element (element ("""ExcIEEEDC3A.seefd1"""))
    val seefd2: (Context) => String = parse_element (element ("""ExcIEEEDC3A.seefd2"""))
    val te: (Context) => String = parse_element (element ("""ExcIEEEDC3A.te"""))
    val trh: (Context) => String = parse_element (element ("""ExcIEEEDC3A.trh"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEDC3A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEDC3A.vrmin"""))
...
{
    val efd1: (Context) => String = parse_element (element ("""ExcIEEEDC4B.efd1"""))
    val efd2: (Context) => String = parse_element (element ("""ExcIEEEDC4B.efd2"""))
    val ka: (Context) => String = parse_element (element ("""ExcIEEEDC4B.ka"""))
    val kd: (Context) => String = parse_element (element ("""ExcIEEEDC4B.kd"""))
    val ke: (Context) => String = parse_element (element ("""ExcIEEEDC4B.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcIEEEDC4B.kf"""))
    val ki: (Context) => String = parse_element (element ("""ExcIEEEDC4B.ki"""))
    val kp: (Context) => String = parse_element (element ("""ExcIEEEDC4B.kp"""))
    val oelin: (Context) => String = parse_element (element ("""ExcIEEEDC4B.oelin"""))
    val seefd1: (Context) => String = parse_element (element ("""ExcIEEEDC4B.seefd1"""))
    val seefd2: (Context) => String = parse_element (element ("""ExcIEEEDC4B.seefd2"""))
    val ta: (Context) => String = parse_element (element ("""ExcIEEEDC4B.ta"""))
    val td: (Context) => String = parse_element (element ("""ExcIEEEDC4B.td"""))
    val te: (Context) => String = parse_element (element ("""ExcIEEEDC4B.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcIEEEDC4B.tf"""))
    val uelin: (Context) => String = parse_element (element ("""ExcIEEEDC4B.uelin"""))
    val vemin: (Context) => String = parse_element (element ("""ExcIEEEDC4B.vemin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEDC4B.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEDC4B.vrmin"""))
...
{
    val ilr: (Context) => String = parse_element (element ("""ExcIEEEST1A.ilr"""))
    val ka: (Context) => String = parse_element (element ("""ExcIEEEST1A.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcIEEEST1A.kc"""))
    val kf: (Context) => String = parse_element (element ("""ExcIEEEST1A.kf"""))
    val klr: (Context) => String = parse_element (element ("""ExcIEEEST1A.klr"""))
    val pssin: (Context) => String = parse_element (element ("""ExcIEEEST1A.pssin"""))
    val ta: (Context) => String = parse_element (element ("""ExcIEEEST1A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcIEEEST1A.tb"""))
    val tb1: (Context) => String = parse_element (element ("""ExcIEEEST1A.tb1"""))
    val tc: (Context) => String = parse_element (element ("""ExcIEEEST1A.tc"""))
    val tc1: (Context) => String = parse_element (element ("""ExcIEEEST1A.tc1"""))
    val tf: (Context) => String = parse_element (element ("""ExcIEEEST1A.tf"""))
    val uelin: (Context) => String = parse_attribute (attribute ("""ExcIEEEST1A.uelin"""))
    val vamax: (Context) => String = parse_element (element ("""ExcIEEEST1A.vamax"""))
    val vamin: (Context) => String = parse_element (element ("""ExcIEEEST1A.vamin"""))
    val vimax: (Context) => String = parse_element (element ("""ExcIEEEST1A.vimax"""))
    val vimin: (Context) => String = parse_element (element ("""ExcIEEEST1A.vimin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEST1A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEST1A.vrmin"""))
...
{
    val efdmax: (Context) => String = parse_element (element ("""ExcIEEEST2A.efdmax"""))
    val ka: (Context) => String = parse_element (element ("""ExcIEEEST2A.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcIEEEST2A.kc"""))
    val ke: (Context) => String = parse_element (element ("""ExcIEEEST2A.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcIEEEST2A.kf"""))
    val ki: (Context) => String = parse_element (element ("""ExcIEEEST2A.ki"""))
    val kp: (Context) => String = parse_element (element ("""ExcIEEEST2A.kp"""))
    val ta: (Context) => String = parse_element (element ("""ExcIEEEST2A.ta"""))
    val te: (Context) => String = parse_element (element ("""ExcIEEEST2A.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcIEEEST2A.tf"""))
    val uelin: (Context) => String = parse_element (element ("""ExcIEEEST2A.uelin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEST2A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEST2A.vrmin"""))
...
{
    val ka: (Context) => String = parse_element (element ("""ExcIEEEST3A.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcIEEEST3A.kc"""))
    val kg: (Context) => String = parse_element (element ("""ExcIEEEST3A.kg"""))
    val ki: (Context) => String = parse_element (element ("""ExcIEEEST3A.ki"""))
    val km: (Context) => String = parse_element (element ("""ExcIEEEST3A.km"""))
    val kp: (Context) => String = parse_element (element ("""ExcIEEEST3A.kp"""))
    val ta: (Context) => String = parse_element (element ("""ExcIEEEST3A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcIEEEST3A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcIEEEST3A.tc"""))
    val thetap: (Context) => String = parse_element (element ("""ExcIEEEST3A.thetap"""))
    val tm: (Context) => String = parse_element (element ("""ExcIEEEST3A.tm"""))
    val vbmax: (Context) => String = parse_element (element ("""ExcIEEEST3A.vbmax"""))
    val vgmax: (Context) => String = parse_element (element ("""ExcIEEEST3A.vgmax"""))
    val vimax: (Context) => String = parse_element (element ("""ExcIEEEST3A.vimax"""))
    val vimin: (Context) => String = parse_element (element ("""ExcIEEEST3A.vimin"""))
    val vmmax: (Context) => String = parse_element (element ("""ExcIEEEST3A.vmmax"""))
    val vmmin: (Context) => String = parse_element (element ("""ExcIEEEST3A.vmmin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEST3A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEST3A.vrmin"""))
    val xl: (Context) => String = parse_element (element ("""ExcIEEEST3A.xl"""))
...
{
    val kc: (Context) => String = parse_element (element ("""ExcIEEEST4B.kc"""))
    val kg: (Context) => String = parse_element (element ("""ExcIEEEST4B.kg"""))
    val ki: (Context) => String = parse_element (element ("""ExcIEEEST4B.ki"""))
    val kim: (Context) => String = parse_element (element ("""ExcIEEEST4B.kim"""))
    val kir: (Context) => String = parse_element (element ("""ExcIEEEST4B.kir"""))
    val kp: (Context) => String = parse_element (element ("""ExcIEEEST4B.kp"""))
    val kpm: (Context) => String = parse_element (element ("""ExcIEEEST4B.kpm"""))
    val kpr: (Context) => String = parse_element (element ("""ExcIEEEST4B.kpr"""))
    val ta: (Context) => String = parse_element (element ("""ExcIEEEST4B.ta"""))
    val thetap: (Context) => String = parse_element (element ("""ExcIEEEST4B.thetap"""))
    val vbmax: (Context) => String = parse_element (element ("""ExcIEEEST4B.vbmax"""))
    val vmmax: (Context) => String = parse_element (element ("""ExcIEEEST4B.vmmax"""))
    val vmmin: (Context) => String = parse_element (element ("""ExcIEEEST4B.vmmin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEST4B.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEST4B.vrmin"""))
    val xl: (Context) => String = parse_element (element ("""ExcIEEEST4B.xl"""))
...
{
    val kc: (Context) => String = parse_element (element ("""ExcIEEEST5B.kc"""))
    val kr: (Context) => String = parse_element (element ("""ExcIEEEST5B.kr"""))
    val t1: (Context) => String = parse_element (element ("""ExcIEEEST5B.t1"""))
    val tb1: (Context) => String = parse_element (element ("""ExcIEEEST5B.tb1"""))
    val tb2: (Context) => String = parse_element (element ("""ExcIEEEST5B.tb2"""))
    val tc1: (Context) => String = parse_element (element ("""ExcIEEEST5B.tc1"""))
    val tc2: (Context) => String = parse_element (element ("""ExcIEEEST5B.tc2"""))
    val tob1: (Context) => String = parse_element (element ("""ExcIEEEST5B.tob1"""))
    val tob2: (Context) => String = parse_element (element ("""ExcIEEEST5B.tob2"""))
    val toc1: (Context) => String = parse_element (element ("""ExcIEEEST5B.toc1"""))
    val toc2: (Context) => String = parse_element (element ("""ExcIEEEST5B.toc2"""))
    val tub1: (Context) => String = parse_element (element ("""ExcIEEEST5B.tub1"""))
    val tub2: (Context) => String = parse_element (element ("""ExcIEEEST5B.tub2"""))
    val tuc1: (Context) => String = parse_element (element ("""ExcIEEEST5B.tuc1"""))
    val tuc2: (Context) => String = parse_element (element ("""ExcIEEEST5B.tuc2"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEST5B.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEST5B.vrmin"""))
...
{
    val ilr: (Context) => String = parse_element (element ("""ExcIEEEST6B.ilr"""))
    val kci: (Context) => String = parse_element (element ("""ExcIEEEST6B.kci"""))
    val kff: (Context) => String = parse_element (element ("""ExcIEEEST6B.kff"""))
    val kg: (Context) => String = parse_element (element ("""ExcIEEEST6B.kg"""))
    val kia: (Context) => String = parse_element (element ("""ExcIEEEST6B.kia"""))
    val klr: (Context) => String = parse_element (element ("""ExcIEEEST6B.klr"""))
    val km: (Context) => String = parse_element (element ("""ExcIEEEST6B.km"""))
    val kpa: (Context) => String = parse_element (element ("""ExcIEEEST6B.kpa"""))
    val oelin: (Context) => String = parse_attribute (attribute ("""ExcIEEEST6B.oelin"""))
    val tg: (Context) => String = parse_element (element ("""ExcIEEEST6B.tg"""))
    val vamax: (Context) => String = parse_element (element ("""ExcIEEEST6B.vamax"""))
    val vamin: (Context) => String = parse_element (element ("""ExcIEEEST6B.vamin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEST6B.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEST6B.vrmin"""))
...
{
    val kh: (Context) => String = parse_element (element ("""ExcIEEEST7B.kh"""))
    val kia: (Context) => String = parse_element (element ("""ExcIEEEST7B.kia"""))
    val kl: (Context) => String = parse_element (element ("""ExcIEEEST7B.kl"""))
    val kpa: (Context) => String = parse_element (element ("""ExcIEEEST7B.kpa"""))
    val oelin: (Context) => String = parse_attribute (attribute ("""ExcIEEEST7B.oelin"""))
    val tb: (Context) => String = parse_element (element ("""ExcIEEEST7B.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcIEEEST7B.tc"""))
    val tf: (Context) => String = parse_element (element ("""ExcIEEEST7B.tf"""))
    val tg: (Context) => String = parse_element (element ("""ExcIEEEST7B.tg"""))
    val tia: (Context) => String = parse_element (element ("""ExcIEEEST7B.tia"""))
    val uelin: (Context) => String = parse_attribute (attribute ("""ExcIEEEST7B.uelin"""))
    val vmax: (Context) => String = parse_element (element ("""ExcIEEEST7B.vmax"""))
    val vmin: (Context) => String = parse_element (element ("""ExcIEEEST7B.vmin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcIEEEST7B.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcIEEEST7B.vrmin"""))
...
extends
    Parseable[ExcOEX3T]
{
    val e1: (Context) => String = parse_element (element ("""ExcOEX3T.e1"""))
    val e2: (Context) => String = parse_element (element ("""ExcOEX3T.e2"""))
    val ka: (Context) => String = parse_element (element ("""ExcOEX3T.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcOEX3T.kc"""))
    val kd: (Context) => String = parse_element (element ("""ExcOEX3T.kd"""))
    val ke: (Context) => String = parse_element (element ("""ExcOEX3T.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcOEX3T.kf"""))
    val see1: (Context) => String = parse_element (element ("""ExcOEX3T.see1"""))
    val see2: (Context) => String = parse_element (element ("""ExcOEX3T.see2"""))
    val t1: (Context) => String = parse_element (element ("""ExcOEX3T.t1"""))
    val t2: (Context) => String = parse_element (element ("""ExcOEX3T.t2"""))
    val t3: (Context) => String = parse_element (element ("""ExcOEX3T.t3"""))
    val t4: (Context) => String = parse_element (element ("""ExcOEX3T.t4"""))
    val t5: (Context) => String = parse_element (element ("""ExcOEX3T.t5"""))
    val t6: (Context) => String = parse_element (element ("""ExcOEX3T.t6"""))
    val te: (Context) => String = parse_element (element ("""ExcOEX3T.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcOEX3T.tf"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcOEX3T.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcOEX3T.vrmin"""))
...
extends
    Parseable[ExcPIC]
{
    val e1: (Context) => String = parse_element (element ("""ExcPIC.e1"""))
    val e2: (Context) => String = parse_element (element ("""ExcPIC.e2"""))
    val efdmax: (Context) => String = parse_element (element ("""ExcPIC.efdmax"""))
    val efdmin: (Context) => String = parse_element (element ("""ExcPIC.efdmin"""))
    val ka: (Context) => String = parse_element (element ("""ExcPIC.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcPIC.kc"""))
    val ke: (Context) => String = parse_element (element ("""ExcPIC.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcPIC.kf"""))
    val ki: (Context) => String = parse_element (element ("""ExcPIC.ki"""))
    val kp: (Context) => String = parse_element (element ("""ExcPIC.kp"""))
    val se1: (Context) => String = parse_element (element ("""ExcPIC.se1"""))
    val se2: (Context) => String = parse_element (element ("""ExcPIC.se2"""))
    val ta1: (Context) => String = parse_element (element ("""ExcPIC.ta1"""))
    val ta2: (Context) => String = parse_element (element ("""ExcPIC.ta2"""))
    val ta3: (Context) => String = parse_element (element ("""ExcPIC.ta3"""))
    val ta4: (Context) => String = parse_element (element ("""ExcPIC.ta4"""))
    val te: (Context) => String = parse_element (element ("""ExcPIC.te"""))
    val tf1: (Context) => String = parse_element (element ("""ExcPIC.tf1"""))
    val tf2: (Context) => String = parse_element (element ("""ExcPIC.tf2"""))
    val vr1: (Context) => String = parse_element (element ("""ExcPIC.vr1"""))
    val vr2: (Context) => String = parse_element (element ("""ExcPIC.vr2"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcPIC.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcPIC.vrmin"""))
...
extends
    Parseable[ExcREXS]
{
    val e1: (Context) => String = parse_element (element ("""ExcREXS.e1"""))
    val e2: (Context) => String = parse_element (element ("""ExcREXS.e2"""))
    val fbf: (Context) => String = parse_attribute (attribute ("""ExcREXS.fbf"""))
    val flimf: (Context) => String = parse_element (element ("""ExcREXS.flimf"""))
    val kc: (Context) => String = parse_element (element ("""ExcREXS.kc"""))
    val kd: (Context) => String = parse_element (element ("""ExcREXS.kd"""))
    val ke: (Context) => String = parse_element (element ("""ExcREXS.ke"""))
    val kefd: (Context) => String = parse_element (element ("""ExcREXS.kefd"""))
    val kf: (Context) => String = parse_element (element ("""ExcREXS.kf"""))
    val kh: (Context) => String = parse_element (element ("""ExcREXS.kh"""))
    val kii: (Context) => String = parse_element (element ("""ExcREXS.kii"""))
    val kip: (Context) => String = parse_element (element ("""ExcREXS.kip"""))
    val ks: (Context) => String = parse_element (element ("""ExcREXS.ks"""))
    val kvi: (Context) => String = parse_element (element ("""ExcREXS.kvi"""))
    val kvp: (Context) => String = parse_element (element ("""ExcREXS.kvp"""))
    val kvphz: (Context) => String = parse_element (element ("""ExcREXS.kvphz"""))
    val nvphz: (Context) => String = parse_element (element ("""ExcREXS.nvphz"""))
    val se1: (Context) => String = parse_element (element ("""ExcREXS.se1"""))
    val se2: (Context) => String = parse_element (element ("""ExcREXS.se2"""))
    val ta: (Context) => String = parse_element (element ("""ExcREXS.ta"""))
    val tb1: (Context) => String = parse_element (element ("""ExcREXS.tb1"""))
    val tb2: (Context) => String = parse_element (element ("""ExcREXS.tb2"""))
    val tc1: (Context) => String = parse_element (element ("""ExcREXS.tc1"""))
    val tc2: (Context) => String = parse_element (element ("""ExcREXS.tc2"""))
    val te: (Context) => String = parse_element (element ("""ExcREXS.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcREXS.tf"""))
    val tf1: (Context) => String = parse_element (element ("""ExcREXS.tf1"""))
    val tf2: (Context) => String = parse_element (element ("""ExcREXS.tf2"""))
    val tp: (Context) => String = parse_element (element ("""ExcREXS.tp"""))
    val vcmax: (Context) => String = parse_element (element ("""ExcREXS.vcmax"""))
    val vfmax: (Context) => String = parse_element (element ("""ExcREXS.vfmax"""))
    val vfmin: (Context) => String = parse_element (element ("""ExcREXS.vfmin"""))
    val vimax: (Context) => String = parse_element (element ("""ExcREXS.vimax"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcREXS.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcREXS.vrmin"""))
    val xc: (Context) => String = parse_element (element ("""ExcREXS.xc"""))
...
extends
    Parseable[ExcSCRX]
{
    val cswitch: (Context) => String = parse_element (element ("""ExcSCRX.cswitch"""))
    val emax: (Context) => String = parse_element (element ("""ExcSCRX.emax"""))
    val emin: (Context) => String = parse_element (element ("""ExcSCRX.emin"""))
    val k: (Context) => String = parse_element (element ("""ExcSCRX.k"""))
    val rcrfd: (Context) => String = parse_element (element ("""ExcSCRX.rcrfd"""))
    val tatb: (Context) => String = parse_element (element ("""ExcSCRX.tatb"""))
    val tb: (Context) => String = parse_element (element ("""ExcSCRX.tb"""))
    val te: (Context) => String = parse_element (element ("""ExcSCRX.te"""))
...
extends
    Parseable[ExcSEXS]
{
    val efdmax: (Context) => String = parse_element (element ("""ExcSEXS.efdmax"""))
    val efdmin: (Context) => String = parse_element (element ("""ExcSEXS.efdmin"""))
    val emax: (Context) => String = parse_element (element ("""ExcSEXS.emax"""))
    val emin: (Context) => String = parse_element (element ("""ExcSEXS.emin"""))
    val k: (Context) => String = parse_element (element ("""ExcSEXS.k"""))
    val kc: (Context) => String = parse_element (element ("""ExcSEXS.kc"""))
    val tatb: (Context) => String = parse_element (element ("""ExcSEXS.tatb"""))
    val tb: (Context) => String = parse_element (element ("""ExcSEXS.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcSEXS.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcSEXS.te"""))
...
extends
    Parseable[ExcSK]
{
    val efdmax: (Context) => String = parse_element (element ("""ExcSK.efdmax"""))
    val efdmin: (Context) => String = parse_element (element ("""ExcSK.efdmin"""))
    val emax: (Context) => String = parse_element (element ("""ExcSK.emax"""))
    val emin: (Context) => String = parse_element (element ("""ExcSK.emin"""))
    val k: (Context) => String = parse_element (element ("""ExcSK.k"""))
    val k1: (Context) => String = parse_element (element ("""ExcSK.k1"""))
    val k2: (Context) => String = parse_element (element ("""ExcSK.k2"""))
    val kc: (Context) => String = parse_element (element ("""ExcSK.kc"""))
    val kce: (Context) => String = parse_element (element ("""ExcSK.kce"""))
    val kd: (Context) => String = parse_element (element ("""ExcSK.kd"""))
    val kgob: (Context) => String = parse_element (element ("""ExcSK.kgob"""))
    val kp: (Context) => String = parse_element (element ("""ExcSK.kp"""))
    val kqi: (Context) => String = parse_element (element ("""ExcSK.kqi"""))
    val kqob: (Context) => String = parse_element (element ("""ExcSK.kqob"""))
    val kqp: (Context) => String = parse_element (element ("""ExcSK.kqp"""))
    val nq: (Context) => String = parse_element (element ("""ExcSK.nq"""))
    val qconoff: (Context) => String = parse_element (element ("""ExcSK.qconoff"""))
    val qz: (Context) => String = parse_element (element ("""ExcSK.qz"""))
    val remote: (Context) => String = parse_element (element ("""ExcSK.remote"""))
    val sbase: (Context) => String = parse_element (element ("""ExcSK.sbase"""))
    val tc: (Context) => String = parse_element (element ("""ExcSK.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcSK.te"""))
    val ti: (Context) => String = parse_element (element ("""ExcSK.ti"""))
    val tp: (Context) => String = parse_element (element ("""ExcSK.tp"""))
    val tr: (Context) => String = parse_element (element ("""ExcSK.tr"""))
    val uimax: (Context) => String = parse_element (element ("""ExcSK.uimax"""))
    val uimin: (Context) => String = parse_element (element ("""ExcSK.uimin"""))
    val urmax: (Context) => String = parse_element (element ("""ExcSK.urmax"""))
    val urmin: (Context) => String = parse_element (element ("""ExcSK.urmin"""))
    val vtmax: (Context) => String = parse_element (element ("""ExcSK.vtmax"""))
    val vtmin: (Context) => String = parse_element (element ("""ExcSK.vtmin"""))
    val yp: (Context) => String = parse_element (element ("""ExcSK.yp"""))
...
extends
    Parseable[ExcST1A]
{
    val ilr: (Context) => String = parse_element (element ("""ExcST1A.ilr"""))
    val ka: (Context) => String = parse_element (element ("""ExcST1A.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcST1A.kc"""))
    val kf: (Context) => String = parse_element (element ("""ExcST1A.kf"""))
    val klr: (Context) => String = parse_element (element ("""ExcST1A.klr"""))
    val ta: (Context) => String = parse_element (element ("""ExcST1A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcST1A.tb"""))
    val tb1: (Context) => String = parse_element (element ("""ExcST1A.tb1"""))
    val tc: (Context) => String = parse_element (element ("""ExcST1A.tc"""))
    val tc1: (Context) => String = parse_element (element ("""ExcST1A.tc1"""))
    val tf: (Context) => String = parse_element (element ("""ExcST1A.tf"""))
    val vamax: (Context) => String = parse_element (element ("""ExcST1A.vamax"""))
    val vamin: (Context) => String = parse_element (element ("""ExcST1A.vamin"""))
    val vimax: (Context) => String = parse_element (element ("""ExcST1A.vimax"""))
    val vimin: (Context) => String = parse_element (element ("""ExcST1A.vimin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcST1A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcST1A.vrmin"""))
    val xe: (Context) => String = parse_element (element ("""ExcST1A.xe"""))
...
extends
    Parseable[ExcST2A]
{
    val efdmax: (Context) => String = parse_element (element ("""ExcST2A.efdmax"""))
    val ka: (Context) => String = parse_element (element ("""ExcST2A.ka"""))
    val kc: (Context) => String = parse_element (element ("""ExcST2A.kc"""))
    val ke: (Context) => String = parse_element (element ("""ExcST2A.ke"""))
    val kf: (Context) => String = parse_element (element ("""ExcST2A.kf"""))
    val ki: (Context) => String = parse_element (element ("""ExcST2A.ki"""))
    val kp: (Context) => String = parse_element (element ("""ExcST2A.kp"""))
    val ta: (Context) => String = parse_element (element ("""ExcST2A.ta"""))
    val tb: (Context) => String = parse_element (element ("""ExcST2A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcST2A.tc"""))
    val te: (Context) => String = parse_element (element ("""ExcST2A.te"""))
    val tf: (Context) => String = parse_element (element ("""ExcST2A.tf"""))
    val uelin: (Context) => String = parse_element (element ("""ExcST2A.uelin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcST2A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcST2A.vrmin"""))
...
extends
    Parseable[ExcST3A]
{
    val efdmax: (Context) => String = parse_element (element ("""ExcST3A.efdmax"""))
    val kc: (Context) => String = parse_element (element ("""ExcST3A.kc"""))
    val kg: (Context) => String = parse_element (element ("""ExcST3A.kg"""))
    val ki: (Context) => String = parse_element (element ("""ExcST3A.ki"""))
    val kj: (Context) => String = parse_element (element ("""ExcST3A.kj"""))
    val km: (Context) => String = parse_element (element ("""ExcST3A.km"""))
    val kp: (Context) => String = parse_element (element ("""ExcST3A.kp"""))
    val ks: (Context) => String = parse_element (element ("""ExcST3A.ks"""))
    val ks1: (Context) => String = parse_element (element ("""ExcST3A.ks1"""))
    val tb: (Context) => String = parse_element (element ("""ExcST3A.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcST3A.tc"""))
    val thetap: (Context) => String = parse_element (element ("""ExcST3A.thetap"""))
    val tm: (Context) => String = parse_element (element ("""ExcST3A.tm"""))
    val vbmax: (Context) => String = parse_element (element ("""ExcST3A.vbmax"""))
    val vgmax: (Context) => String = parse_element (element ("""ExcST3A.vgmax"""))
    val vimax: (Context) => String = parse_element (element ("""ExcST3A.vimax"""))
    val vimin: (Context) => String = parse_element (element ("""ExcST3A.vimin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcST3A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcST3A.vrmin"""))
    val xl: (Context) => String = parse_element (element ("""ExcST3A.xl"""))
...
extends
    Parseable[ExcST4B]
{
    val kc: (Context) => String = parse_element (element ("""ExcST4B.kc"""))
    val kg: (Context) => String = parse_element (element ("""ExcST4B.kg"""))
    val ki: (Context) => String = parse_element (element ("""ExcST4B.ki"""))
    val kim: (Context) => String = parse_element (element ("""ExcST4B.kim"""))
    val kir: (Context) => String = parse_element (element ("""ExcST4B.kir"""))
    val kp: (Context) => String = parse_element (element ("""ExcST4B.kp"""))
    val kpm: (Context) => String = parse_element (element ("""ExcST4B.kpm"""))
    val kpr: (Context) => String = parse_element (element ("""ExcST4B.kpr"""))
    val lvgate: (Context) => String = parse_element (element ("""ExcST4B.lvgate"""))
    val ta: (Context) => String = parse_element (element ("""ExcST4B.ta"""))
    val thetap: (Context) => String = parse_element (element ("""ExcST4B.thetap"""))
    val uel: (Context) => String = parse_element (element ("""ExcST4B.uel"""))
    val vbmax: (Context) => String = parse_element (element ("""ExcST4B.vbmax"""))
    val vgmax: (Context) => String = parse_element (element ("""ExcST4B.vgmax"""))
    val vmmax: (Context) => String = parse_element (element ("""ExcST4B.vmmax"""))
    val vmmin: (Context) => String = parse_element (element ("""ExcST4B.vmmin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcST4B.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcST4B.vrmin"""))
    val xl: (Context) => String = parse_element (element ("""ExcST4B.xl"""))
...
extends
    Parseable[ExcST6B]
{
    val ilr: (Context) => String = parse_element (element ("""ExcST6B.ilr"""))
    val k1: (Context) => String = parse_element (element ("""ExcST6B.k1"""))
    val kcl: (Context) => String = parse_element (element ("""ExcST6B.kcl"""))
    val kff: (Context) => String = parse_element (element ("""ExcST6B.kff"""))
    val kg: (Context) => String = parse_element (element ("""ExcST6B.kg"""))
    val kia: (Context) => String = parse_element (element ("""ExcST6B.kia"""))
    val klr: (Context) => String = parse_element (element ("""ExcST6B.klr"""))
    val km: (Context) => String = parse_element (element ("""ExcST6B.km"""))
    val kpa: (Context) => String = parse_element (element ("""ExcST6B.kpa"""))
    val kvd: (Context) => String = parse_element (element ("""ExcST6B.kvd"""))
    val oelin: (Context) => String = parse_attribute (attribute ("""ExcST6B.oelin"""))
    val tg: (Context) => String = parse_element (element ("""ExcST6B.tg"""))
    val ts: (Context) => String = parse_element (element ("""ExcST6B.ts"""))
    val tvd: (Context) => String = parse_element (element ("""ExcST6B.tvd"""))
    val vamax: (Context) => String = parse_element (element ("""ExcST6B.vamax"""))
    val vamin: (Context) => String = parse_element (element ("""ExcST6B.vamin"""))
    val vilim: (Context) => String = parse_element (element ("""ExcST6B.vilim"""))
    val vimax: (Context) => String = parse_element (element ("""ExcST6B.vimax"""))
    val vimin: (Context) => String = parse_element (element ("""ExcST6B.vimin"""))
    val vmult: (Context) => String = parse_element (element ("""ExcST6B.vmult"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcST6B.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcST6B.vrmin"""))
    val xc: (Context) => String = parse_element (element ("""ExcST6B.xc"""))
...
extends
    Parseable[ExcST7B]
{
    val kh: (Context) => String = parse_element (element ("""ExcST7B.kh"""))
    val kia: (Context) => String = parse_element (element ("""ExcST7B.kia"""))
    val kl: (Context) => String = parse_element (element ("""ExcST7B.kl"""))
    val kpa: (Context) => String = parse_element (element ("""ExcST7B.kpa"""))
    val oelin: (Context) => String = parse_attribute (attribute ("""ExcST7B.oelin"""))
    val tb: (Context) => String = parse_element (element ("""ExcST7B.tb"""))
    val tc: (Context) => String = parse_element (element ("""ExcST7B.tc"""))
    val tf: (Context) => String = parse_element (element ("""ExcST7B.tf"""))
    val tg: (Context) => String = parse_element (element ("""ExcST7B.tg"""))
    val tia: (Context) => String = parse_element (element ("""ExcST7B.tia"""))
    val ts: (Context) => String = parse_element (element ("""ExcST7B.ts"""))
    val uelin: (Context) => String = parse_attribute (attribute ("""ExcST7B.uelin"""))
    val vmax: (Context) => String = parse_element (element ("""ExcST7B.vmax"""))
    val vmin: (Context) => String = parse_element (element ("""ExcST7B.vmin"""))
    val vrmax: (Context) => String = parse_element (element ("""ExcST7B.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""ExcST7B.vrmin"""))
...
{
    val DiscontinuousExcitationControlDynamics: (Context) => String = parse_attribute (attribute ("""ExcitationSystemDynamics.DiscontinuousExcitationControlDynamics"""))
    val OverexcitationLimiterDynamics: (Context) => String = parse_attribute (attribute ("""ExcitationSystemDynamics.OverexcitationLimiterDynamics"""))
    val PFVArControllerType1Dynamics: (Context) => String = parse_attribute (attribute ("""ExcitationSystemDynamics.PFVArControllerType1Dynamics"""))
    val PFVArControllerType2Dynamics: (Context) => String = parse_attribute (attribute ("""ExcitationSystemDynamics.PFVArControllerType2Dynamics"""))
    val PowerSystemStabilizerDynamics: (Context) => String = parse_attribute (attribute ("""ExcitationSystemDynamics.PowerSystemStabilizerDynamics"""))
    val SynchronousMachineDynamics: (Context) => String = parse_attribute (attribute ("""ExcitationSystemDynamics.SynchronousMachineDynamics"""))
    val UnderexcitationLimiterDynamics: (Context) => String = parse_attribute (attribute ("""ExcitationSystemDynamics.UnderexcitationLimiterDynamics"""))
    val VoltageCompensatorDynamics: (Context) => String = parse_attribute (attribute ("""ExcitationSystemDynamics.VoltageCompensatorDynamics"""))
