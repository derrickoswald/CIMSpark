...
{
    val ExcitationSystemDynamics: (Context) => String = parse_attribute (attribute ("""PowerSystemStabilizerDynamics.ExcitationSystemDynamics"""))
...
extends
    Parseable[Pss1]
{
    val kf: (Context) => String = parse_element (element ("""Pss1.kf"""))
    val kpe: (Context) => String = parse_element (element ("""Pss1.kpe"""))
    val ks: (Context) => String = parse_element (element ("""Pss1.ks"""))
    val kw: (Context) => String = parse_element (element ("""Pss1.kw"""))
    val pmin: (Context) => String = parse_element (element ("""Pss1.pmin"""))
    val t10: (Context) => String = parse_element (element ("""Pss1.t10"""))
    val t5: (Context) => String = parse_element (element ("""Pss1.t5"""))
    val t6: (Context) => String = parse_element (element ("""Pss1.t6"""))
    val t7: (Context) => String = parse_element (element ("""Pss1.t7"""))
    val t8: (Context) => String = parse_element (element ("""Pss1.t8"""))
    val t9: (Context) => String = parse_element (element ("""Pss1.t9"""))
    val tpe: (Context) => String = parse_element (element ("""Pss1.tpe"""))
    val vadat: (Context) => String = parse_element (element ("""Pss1.vadat"""))
    val vsmn: (Context) => String = parse_element (element ("""Pss1.vsmn"""))
    val vsmx: (Context) => String = parse_element (element ("""Pss1.vsmx"""))
...
extends
    Parseable[Pss1A]
{
    val a1: (Context) => String = parse_element (element ("""Pss1A.a1"""))
    val a2: (Context) => String = parse_element (element ("""Pss1A.a2"""))
    val a3: (Context) => String = parse_element (element ("""Pss1A.a3"""))
    val a4: (Context) => String = parse_element (element ("""Pss1A.a4"""))
    val a5: (Context) => String = parse_element (element ("""Pss1A.a5"""))
    val a6: (Context) => String = parse_element (element ("""Pss1A.a6"""))
    val a7: (Context) => String = parse_element (element ("""Pss1A.a7"""))
    val a8: (Context) => String = parse_element (element ("""Pss1A.a8"""))
    val inputSignalType: (Context) => String = parse_attribute (attribute ("""Pss1A.inputSignalType"""))
    val kd: (Context) => String = parse_element (element ("""Pss1A.kd"""))
    val ks: (Context) => String = parse_element (element ("""Pss1A.ks"""))
    val t1: (Context) => String = parse_element (element ("""Pss1A.t1"""))
    val t2: (Context) => String = parse_element (element ("""Pss1A.t2"""))
    val t3: (Context) => String = parse_element (element ("""Pss1A.t3"""))
    val t4: (Context) => String = parse_element (element ("""Pss1A.t4"""))
    val t5: (Context) => String = parse_element (element ("""Pss1A.t5"""))
    val t6: (Context) => String = parse_element (element ("""Pss1A.t6"""))
    val tdelay: (Context) => String = parse_element (element ("""Pss1A.tdelay"""))
    val vcl: (Context) => String = parse_element (element ("""Pss1A.vcl"""))
    val vcu: (Context) => String = parse_element (element ("""Pss1A.vcu"""))
    val vrmax: (Context) => String = parse_element (element ("""Pss1A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""Pss1A.vrmin"""))
...
extends
    Parseable[Pss2B]
{
    val a: (Context) => String = parse_element (element ("""Pss2B.a"""))
    val inputSignal1Type: (Context) => String = parse_attribute (attribute ("""Pss2B.inputSignal1Type"""))
    val inputSignal2Type: (Context) => String = parse_attribute (attribute ("""Pss2B.inputSignal2Type"""))
    val ks1: (Context) => String = parse_element (element ("""Pss2B.ks1"""))
    val ks2: (Context) => String = parse_element (element ("""Pss2B.ks2"""))
    val ks3: (Context) => String = parse_element (element ("""Pss2B.ks3"""))
    val ks4: (Context) => String = parse_element (element ("""Pss2B.ks4"""))
    val m: (Context) => String = parse_element (element ("""Pss2B.m"""))
    val n: (Context) => String = parse_element (element ("""Pss2B.n"""))
    val t1: (Context) => String = parse_element (element ("""Pss2B.t1"""))
    val t10: (Context) => String = parse_element (element ("""Pss2B.t10"""))
    val t11: (Context) => String = parse_element (element ("""Pss2B.t11"""))
    val t2: (Context) => String = parse_element (element ("""Pss2B.t2"""))
    val t3: (Context) => String = parse_element (element ("""Pss2B.t3"""))
    val t4: (Context) => String = parse_element (element ("""Pss2B.t4"""))
    val t6: (Context) => String = parse_element (element ("""Pss2B.t6"""))
    val t7: (Context) => String = parse_element (element ("""Pss2B.t7"""))
    val t8: (Context) => String = parse_element (element ("""Pss2B.t8"""))
    val t9: (Context) => String = parse_element (element ("""Pss2B.t9"""))
    val ta: (Context) => String = parse_element (element ("""Pss2B.ta"""))
    val tb: (Context) => String = parse_element (element ("""Pss2B.tb"""))
    val tw1: (Context) => String = parse_element (element ("""Pss2B.tw1"""))
    val tw2: (Context) => String = parse_element (element ("""Pss2B.tw2"""))
    val tw3: (Context) => String = parse_element (element ("""Pss2B.tw3"""))
    val tw4: (Context) => String = parse_element (element ("""Pss2B.tw4"""))
    val vsi1max: (Context) => String = parse_element (element ("""Pss2B.vsi1max"""))
    val vsi1min: (Context) => String = parse_element (element ("""Pss2B.vsi1min"""))
    val vsi2max: (Context) => String = parse_element (element ("""Pss2B.vsi2max"""))
    val vsi2min: (Context) => String = parse_element (element ("""Pss2B.vsi2min"""))
    val vstmax: (Context) => String = parse_element (element ("""Pss2B.vstmax"""))
    val vstmin: (Context) => String = parse_element (element ("""Pss2B.vstmin"""))
...
extends
    Parseable[Pss2ST]
{
    val inputSignal1Type: (Context) => String = parse_attribute (attribute ("""Pss2ST.inputSignal1Type"""))
    val inputSignal2Type: (Context) => String = parse_attribute (attribute ("""Pss2ST.inputSignal2Type"""))
    val k1: (Context) => String = parse_element (element ("""Pss2ST.k1"""))
    val k2: (Context) => String = parse_element (element ("""Pss2ST.k2"""))
    val lsmax: (Context) => String = parse_element (element ("""Pss2ST.lsmax"""))
    val lsmin: (Context) => String = parse_element (element ("""Pss2ST.lsmin"""))
    val t1: (Context) => String = parse_element (element ("""Pss2ST.t1"""))
    val t10: (Context) => String = parse_element (element ("""Pss2ST.t10"""))
    val t2: (Context) => String = parse_element (element ("""Pss2ST.t2"""))
    val t3: (Context) => String = parse_element (element ("""Pss2ST.t3"""))
    val t4: (Context) => String = parse_element (element ("""Pss2ST.t4"""))
    val t5: (Context) => String = parse_element (element ("""Pss2ST.t5"""))
    val t6: (Context) => String = parse_element (element ("""Pss2ST.t6"""))
    val t7: (Context) => String = parse_element (element ("""Pss2ST.t7"""))
    val t8: (Context) => String = parse_element (element ("""Pss2ST.t8"""))
    val t9: (Context) => String = parse_element (element ("""Pss2ST.t9"""))
    val vcl: (Context) => String = parse_element (element ("""Pss2ST.vcl"""))
    val vcu: (Context) => String = parse_element (element ("""Pss2ST.vcu"""))
...
extends
    Parseable[Pss5]
{
    val ctw2: (Context) => String = parse_element (element ("""Pss5.ctw2"""))
    val deadband: (Context) => String = parse_element (element ("""Pss5.deadband"""))
    val isfreq: (Context) => String = parse_element (element ("""Pss5.isfreq"""))
    val kf: (Context) => String = parse_element (element ("""Pss5.kf"""))
    val kpe: (Context) => String = parse_element (element ("""Pss5.kpe"""))
    val kpss: (Context) => String = parse_element (element ("""Pss5.kpss"""))
    val pmm: (Context) => String = parse_element (element ("""Pss5.pmm"""))
    val tl1: (Context) => String = parse_element (element ("""Pss5.tl1"""))
    val tl2: (Context) => String = parse_element (element ("""Pss5.tl2"""))
    val tl3: (Context) => String = parse_element (element ("""Pss5.tl3"""))
    val tl4: (Context) => String = parse_element (element ("""Pss5.tl4"""))
    val tpe: (Context) => String = parse_element (element ("""Pss5.tpe"""))
    val tw1: (Context) => String = parse_element (element ("""Pss5.tw1"""))
    val tw2: (Context) => String = parse_element (element ("""Pss5.tw2"""))
    val vadat: (Context) => String = parse_element (element ("""Pss5.vadat"""))
    val vsmn: (Context) => String = parse_element (element ("""Pss5.vsmn"""))
    val vsmx: (Context) => String = parse_element (element ("""Pss5.vsmx"""))
...
extends
    Parseable[PssELIN2]
{
    val apss: (Context) => String = parse_element (element ("""PssELIN2.apss"""))
    val ks1: (Context) => String = parse_element (element ("""PssELIN2.ks1"""))
    val ks2: (Context) => String = parse_element (element ("""PssELIN2.ks2"""))
    val ppss: (Context) => String = parse_element (element ("""PssELIN2.ppss"""))
    val psslim: (Context) => String = parse_element (element ("""PssELIN2.psslim"""))
    val ts1: (Context) => String = parse_element (element ("""PssELIN2.ts1"""))
    val ts2: (Context) => String = parse_element (element ("""PssELIN2.ts2"""))
    val ts3: (Context) => String = parse_element (element ("""PssELIN2.ts3"""))
    val ts4: (Context) => String = parse_element (element ("""PssELIN2.ts4"""))
    val ts5: (Context) => String = parse_element (element ("""PssELIN2.ts5"""))
    val ts6: (Context) => String = parse_element (element ("""PssELIN2.ts6"""))
...
extends
    Parseable[PssIEEE1A]
{
    val a1: (Context) => String = parse_element (element ("""PssIEEE1A.a1"""))
    val a2: (Context) => String = parse_element (element ("""PssIEEE1A.a2"""))
    val inputSignalType: (Context) => String = parse_attribute (attribute ("""PssIEEE1A.inputSignalType"""))
    val ks: (Context) => String = parse_element (element ("""PssIEEE1A.ks"""))
    val t1: (Context) => String = parse_element (element ("""PssIEEE1A.t1"""))
    val t2: (Context) => String = parse_element (element ("""PssIEEE1A.t2"""))
    val t3: (Context) => String = parse_element (element ("""PssIEEE1A.t3"""))
    val t4: (Context) => String = parse_element (element ("""PssIEEE1A.t4"""))
    val t5: (Context) => String = parse_element (element ("""PssIEEE1A.t5"""))
    val t6: (Context) => String = parse_element (element ("""PssIEEE1A.t6"""))
    val vrmax: (Context) => String = parse_element (element ("""PssIEEE1A.vrmax"""))
    val vrmin: (Context) => String = parse_element (element ("""PssIEEE1A.vrmin"""))
...
extends
    Parseable[PssIEEE2B]
{
    val inputSignal1Type: (Context) => String = parse_attribute (attribute ("""PssIEEE2B.inputSignal1Type"""))
    val inputSignal2Type: (Context) => String = parse_attribute (attribute ("""PssIEEE2B.inputSignal2Type"""))
    val ks1: (Context) => String = parse_element (element ("""PssIEEE2B.ks1"""))
    val ks2: (Context) => String = parse_element (element ("""PssIEEE2B.ks2"""))
    val ks3: (Context) => String = parse_element (element ("""PssIEEE2B.ks3"""))
    val m: (Context) => String = parse_element (element ("""PssIEEE2B.m"""))
    val n: (Context) => String = parse_element (element ("""PssIEEE2B.n"""))
    val t1: (Context) => String = parse_element (element ("""PssIEEE2B.t1"""))
    val t10: (Context) => String = parse_element (element ("""PssIEEE2B.t10"""))
    val t11: (Context) => String = parse_element (element ("""PssIEEE2B.t11"""))
    val t2: (Context) => String = parse_element (element ("""PssIEEE2B.t2"""))
    val t3: (Context) => String = parse_element (element ("""PssIEEE2B.t3"""))
    val t4: (Context) => String = parse_element (element ("""PssIEEE2B.t4"""))
    val t6: (Context) => String = parse_element (element ("""PssIEEE2B.t6"""))
    val t7: (Context) => String = parse_element (element ("""PssIEEE2B.t7"""))
    val t8: (Context) => String = parse_element (element ("""PssIEEE2B.t8"""))
    val t9: (Context) => String = parse_element (element ("""PssIEEE2B.t9"""))
    val tw1: (Context) => String = parse_element (element ("""PssIEEE2B.tw1"""))
    val tw2: (Context) => String = parse_element (element ("""PssIEEE2B.tw2"""))
    val tw3: (Context) => String = parse_element (element ("""PssIEEE2B.tw3"""))
    val tw4: (Context) => String = parse_element (element ("""PssIEEE2B.tw4"""))
    val vsi1max: (Context) => String = parse_element (element ("""PssIEEE2B.vsi1max"""))
    val vsi1min: (Context) => String = parse_element (element ("""PssIEEE2B.vsi1min"""))
    val vsi2max: (Context) => String = parse_element (element ("""PssIEEE2B.vsi2max"""))
    val vsi2min: (Context) => String = parse_element (element ("""PssIEEE2B.vsi2min"""))
    val vstmax: (Context) => String = parse_element (element ("""PssIEEE2B.vstmax"""))
    val vstmin: (Context) => String = parse_element (element ("""PssIEEE2B.vstmin"""))
...
extends
    Parseable[PssIEEE3B]
{
    val a1: (Context) => String = parse_element (element ("""PssIEEE3B.a1"""))
    val a2: (Context) => String = parse_element (element ("""PssIEEE3B.a2"""))
    val a3: (Context) => String = parse_element (element ("""PssIEEE3B.a3"""))
    val a4: (Context) => String = parse_element (element ("""PssIEEE3B.a4"""))
    val a5: (Context) => String = parse_element (element ("""PssIEEE3B.a5"""))
    val a6: (Context) => String = parse_element (element ("""PssIEEE3B.a6"""))
    val a7: (Context) => String = parse_element (element ("""PssIEEE3B.a7"""))
    val a8: (Context) => String = parse_element (element ("""PssIEEE3B.a8"""))
    val inputSignal1Type: (Context) => String = parse_attribute (attribute ("""PssIEEE3B.inputSignal1Type"""))
    val inputSignal2Type: (Context) => String = parse_attribute (attribute ("""PssIEEE3B.inputSignal2Type"""))
    val ks1: (Context) => String = parse_element (element ("""PssIEEE3B.ks1"""))
    val ks2: (Context) => String = parse_element (element ("""PssIEEE3B.ks2"""))
    val t1: (Context) => String = parse_element (element ("""PssIEEE3B.t1"""))
    val t2: (Context) => String = parse_element (element ("""PssIEEE3B.t2"""))
    val tw1: (Context) => String = parse_element (element ("""PssIEEE3B.tw1"""))
    val tw2: (Context) => String = parse_element (element ("""PssIEEE3B.tw2"""))
    val tw3: (Context) => String = parse_element (element ("""PssIEEE3B.tw3"""))
    val vstmax: (Context) => String = parse_element (element ("""PssIEEE3B.vstmax"""))
    val vstmin: (Context) => String = parse_element (element ("""PssIEEE3B.vstmin"""))
...
extends
    Parseable[PssIEEE4B]
{
    val bwh1: (Context) => String = parse_element (element ("""PssIEEE4B.bwh1"""))
    val bwh2: (Context) => String = parse_element (element ("""PssIEEE4B.bwh2"""))
    val bwl1: (Context) => String = parse_element (element ("""PssIEEE4B.bwl1"""))
    val bwl2: (Context) => String = parse_element (element ("""PssIEEE4B.bwl2"""))
    val kh: (Context) => String = parse_element (element ("""PssIEEE4B.kh"""))
    val kh1: (Context) => String = parse_element (element ("""PssIEEE4B.kh1"""))
    val kh11: (Context) => String = parse_element (element ("""PssIEEE4B.kh11"""))
    val kh17: (Context) => String = parse_element (element ("""PssIEEE4B.kh17"""))
    val kh2: (Context) => String = parse_element (element ("""PssIEEE4B.kh2"""))
    val ki: (Context) => String = parse_element (element ("""PssIEEE4B.ki"""))
    val ki1: (Context) => String = parse_element (element ("""PssIEEE4B.ki1"""))
    val ki11: (Context) => String = parse_element (element ("""PssIEEE4B.ki11"""))
    val ki17: (Context) => String = parse_element (element ("""PssIEEE4B.ki17"""))
    val ki2: (Context) => String = parse_element (element ("""PssIEEE4B.ki2"""))
    val kl: (Context) => String = parse_element (element ("""PssIEEE4B.kl"""))
    val kl1: (Context) => String = parse_element (element ("""PssIEEE4B.kl1"""))
    val kl11: (Context) => String = parse_element (element ("""PssIEEE4B.kl11"""))
    val kl17: (Context) => String = parse_element (element ("""PssIEEE4B.kl17"""))
    val kl2: (Context) => String = parse_element (element ("""PssIEEE4B.kl2"""))
    val omeganh1: (Context) => String = parse_element (element ("""PssIEEE4B.omeganh1"""))
    val omeganh2: (Context) => String = parse_element (element ("""PssIEEE4B.omeganh2"""))
    val omeganl1: (Context) => String = parse_element (element ("""PssIEEE4B.omeganl1"""))
    val omeganl2: (Context) => String = parse_element (element ("""PssIEEE4B.omeganl2"""))
    val th1: (Context) => String = parse_element (element ("""PssIEEE4B.th1"""))
    val th10: (Context) => String = parse_element (element ("""PssIEEE4B.th10"""))
    val th11: (Context) => String = parse_element (element ("""PssIEEE4B.th11"""))
    val th12: (Context) => String = parse_element (element ("""PssIEEE4B.th12"""))
    val th2: (Context) => String = parse_element (element ("""PssIEEE4B.th2"""))
    val th3: (Context) => String = parse_element (element ("""PssIEEE4B.th3"""))
    val th4: (Context) => String = parse_element (element ("""PssIEEE4B.th4"""))
    val th5: (Context) => String = parse_element (element ("""PssIEEE4B.th5"""))
    val th6: (Context) => String = parse_element (element ("""PssIEEE4B.th6"""))
    val th7: (Context) => String = parse_element (element ("""PssIEEE4B.th7"""))
    val th8: (Context) => String = parse_element (element ("""PssIEEE4B.th8"""))
    val th9: (Context) => String = parse_element (element ("""PssIEEE4B.th9"""))
    val ti1: (Context) => String = parse_element (element ("""PssIEEE4B.ti1"""))
    val ti10: (Context) => String = parse_element (element ("""PssIEEE4B.ti10"""))
    val ti11: (Context) => String = parse_element (element ("""PssIEEE4B.ti11"""))
    val ti12: (Context) => String = parse_element (element ("""PssIEEE4B.ti12"""))
    val ti2: (Context) => String = parse_element (element ("""PssIEEE4B.ti2"""))
    val ti3: (Context) => String = parse_element (element ("""PssIEEE4B.ti3"""))
    val ti4: (Context) => String = parse_element (element ("""PssIEEE4B.ti4"""))
    val ti5: (Context) => String = parse_element (element ("""PssIEEE4B.ti5"""))
    val ti6: (Context) => String = parse_element (element ("""PssIEEE4B.ti6"""))
    val ti7: (Context) => String = parse_element (element ("""PssIEEE4B.ti7"""))
    val ti8: (Context) => String = parse_element (element ("""PssIEEE4B.ti8"""))
    val ti9: (Context) => String = parse_element (element ("""PssIEEE4B.ti9"""))
    val tl1: (Context) => String = parse_element (element ("""PssIEEE4B.tl1"""))
    val tl10: (Context) => String = parse_element (element ("""PssIEEE4B.tl10"""))
    val tl11: (Context) => String = parse_element (element ("""PssIEEE4B.tl11"""))
    val tl12: (Context) => String = parse_element (element ("""PssIEEE4B.tl12"""))
    val tl2: (Context) => String = parse_element (element ("""PssIEEE4B.tl2"""))
    val tl3: (Context) => String = parse_element (element ("""PssIEEE4B.tl3"""))
    val tl4: (Context) => String = parse_element (element ("""PssIEEE4B.tl4"""))
    val tl5: (Context) => String = parse_element (element ("""PssIEEE4B.tl5"""))
    val tl6: (Context) => String = parse_element (element ("""PssIEEE4B.tl6"""))
    val tl7: (Context) => String = parse_element (element ("""PssIEEE4B.tl7"""))
    val tl8: (Context) => String = parse_element (element ("""PssIEEE4B.tl8"""))
    val tl9: (Context) => String = parse_element (element ("""PssIEEE4B.tl9"""))
    val vhmax: (Context) => String = parse_element (element ("""PssIEEE4B.vhmax"""))
    val vhmin: (Context) => String = parse_element (element ("""PssIEEE4B.vhmin"""))
    val vimax: (Context) => String = parse_element (element ("""PssIEEE4B.vimax"""))
    val vimin: (Context) => String = parse_element (element ("""PssIEEE4B.vimin"""))
    val vlmax: (Context) => String = parse_element (element ("""PssIEEE4B.vlmax"""))
    val vlmin: (Context) => String = parse_element (element ("""PssIEEE4B.vlmin"""))
    val vstmax: (Context) => String = parse_element (element ("""PssIEEE4B.vstmax"""))
    val vstmin: (Context) => String = parse_element (element ("""PssIEEE4B.vstmin"""))
...
extends
    Parseable[PssPTIST1]
{
    val dtc: (Context) => String = parse_element (element ("""PssPTIST1.dtc"""))
    val dtf: (Context) => String = parse_element (element ("""PssPTIST1.dtf"""))
    val dtp: (Context) => String = parse_element (element ("""PssPTIST1.dtp"""))
    val k: (Context) => String = parse_element (element ("""PssPTIST1.k"""))
    val m: (Context) => String = parse_element (element ("""PssPTIST1.m"""))
    val t1: (Context) => String = parse_element (element ("""PssPTIST1.t1"""))
    val t2: (Context) => String = parse_element (element ("""PssPTIST1.t2"""))
    val t3: (Context) => String = parse_element (element ("""PssPTIST1.t3"""))
    val t4: (Context) => String = parse_element (element ("""PssPTIST1.t4"""))
    val tf: (Context) => String = parse_element (element ("""PssPTIST1.tf"""))
    val tp: (Context) => String = parse_element (element ("""PssPTIST1.tp"""))
...
extends
    Parseable[PssPTIST3]
{
    val a0: (Context) => String = parse_element (element ("""PssPTIST3.a0"""))
    val a1: (Context) => String = parse_element (element ("""PssPTIST3.a1"""))
    val a2: (Context) => String = parse_element (element ("""PssPTIST3.a2"""))
    val a3: (Context) => String = parse_element (element ("""PssPTIST3.a3"""))
    val a4: (Context) => String = parse_element (element ("""PssPTIST3.a4"""))
    val a5: (Context) => String = parse_element (element ("""PssPTIST3.a5"""))
    val al: (Context) => String = parse_element (element ("""PssPTIST3.al"""))
    val athres: (Context) => String = parse_element (element ("""PssPTIST3.athres"""))
    val b0: (Context) => String = parse_element (element ("""PssPTIST3.b0"""))
    val b1: (Context) => String = parse_element (element ("""PssPTIST3.b1"""))
    val b2: (Context) => String = parse_element (element ("""PssPTIST3.b2"""))
    val b3: (Context) => String = parse_element (element ("""PssPTIST3.b3"""))
    val b4: (Context) => String = parse_element (element ("""PssPTIST3.b4"""))
    val b5: (Context) => String = parse_element (element ("""PssPTIST3.b5"""))
    val dl: (Context) => String = parse_element (element ("""PssPTIST3.dl"""))
    val dtc: (Context) => String = parse_element (element ("""PssPTIST3.dtc"""))
    val dtf: (Context) => String = parse_element (element ("""PssPTIST3.dtf"""))
    val dtp: (Context) => String = parse_element (element ("""PssPTIST3.dtp"""))
    val isw: (Context) => String = parse_element (element ("""PssPTIST3.isw"""))
    val k: (Context) => String = parse_element (element ("""PssPTIST3.k"""))
    val lthres: (Context) => String = parse_element (element ("""PssPTIST3.lthres"""))
    val m: (Context) => String = parse_element (element ("""PssPTIST3.m"""))
    val nav: (Context) => String = parse_element (element ("""PssPTIST3.nav"""))
    val ncl: (Context) => String = parse_element (element ("""PssPTIST3.ncl"""))
    val ncr: (Context) => String = parse_element (element ("""PssPTIST3.ncr"""))
    val pmin: (Context) => String = parse_element (element ("""PssPTIST3.pmin"""))
    val t1: (Context) => String = parse_element (element ("""PssPTIST3.t1"""))
    val t2: (Context) => String = parse_element (element ("""PssPTIST3.t2"""))
    val t3: (Context) => String = parse_element (element ("""PssPTIST3.t3"""))
    val t4: (Context) => String = parse_element (element ("""PssPTIST3.t4"""))
    val t5: (Context) => String = parse_element (element ("""PssPTIST3.t5"""))
    val t6: (Context) => String = parse_element (element ("""PssPTIST3.t6"""))
    val tf: (Context) => String = parse_element (element ("""PssPTIST3.tf"""))
    val tp: (Context) => String = parse_element (element ("""PssPTIST3.tp"""))
...
extends
    Parseable[PssSB4]
{
    val kx: (Context) => String = parse_element (element ("""PssSB4.kx"""))
    val ta: (Context) => String = parse_element (element ("""PssSB4.ta"""))
    val tb: (Context) => String = parse_element (element ("""PssSB4.tb"""))
    val tc: (Context) => String = parse_element (element ("""PssSB4.tc"""))
    val td: (Context) => String = parse_element (element ("""PssSB4.td"""))
    val te: (Context) => String = parse_element (element ("""PssSB4.te"""))
    val tt: (Context) => String = parse_element (element ("""PssSB4.tt"""))
    val tx1: (Context) => String = parse_element (element ("""PssSB4.tx1"""))
    val tx2: (Context) => String = parse_element (element ("""PssSB4.tx2"""))
    val vsmax: (Context) => String = parse_element (element ("""PssSB4.vsmax"""))
    val vsmin: (Context) => String = parse_element (element ("""PssSB4.vsmin"""))
...
extends
    Parseable[PssSH]
{
    val k: (Context) => String = parse_element (element ("""PssSH.k"""))
    val k0: (Context) => String = parse_element (element ("""PssSH.k0"""))
    val k1: (Context) => String = parse_element (element ("""PssSH.k1"""))
    val k2: (Context) => String = parse_element (element ("""PssSH.k2"""))
    val k3: (Context) => String = parse_element (element ("""PssSH.k3"""))
    val k4: (Context) => String = parse_element (element ("""PssSH.k4"""))
    val t1: (Context) => String = parse_element (element ("""PssSH.t1"""))
    val t2: (Context) => String = parse_element (element ("""PssSH.t2"""))
    val t3: (Context) => String = parse_element (element ("""PssSH.t3"""))
    val t4: (Context) => String = parse_element (element ("""PssSH.t4"""))
    val td: (Context) => String = parse_element (element ("""PssSH.td"""))
    val vsmax: (Context) => String = parse_element (element ("""PssSH.vsmax"""))
    val vsmin: (Context) => String = parse_element (element ("""PssSH.vsmin"""))
...
extends
    Parseable[PssSK]
{
    val k1: (Context) => String = parse_element (element ("""PssSK.k1"""))
    val k2: (Context) => String = parse_element (element ("""PssSK.k2"""))
    val k3: (Context) => String = parse_element (element ("""PssSK.k3"""))
    val t1: (Context) => String = parse_element (element ("""PssSK.t1"""))
    val t2: (Context) => String = parse_element (element ("""PssSK.t2"""))
    val t3: (Context) => String = parse_element (element ("""PssSK.t3"""))
    val t4: (Context) => String = parse_element (element ("""PssSK.t4"""))
    val t5: (Context) => String = parse_element (element ("""PssSK.t5"""))
    val t6: (Context) => String = parse_element (element ("""PssSK.t6"""))
    val vsmax: (Context) => String = parse_element (element ("""PssSK.vsmax"""))
    val vsmin: (Context) => String = parse_element (element ("""PssSK.vsmin"""))
...
extends
    Parseable[PssWECC]
{
    val inputSignal1Type: (Context) => String = parse_attribute (attribute ("""PssWECC.inputSignal1Type"""))
    val inputSignal2Type: (Context) => String = parse_attribute (attribute ("""PssWECC.inputSignal2Type"""))
    val k1: (Context) => String = parse_element (element ("""PssWECC.k1"""))
    val k2: (Context) => String = parse_element (element ("""PssWECC.k2"""))
    val t1: (Context) => String = parse_element (element ("""PssWECC.t1"""))
    val t10: (Context) => String = parse_element (element ("""PssWECC.t10"""))
    val t2: (Context) => String = parse_element (element ("""PssWECC.t2"""))
    val t3: (Context) => String = parse_element (element ("""PssWECC.t3"""))
    val t4: (Context) => String = parse_element (element ("""PssWECC.t4"""))
    val t5: (Context) => String = parse_element (element ("""PssWECC.t5"""))
    val t6: (Context) => String = parse_element (element ("""PssWECC.t6"""))
    val t7: (Context) => String = parse_element (element ("""PssWECC.t7"""))
    val t8: (Context) => String = parse_element (element ("""PssWECC.t8"""))
    val t9: (Context) => String = parse_element (element ("""PssWECC.t9"""))
    val vcl: (Context) => String = parse_element (element ("""PssWECC.vcl"""))
    val vcu: (Context) => String = parse_element (element ("""PssWECC.vcu"""))
    val vsmax: (Context) => String = parse_element (element ("""PssWECC.vsmax"""))
    val vsmin: (Context) => String = parse_element (element ("""PssWECC.vsmin"""))
