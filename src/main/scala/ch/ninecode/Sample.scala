 ...
 * spark-shell --master yarn --deploy-mode client --driver-memory 1g --executor-memory 4g --executor-cores 1 --jars /opt/code/CIMScala-2.10-1.6.0-1.7.1.jar --class ch.ninecode.Sample hdfs:/data/NIS_CIM_Export_NS_INITIAL_FILL.rdf
 */
object Sample
{
